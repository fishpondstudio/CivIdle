export const CZ = {
   ...
   AccountGreatPeopleLevelRequirement: "Požadovaný level Skvělého člověka",
   ...
   AldersonDiskDesc: "+25 Spokojenosti. Tenhle div může být vylepšen a každé vylepšení přidá +5 Spokojenosti",
   Alloy: "Slitina",
   Alps: "Alpy",
   ...
   AoiMatsuri: "Aoi Matsuri: Hora Fuji generuje dvojnásob warpu",
   Apartment: "Apartmán",
   Aphrodite: "Afrodita",
   ...
   OpenSaveFolder: "Otevřít záložní složku",
   Opera: "Opera",
   ...
   StatisticsBuildingsFilters: "Filtry",
