export const CZ = {
   ...
   Atomium: "Atomium",
   AtomiumDesc: "Všechny budovy, které produkují vědu v dosahu 2 dlaždic, získají výrobní násobek +5. Generuje vědu, která se rovná produkci vědy v dosahu 2 dlaždic.",
   ...
   GameVisualShowEmpireValue: "Zobrazit hodnotu Empire Value ve stavebních dlaždicích",
   Garment: "Oděvní",
   ...
   PlayerTradeCancelDesc: "Zrušení tohoto obchodu vrátí pouze %{percent} zdrojů. Jste si jisti, že chcete obchod zrušit?",
