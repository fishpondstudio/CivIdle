export const DE = {
   ...
   CityViewMap: "Stadt",
   ConsumeResource: "Konsumieren",
   Consume: "Konsumieren",
   ProduceResource: "Produzieren",
   Produce: "Produzieren",
   ...
   ProgressTowardsNextGreatPerson: "Fortschritte auf dem Weg zur nächsten großen Person bei der Wiedergeburt",
   NotProducingBuildings: "Gebäude, die nicht produzieren",
   ExtraGreatPeopleAtReborn: "Extra tolle Menschen bei der Wiedergeburt",
   Ok: "OK",
   Cancel: "Abbrechen",
   ChooseGreatPersonFromLastReborn: "Wähle eine großartige Person aus der letzten Wiedergeburt",
