export const DE = {
   ...
   JuliusCaesarDesc: "+%{value} Wissenschaft von unbeschäftigten Arbeitern",
   Augustus: "August",
   CaiLun: "Cai Lun",
   Cleopatra: "Kleopatra",
   SimaQian: "Sima Qian",
   ...
   EndConstructionDescHTML:
      "Wenn Sie den Bau beenden, werden alle bereits verbrauchten Ressourcen nicht zurückgegeben</b>",
