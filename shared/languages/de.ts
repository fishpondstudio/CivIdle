export const DE = {
   ...
   FirstTimeTutorialWelcome3HTML: "Jetzt, da du alle Grundlagen des Spiels kennst, kannst du mit dem Aufbau deines Imperiums beginnen. Aber bevor ich dich gehen lasse, solltest du <b>einen Spielernamen wählen</b> und im In-Game-Chat Hallo sagen. Wir haben eine unglaublich hilfsbereite Community: Wenn du nicht weiterkommst, zögere nicht zu fragen!",
   Fish: "Fisch",
   FishPond: "Angelteich",
   ...
   ProductionPriorityDescV3:
      "Die Priorität bestimmt die Reihenfolge, in der Gebäude transportieren und produzieren – eine höhere Zahl bedeutet, dass ein Gebäude vor anderen Gebäuden transportiert und produziert. Eine höhere Priorität garantiert jedoch nicht, dass das Gebäude die Ressource zuerst transportiert. Bei der folgenden Prioritätsreihenfolge: Kohlekraftwerk > Kohlebergwerk > Stahlwerk erhält das Stahlwerk beispielsweise die gesamte Kohle, die im selben Zyklus produziert wird, da es unmittelbar nach dem Kohlebergwerk transportiert und produziert.",
   ...
   Reborn: "Wiedergeburt",
   RebornModalDescV3: "Du wirst ein neues Imperium gründen, aber alle deine herausragenden Persönlichkeiten <b>aus diesem Lauf</b> werden zu permanenten Splittern, mit denen du dein <b>permanentes herausragende Persönlichkeit</b>-Level verbessern kannst. Du erhälst außerdem zusätzliche Scherben herausragender Persönlichkeiten basierend auf deinem <b>Gesamtwert des Imperiums</b>",
   ...
   ZigguratOfUrDescV2: "Alle 10 Zufriendenheit (gedeckelt) bringt +1 Produktionsmultiplikator für alle Gebäude, die keine Arbeiter produzieren und in früheren Zeitaltern freigeschaltet wurden (max = Anzahl der freigeschalteten Zeitalter / 2). Wunder (inkl. Natürliche) bringen nicht mehr +1 Zufriendenheit. Der Effekt kann abgeschaltet werden",
   Zoroaster: "Zoroaster",
   Zugspitze: "Zugspitze",
