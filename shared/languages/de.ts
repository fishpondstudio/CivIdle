export const DE = {
   ...
   CNTower: "CN Tower",
   CNTowerDesc: "Alle Filmstudios, Radiostationen und Fernsehsender sind von -1 Zufrioedenheit ausgenommen. Alle Gebäude, die in den Weltkriegen und im Kalten Krieg freigeschaltet werden, erhalten +N Produktions-, Arbeitskraft- und Lagermultiplikator. N = Differenz zwischen der Stufe und dem Alter des Gebäudes",
   Coal: "Kohle",
   ...
   CursorStyleDescHTML: "Anpassen des Cursor Styles. <b>Erfordert einen Neustart des Spiels, um wirksam zu werden</b>",
   CursorSystem: "System",
   CyrusII: "Kyros II.",
   ...
   DeficitResources: "Defizit Ressourcen",
