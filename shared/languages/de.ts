export const DE = {
   ...
   Atomium: "Atomium",
   AtomiumDescV2: "Alle Gebäude, die im Umkreis von 2 Kacheln Wissenschaft produzieren, erhalten einen Produktionsmultiplikator von +5. Erzeugt Wissenschaft, die der Wissenschaftsproduktion im Umkreis von 2 Kacheln entspricht. Bei Fertigstellung wird einmalig Wissenschaft in Höhe der Kosten der teuersten freigeschalteten Technologie erzeugt.",
