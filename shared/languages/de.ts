export const DE = {
   ...
   AbuSimbelDesc: "Verdoppelt den Effekt von Ramsses II.<br>Alle angrenzenden Wunder generieren +1 Zufriedenheit",
   ...
   ApolloProgramDesc: "Alle Raketenfabriken erhalten +2 Produktions-, Arbeitskapazitäts- und Lagermultiplikatoren.<br>Satellitenfabriken, Raumschiff-Fabriken und Atomraketen-Silos erhalten +1 Produktionsmultiplikator für jede benachbarte Raketenfabrik.",
   ...
   Atomium: "Atomium",
   AtomiumDescV2:
      "Alle Gebäude, die im Umkreis von 2 Kacheln Wissenschaft produzieren (außer Klon-Forschung), erhalten einen Produktionsmultiplikator von +5.<br>Erzeugt Wissenschaft, die der Wissenschaftsproduktion im Umkreis von 2 Kacheln entspricht.<br>Bei Fertigstellung wird einmalig Wissenschaft in Höhe der Kosten der teuersten freigeschalteten Technologie erzeugt.",
   ...
   Beijing: "Peking",
   BigBen: "Big Ben",
   BigBenDesc: "+2 Science From Busy Workers.<br>Choose an empire ideology, unlock more boost with each choice",
   ...
   BrandenburgGateDesc: "Der Multiplikator für Produktion, Lagerung und Arbeitskräfte erhöht sich bei allen Kohleminen und Ölquellen um 1.<br>Zusätzlich erhöht sich der Multiplikator für Produktion, Lagerung und von Ölraffinerien um die Anzahl angrenzender Ölquellen.",
   Bread: "Brot",
   Brewery: "Brauerei",
   Brick: "Ziegelstein",
   ...
   CircusMaximusDescV2: "+5 Zufriedenheit.<br>Bei sämtlichen Musiker-, Schriftsteller- und Malergilden steigt der Multiplikator für Produktion und Lagerkapazität um 1",
   ...
   CNTower: "CN Tower",
   CNTowerDesc: "Alle Filmstudios, Radiostationen und Fernsehsender sind von -1 Zufriedenheit ausgenommen.<br>Alle Gebäude, die in den Weltkriegen und im Kalten Krieg freigeschaltet werden, erhalten +N Produktions-, Arbeitskraft- und Lagermultiplikator. N = Zeitalter des Gebäudes - Stufe des Gebäudes.",
   Coal: "Kohle",
   ...
   GoldenGateBridgeDesc: "Alle Kraftwerke erhalten +1 Produktionsmultiplikator.<br>Gewährt Stromversorgung im Umkreis von 2 Kacheln um die Golden Gate Brücke.",
   ...
   GreatDagonPagodaDescV2: "Alle Pagoden sind von -1 Glück ausgenommen.<br>Erzeuge Wissenschaft basierend auf der Glaubensproduktion aller Pagoden",
   GreatMosqueOfSamarra: "Große Moschee von Samarra",
   GreatMosqueOfSamarraDescV2: "Sichtweite aller Gebäude erhöht sich um 1.<br>Außerdem werden 5 zufällig ausgewählte Lagerstätten sichtbar. Auf jeder davon wird eine Mine auf Stufe 10 errichtet.",
   ...
   GreatWallDesc: "Alle angrenzenden Gebäude erhalten +N Produktion, Arbeiterkapazität und Lagermultiplikator. N = Die Anzahl der Zeitalter zwischen dem aktuellen und dem Zeitalter, als das Gebäude freigeschaltet wurde.<br>Wenn sie neben der Verbotenen Stadt gebaut wird, erhöht sich die Reichweite auf 2 Kacheln.",
   ...
   HagiaSophiaDescV2: "+5 Zufriedenheit. Gebäude mit 0% Produktionskapazität sind von -1 Zufriedenheit ausgenommen.<br>Während des Spielstarts zusätzliches Glück bereitstellen, um einen Produktionsstopp zu vermeiden",
   HallOfSupremeHarmony: "Halle der höchsten Harmonie",
   Hammurabi: "Hammurabi",
   HangingGarden: "Hängende Gärten",
   HangingGardenDesc: "Der Multiplikator für Bauarbeiter erhöht sich um 1.<br>Bei benachbarten Aquädukten erhöht sich der Multiplikator für Produktion, Lagerung und Arbeitskräfte um 1",
   ...
   HatshepsutTempleDesc: "Deckt alle Gebiete mit Wasserquellen auf.<br>Weizenfarmen erhalten +1 Produktionsmultiplikator für jede angrenzende Kachel mit Wasser.",
   ...
   Hollywood: "Hollywood",
   HollywoodDesc: "+5 Zufriedenheit.<br>+1 Zufriedenheit für alle gut versorgten Gebäude im Umkreis von 2 Kacheln, die Kultur produzieren oder konsumieren",
   ...
   ManhattanProjectDesc: "Bei allen Uranminen erhöht sich der Multiplikator für Produktion, Lagervolumen und Arbeiter um 2.<br>Urananreicherung und Atomare Anlagen erhalten +1 Produktionsmultiplikator für jede angrenzende Uranmine, die auf einer Uranlagerstätte steht.",
   Marble: "Marmor",
   ...
   MogaoCavesDescV3: "+1 Zufriedenheit für jede 10% der beschäftigten Arbeiter.<br>Alle angrenzenden Gebäude, die Glauben produzieren, sind von -1 Zufriedenheit ausgenommen.",
   ...
   OsakaCastleDesc: "Provide power to all tiles within 2 tile range.<br>Allow electrification of science producing buildings (including Clone Lab)",
   OxfordUniversity: "Universität Oxford",
   OxfordUniversityDescV3: "+10% mehr Wissenschaft für Gebäude, die Wissenschaft produzieren.<br>Beim Abschluss werden einmalig die Kosten der teuersten bislang freigeschalteten Technologie generiert",
   ...
   Pantheon: "Pantheon",
   PantheonDescV2: "Alle Gebäude im Umkreis von 2 Kacheln erhalten +1 Arbeiterkapazität und Lagermultiplikator.<br>Erzeuge Wissenschaft basierend auf der Glaubensproduktion aller Schreine",
   Paper: "Papier",
   PaperMaker: "Papiermacher",
   Parliament: "Parlament",
   Parthenon: "Parthenon",
   ParthenonDescV2: "2 herausragende Persönlichkeiten der Klassik werden geboren und Du kannst jeweils aus 4 auswählen.<br>Musiker- und  Malergilden erhalten +1 Produktion, Arbeiter- und Speicherkapzität und sind von -1 Happiness befreit",
   ...
   ProphetsMosqueDesc: "Verdoppelung der Wirkung von Harun al-Rashid.<br>Erzeugung von Wissenschaft auf der Grundlage der Glaubensproduktion aller Moscheen",
   Province: "Provinz",
   ...
   RijksmuseumDesc: "+5 Zufriedenheit.<br>Bei allen Gebäuden, die Kultur verbrauchen oder produzieren, erhöht sich die Kapazität für Produktions, Lager und Arbeitskräfte um 1.",
   ...
   SaintBasilsCathedralDescV2: "Ermöglicht es, Gebäude zum Abbau von Ressourcen in Gebieten zu errichten, die an die Lagerstelle der Ressource angrenzen.<br>Bei allen benachbarten Gebäuden auf Stufe I erhöht sich der Multiplikator für Produktion, Arbeitskräfte und Lagervolumen um 1.",
   Saladin: "Saladin",
   Sand: "Sand",
   Sandpit: "Sandgrube",
   ...
   ShenandoahDescV2: "Gebäude, die im aktuellen Zeitalter freigeschaltet werden, erhalten +2 Produktionsmultiplikator.<br>Verdopple den Effekt von J.P. Morgan",
   ...
   SocialismLevel4DescHTML: "Erzeugt einmal Wissenschaft in Höhe der Kosten der günstigsten <b>Zeitalter der Weltkriege</b> Technologie.",
   SocialismLevel5DescHTML: "Erzeugt einmal Wissenschaft in Höhe der Kosten der günstigsten <b>Kalter Krieg</b> Technologie.",
   ...
   StatueOfZeusDesc: "Erzeuge zufällige Vorkommen, die auf benachbarten leeren Gebieten aufgedeckt wurden.<br>Bei allen angrenzenden Stufe I Gebäuden erhöht sich der Multiplikator für Produktion und Lagerkapazität um 5.",
   ...
   StPetersBasilicaDescV2: "Alle Kirchen erhalten +5 Speicher-Multiplikator.<br>Erzeuge Wissenschaft basierend auf der Glaubensproduktion aller Kirchen.",
   Submarine: "U-Boot",
   SubmarineYard: "U-Boot-Werft",
   SummerPalace: "Sommerpalast",
   SummerPalaceDesc:
      "Wenn sich auf einem angrenzenden Gebiet ein Gebäude befindet, das Schießpulver verbraucht oder produziert, erzeugt es nicht länger einen Verlust von Zufriedenheit.<br>Bei allen Gebäude, die Schießpulver verbrauchen oder produzieren, erhöht sich die Kapazität für Produktions, Lager und Arbeitskräfte um 1.",
   ...
   TajMahal: "Taj Mahal",
   TajMahalDescV2: "Je eine herausragende Persönlichkeit der Klassik und des Mittelalters werden geboren.<br>+5 Multiplikator für Kapazität, wenn Gebäude über Stufe 20 verbessert werden.",
   ...
   TerracottaArmyDesc: "Bei allen Eisenbergbau-Lagern erhöht sich der Multiplikator für Produktion, Arbeitskräfte und Lagerkapazität um 1.<br>Zusätzlich erhöht sich bei Eisenschmieden der Multiplikator für Produktion für jedes angrenzende Eisenbergbaulager um 1.",
   Theater: "Theater",
   Theme: "Thema",
   ...
   TheMet: "The Met",
   TheMetDesc: "Erzeugt nach dem Bau Teleporter, die zum Bewegen von Gebäuden verwendet werden können.<br>Alle Gebäude im Umkreis von 2 Kacheln erhalten einen Multiplikator von +1 für Produktion, Arbeiterkapazität und Lagerung.",
   ...
   UnitedNationsDesc: "Alle Gebäude der Stufen IV, V und VI erhalten +1 Produktions-, Arbeitskraft- und Lagermultiplikator.<br>Nimm an der UN-Generalversammlung teil und stimme jede Woche für einen zusätzlichen Schub ab.",
   ...
   ZagrosMountainsDesc: "Alle angrenzenden Gebäude, die weniger als 5 Produktionsmultiplikatoren haben, erhalten +2 Produktionsmultiplikatoren.<br>Verdopple den Effekt von Nebukadnezar II (Große Persönlichkeit)",
