export const RU = {
   ...
   BlackForestDesc: "При обнаружении на карте появляются все деревянные плитки. На соседних плитках появляется дерево. Все здания, которые используют древесину или пиломатериалы, получают +5 к производительности",
   Blacksmith: "Кузница",
   Blockchain: "Блокчейн",
   BobHope: "Боб Хоуп",
   ...
   CerneAbbasGiantDesc: "Великий человек текущей эпохи рождается, когда завершается постройка этого чуда",
   ...
   CrossPlatformSaveStatusCheckedOutTooltip: "Ваше кроссплатформенное сохранение было создано на другой платформе, вам необходимо зарегистрироваться на этой платформе, прежде чем вы сможете войти на этой платформе",
   ...
   GrandCanyonDesc: "Здания, разблокированные в текущей эпохе, получают +2 к можителю производства. Удваивает эффект от Дж. П. Моргана",
   ...
   GuyFawkesNight: "Ночь Гая Фокса: Ост-Индская компания увеличивает производительность зданий, прилегающих к караван-сараям, в 2 раза. Тауэрский мост на 20% быстрее генерирует великих людей",
   ...
   Language: "Язык",
   Lapland: "Лапландия",
   LaplandDesc: "Когда открыто, раскрывает всю карту. Все здания в пределах 2 плиток получают +5 к множителю производства. Это чудо природы можно будет обнаружить только в декабре",
   ...
   OfflineProductionTimeDescHTML: "Для <b>первого %{time} оффлайн времени</b>, вы можете выбрать либо производство в оффлайн или ускорение времени - вы можете уствновить разделитель здесь. <b>Оставшееся оффлайн время</b> может быть преобраховано только в ускорение времени",
   ...
   PlatformiOS: "iOS",
   PlatformSteam: "Steam",
   PlatformSyncInstructionHTML: "Если вы хотите синхронизировать свой прогресс на этом устройстве с новым устройством, нажмите <b>Синхронизировать с новым устройством</b>и получите одноразовый код доступа. На вашем новом устройстве нажмите <b>Подключиться к устройству</b> и введите одноразовый код доступа",
   Plato: "Платон",
   ...
   RockefellerCenterChristmasTree: "Рождественская елка в Рокфеллер центре",
   RockefellerCenterChristmasTreeDesc: "+3 Счастья за каждую открытую эпоху. Это чудо природы можно открыть только в декабре",
   Rocket: "Ракета",
   ...
   SantaClausVillageDesc: "После завершения строительства рождается великий человек текущей эпохи. Это чудо может быть улучшено, и каждое следуещее улучшение дает еще одного великого человека. Чтобы выбрать великих людей из этого чуда, предлагается 4 варианта. Это чудо может быть построено только в декабре",
   ...
   ThePentagonDesc: "После постройки генерирует телепорты, которые можно использовать для перемещения зданий. Все здания в пределах 2 плиток получают +1 к множителю продуктивности, рабочим и хранилищ",
   ...
   TradeFillSound: "Звук 'Сделака завершена'",
   ...
   YearOfTheSnakeDesc: "После завершения строительства, при входе в новую эпоху, вместо того, чтобы получать по одному великому человеку из каждой разблокированной эпохи, получите такое же количество великих людей в текущей эпохи. Все здания в радиусе 2 плиток получают +1 к множителю производства. Это чудо можно улучшить, каждое дополнительное улучшение дает +1 к множителю производства зданиям в радиусе 2 плиток. Это чудо может быть построено только в период лунного нового года (1.20 ~ 2.10)",
