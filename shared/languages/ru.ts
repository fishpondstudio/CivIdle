export const RU = {
   ...
   PlayerMapOccupyTileCondition2: "Вы не достигли максимального количества занятых плиток для вашего ранга",
