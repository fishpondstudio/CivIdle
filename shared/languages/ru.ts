export const RU = {
   ...
   DysonSphereDesc: "Все постройки получают +5 Множителя Производительности. Чудо можно улучшить, +1 Множитель Производительности за каждый уровень улучшения всем постройкам",
   ...
   InternationalSpaceStationDesc: "Все здания получают +5 Множителю Хранилища. Это чудо можно улучшить, за каждый уровень улучшения все здания получают +1 Множителя Хранилища",
   Internet: "Интернет",
   ...
   MarinaBaySandsDesc: "Все здания получают +5 Множителя производительности рабочих. Это чудо можно улучшить, за каждое улучшение все здания получают +1 Множителья производительности рабочих",
   Market: "Рынок",
   ...
   MatrioshkaBrainDesc: "Позволяет учитывать науку в стоимости империи (5 Науки = 1 Стоимость Империи). +5 Науки за каждого занятого и незанятого рабочего. Это чудо можно улучшить, +1 Науки за каждого занятого и незанятого рабочего за каждое улучшение ",
   ...
   MoveBuildingSelectTileToastHTML: "Выберите <b>пустую исследованную клетку</b> на карте как цель",
   Movie: "Фильм",
   ...
   NiagaraFallsDescV2: "Все склады, рынки и базары получают +N Множитель хранилища. N = число открытых эпох. Альберт Эйнштейн добавляет +1 Множителю производства Фонду исследований (на него не влияют другие улучшения, такие как Бродвей)",
   NielsBohr: "Нильс Бор",
   ...
   PalmJumeirahDesc: "+10 Мощности строительства. Это чудо можно улучшить, +2 Мощности строительства за каждое улучшение",
   Pantheon: "Пантеон",
   PantheonDescV2: "Все здания с радиусом 2 клетки получают +1 Производительности рабочих и Множителя хранилища. Генерирует науку, равную производству веры всех святилищ",
   Paper: "Бумага",
   ...
   Shelter: "Укрытие",
   Shenandoah: "Шенандоа",
   ShenandoahDescV2: "Здания, разблокированные в текущую эпоху, получают +2 Множителя производства. Двойной эффект от Дж. П. Морган",
   ...
   StPetersBasilicaDescV2: "Все церкви получают +5 Множителя хранилища. Генерирует науку, равную производству веры всех церквей",
   Submarine: "Подлодка",
   ...
   TheMet: "Метрополитен",
   TheMetDesc: "После постройки создайте телепорты, которые можно использовать для перемещения зданий. Все здания в радиусе 2 клеток получают +1 Множителя производства, Производительности рабочих и хранилища.",
   ...
   TowerOfBabelDesc: "Обеспечивает +2 Множителя производства всем зданиям, в которых есть хотя бы одно работающее здание, расположенное рядом с чудом.",
   ...
   WallOfBabylonDesc: "Все здания получают +N Множителя хранилища. N = количество открытых эпох / 2",
   WallStreet: "Уолл-стрит",
   WallStreetDesc: "Все здания, производящие монеты, банкноты, облигации, акции и валюту в радиусе 2 клеток получают +N Множителя производства. N = Случайное значение от 1 до 5, которое разное для каждого здания и меняется при каждом обновлении рынка. Двойной эффект Джона Д. Рокфеллера",
   ...
   ZagrosMountainsDesc: "Все соседние здания с множителем производства менее 5 получают +2 Множителя производства. Двойной эффект Навуходоносора II (Великого Человека)",
   Zenobia: "Зенобия",
   ZenobiaDesc: "+%{value}ч Хранилища Временного Разрыва в Петре",
   ZhengHe: "Чжэн Хэ",
   ZigguratOfUr: "Зиккурат Ура",
   ZigguratOfUrDesc: "Каждые 10 счастья (ограничение) дают +1 Множителю производства для всех зданий (максимум = количество разблокированных эпох / 2). Чудеса (включая природные) больше не дают +1 Счастья. Эффект можно отключить",
