export const RU = {
   ...
   ManhattanProjectDesc: "Все урановые рудники получают множитель +2 к  множителю производству, мощности работников и хранилищу. Заводы по обогащению урана и атомные объекты получают +1 к множителю производства за каждую прилегающую урановую шахту, построенную на месте уранового месторождения",
   Marble: "Мрамор",
   ...
   SagradaFamiliaDesc: "Все здания в радиусе 2 плиток получают +N к множителю производства, мощности работников и хранилища. N = максимальная разница в тирах между прилегающими зданиями",
   ...
   UnitedNations: "ООН",
   UnitedNationsDesc: "Все здания IV, V и VI тиров получают +1 к Множителю Производства, Мощности Работников и Хранилища. Участвуйте в Генеральной ассамблее ООН и голосуйте, чтобы каждую неделю получать дополнительный бонус",
