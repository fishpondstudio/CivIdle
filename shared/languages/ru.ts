export const RU = {
   ...
   BlackForestDesc: "При обнаружении на карте появляются все деревянные плитки. На соседних плитках появляется дерево. Все здания, которые используют древесину или доски, получают +5 к производительности",
   Blacksmith: "Кузница",
   Blockchain: "Блокчейн",
   BobHope: "Боб Хоуп",
   ...
   PlatformiOS: "iOS",
   PlatformSteam: "Steam",
   PlatformSyncInstructionHTML: "Если вы хотите синхронизировать свой прогресс на этом устройстве с новым устройством, нажмите <b>Подключиться к Устройству</b>и получите одноразовый код доступа. На вашем новом устройстве нажмите <b>Подключиться к устройству</b> и введите одноразовый код доступа",
   Plato: "Платон",
