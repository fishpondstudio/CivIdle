export const RU = {
   ...
   AbuSimbelDescV2: "Каждый уровень дает +100% эффекта Рамсеса II (Великого человека). Все чудеса в пределах X плиток дают +1 к Счастью. X = уровень этого чуда",
   ...
   AkademikLomonosovDescV2: "Это чудо можно улучшать, каждый уровень дает 100 кВт энергии. Обеспечивает энергией все плитки в радиусе 2 плиток. Это чудо можно перемещать",
   ...
   Alloy: "Сплав",
   AllTransportsWithDistance3TileAreImmediate: "Все транспортировки на расстоянии <= 3 плиток осуществляются мгновенно",
   Ally: "Союзник",
   ...
   AntonieVanLeeuwenhoek: "Антони ван Левенгук",
   ...
   ArcDeTriompheDescV2: "За каждую единицу счастья (максимум +50) дается +1 к Множителю Мощности Строительства для всех зданий",
   Archimedes: "Архимед",
   Architecture: "Архитектура",
   AreYouSureYouWantToRebirthAsX: "Вы уверены, что хотите переродиться в %{city}?",
   ...
   AuroraBorealisDesc: "Все здания, не производящие работников, в радиусе 2 клеток получают +X к Множителю Производства. X зависит от времени, прошедшего с момента открытия чуда",
   ...
   BirthdayOfXIsY: "День рождения %{name} в %{date}",
   Bitcoin: "Биткоин",
   ...
   Blacksmith: "Кузница",
   Blockchain: "Блокчейн",
   BlockXCurrentGameSession: "Заблокировать %{name} (Текущая игровая сессия)",
   BlockXCurrentGameSessionDesc: "Вы уверены, что хотите заблокировать <b>%{name}</b>? Блокировка действует только в течение текущей игровой сессии.",
   ...
   BranCastleDescV2:
      "Производит X рабочих. X = рабочие, произведенные в радиусе 3 плиток. Если рабочих достаточно, также наймет X рабочих в качестве вампиров. Вампиры не производят и не транспортируют ресурсы, но считаются занятыми рабочими. Уровень Замка Бран определяется общим количеством рабочих, и каждый уровень дает +1 Науки за незанятого рабочего и +2 Науки за занятого рабочего. Это чудо можно построить только во время Хэллоуина (15.10 ~ 15.11)",
   ...
   BuildWithin0TileRange: "Построить на выбранной плитке",
   BuildWithinXTileRange: "Построить на пустых плитках в радиусе %{range} клеток",
   BuySupporterPack: "Купить Пакет Поддержки",
   Cable: "Кабель",
   ...
   CaravansaryNetwork: "Торговый путь",
   Caravel: "Каравелла",
   ...
   CarryOverWatchedResources: "Запомнить отслеживаемые Ресурсы",
   CarryOverWatchedResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingStatisticsOffice: "Запомнить отслеживаемые Ресурсы для следующего забега. Вкладка отображается только после постройки Офиса статистики",
   CarryOverWatchedTradeableResources: "Запомнить отслеживаемые Торгуемые ресурсы",
   CarryOverWatchedTradeableResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingACaravansary: "Запомнить отслеживаемые Ресурсы, которыми можно торговать, для следующего забега. Вкладка отображается только после постройки Базара",
   Carthage: "Карфаген",
   ...
   ChateauFrontenac: "Замок Фронтенак",
   ChateauFrontenacDesc: "Это чудо можно улучшать. При каждом повышении уровня случайным образом выбираются три здания из текущей эпохи. Выберите одно из них, чтобы получить +1 к Уровню Зданий (выбор нельзя изменить)",
   ...
   CircusMaximusDescV3: "+5X Счастья. Все Гильдии Музыкантов, Гильдии Писателей и Гильдии Художников получают +X к Множителям Производства и Хранилища. X = уровень этого чуда",
   ...
   Colosseum: "Колизей",
   ColosseumDescV3: "Колесничные мастерские освобождены от -1 Счастья. Потребляет 10X Колесниц и производит +5X Счастья. Каждый разблокированный век дает +X Счастья. X = уровень этого чуда",
   ...
   DinosaurProvincialParkDesc: "Это чудо можно активировать в выбранное время, чтобы получить разовое количество Коти, равное 15% стоимости империи на тот момент",
   DinosaurProvincialParkNotUsedWarningHTML: "Вы еще не активировали <b>Провинциальный Парк Динозавров</b> — подумайте об активации перед перерождением",
   Diplomacy: "Дипломатия",
   Display3PaintingsByJohannesVermeerToUnlock1ProductionMultiplier: "Разместите 3 картины Йоханнеса Вермеера, чтобы получить +1 к Множителю производства",
   Display3PaintingsByRembrandtVanRijnToUnlock1ProductionMultiplier: "Разместите 3 картины Рембрандта Ван Рейна, чтобы получить +1 Множитель производства",
   Display3PaintingsByVincentVanGoghToUnlock1ProductionMultiplier: "Разместите 3 картины Винсента ван Гога, чтобы получить +1 к Множителю производства",
   Display5MasterpiecesToUnlock1BuildingLevelBoost: "Разместите 5 шедевров, чтобы получить +1 к уровню здания",
   DisplayPaintingsBy5DifferentPaintersToUnlock1BuildingLevelBoost: "Разместите картины 5 разных художников, чтобы получить +1 к уровню здания",
   DisplayPaintingsWith5DifferentThemesToUnlock1BuildingLevelBoost: "Разместите картины с 5 различными жанрами, чтобы получить +1 к уровню здания",
   DistanceInfinity: "Не ограничено",
   DistanceInTiles: "Дистанция (В Плитках)",
   DiversificationBonus: "Бонус диверсификации",
   DiwaliV3: "Дивали: Увеличивает радиус реки Ганг до 2-х плиток. Увеличивает радиус Ступы Санчи на 2 плитки. Увеличивает радиус Красного Форта до 5-ти плиток",
   ...
   EachPairOfAdjacentPaintingsByTheSamePainterV2: "Каждая пара соседних картин одного и того же художника дает +0.5 к уровню здания",
   EachPairOfAdjacentPaintingsOfTheSameSizeV2: "Каждая пара соседних картин одинакового размера дает +0.5 к Множителю производства",
   EachPairOfAdjacentPaintingsPaintedInTheSameCenturyV3: "Каждая пара смежных картин, написанных в том же столетии (100 лет), дает +2 Науки от Незанятых Работников",
   EachPairOfAdjacentPaintingsWithTheSameTheme: "Каждая пара соседних картин с одинаковым жанром дает +5 к Множителю Мощности Строительства",
   EasterBunny: "Пасхальный Кролик",
   EasterBunnyConstructed: "Пасхальный Кролик построен",
   ...
   EmpireValueImpactAfterTariff: "Влияние на Стоимость Империи (после пошлин)",
   EmpireValueIncrease: "Увеличение стоимости империи",
   EmployedVampires: "Занятые Вампиры",
   ...
   EnterExitMinimizedMode: "Включить/Выключить компактный режим",
   ...
   Every5WindMillsLevelGives1ProductionMultiplierToAdjacentPowerPlants: "Каждые 5 уровней Ветрогенератора дают +1 к Множителю Производства прилегающих электростанций",
   ...
   Gallery: "Галерея",
   GalleryPainterFransHals: "Франс Халс",
   GalleryPainterGeorgeHendrikBreitner: "Джордж Хендрик Брайтнер",
   GalleryPainterJacobVanRuisdael: "Якоб ван Рейсдал",
   GalleryPainterJanSteen: "Ян Стин",
   GalleryPainterJohannesVermeer: "Йоханнес Вермеер",
   GalleryPainterKarelAppel: "Карел Аппель",
   GalleryPainterPieterBruegelTheElder: "Питер Брейгель Старший",
   GalleryPainterPieterDeHooch: "Питер де Хуч",
   GalleryPainterPietMondrian: "Пит Мондрайн",
   GalleryPainterRachelRuysch: "Рэйчел Рюйш",
   GalleryPainterRembrandtVanRijn: "Рембрандт ван Рейн",
   GalleryPainterVincentVanGogh: "Винсент ван Гог",
   GalleryPaintingAMothersDuty: "Материнский долг",
   GalleryPaintingBroadwayBoogieWoogie: "Буги-Вуги на Бродвее",
   GalleryPaintingCafeTerraceAtNight: "Ночная терраса кафе",
   GalleryPaintingCompositionWithRedBlueAndYellow: "Композиция с красным, синим и жёлтым",
   GalleryPaintingGirlInAWhiteKimono: "Девушка в белом кимоно",
   GalleryPaintingGirlWithAPearlEarring: "Девушка с жемчужной серёжкой",
   GalleryPaintingGrayTree: "Серое дерево",
   GalleryPaintingSelfPortrait1889: "Автопортрет (1889)",
   GalleryPaintingStillLifeWithFlowersOnAMarbleSlab: "Натюрморт с цветами на мраморной плите",
   GalleryPaintingSunflowers: "Подсолнухи",
   GalleryPaintingTheAnatomyLessonOfDrNicolaesTulp: "Урок анатомии доктора Николаса Тульпа",
   GalleryPaintingTheArtOfPainting: "Искусство живописи",
   GalleryPaintingTheBanquetOfTheOfficersOfTheStGeorgeMilitiaCompany: "Банкет офицеров роты ополчения Святого Георгия",
   GalleryPaintingTheCourtyardOfAHouseInDelft: "Дворик в Делфте",
   GalleryPaintingTheCryingCrocodileTriesToCatchTheSun: "Плачущий крокодил пытается поймать Солнце",
   GalleryPaintingTheFeastOfSaintNicholas: "Праздник Святого Николая",
   GalleryPaintingTheHuntersInTheSnow: "Охотники на снегу",
   GalleryPaintingTheJewishBride: "Еврейская невеста",
   GalleryPaintingTheLaughingCavalier: "Смеющийся кавалер",
   GalleryPaintingTheLittleStreet: "Маленькая улица",
   GalleryPaintingTheMerryFamily: "Счастливое семейство",
   GalleryPaintingTheMilkmaid: "Молочница",
   GalleryPaintingTheNightWatch: "Ночной дозор",
   GalleryPaintingThePotatoEaters: "Едоки картофеля",
   GalleryPaintingTheSingelBridgeAtThePaleisstraatInAmsterdam: "Мост Сингел на улице Палейсстраат в Амстердаме",
   GalleryPaintingTheStarryNight: "Звёздная ночь",
   GalleryPaintingViewOfHaarlemWithBleachingFields: "Вид на Харлем с белеющими полями",
   GalleryPaintingWheatFieldWithCrows: "Пшеничное поле с воронами",
   GalleryPaintingWindmillAtWijkBijDuurstede: "Ветряная мельница около Вейк-бий-Дюрстеде",
   GalleryPaintingWomanHoldingABalance: "Женщина, держащая весы",
   GalleryThemeAbstract: "Абстракция",
   GalleryThemeDomesticScene: "Домашняя сцена",
   GalleryThemeLandscapeCityscape: "Ландшафт/Городской пейзаж",
   GalleryThemePortrait: "Портрет",
   GalleryThemeStillLife: "Натюрморт",
   GameCalendar: "Игровой Календарь",
   Gameplay: "Геймплей",
   GangesRiver: "Река Ганг (Ганга)",
   GangesRiverDescV3: "Все типы зданий (кроме зданий производящих работников) в радиусе одной плитки получают бонус к продукции +N, где N = уровень Мудрости Эпох для эры, к которой относится это здание",
   Garment: "Одежда",
   ...
   Generate1hTimeWarpWhenEnteringANewAge: "Генерирует 1 час Временного разрыва при входе в новую эпоху (в зависимости от лимита хранилища)",
   GenerateOneTimeKotiEqualToXOfTheTotalBuildingValue: "Генерирует одноразовое количество Коти, равное %{percent} от общей стоимости зданий",
   GenerateOneTimeKotiEqualToXOfTheTotalEmpireValue: "Генерирует одноразовое количество Коти, равное %{percent} от общей стоимости империи",
   GenerateOneTimeScienceEqualToTheCheapestTechnologyOfTheCurrentAge: "Генерирует единоразово Науку, равную самой дешевой технологии текущего века",
   GenerateOneTimeScienceEqualToTheCostOfTheMostExpensiveTechnologyOfTheCurrentAge: "Генерирует единоразово Науку, равную стоимости самой дорогой технологии текущего века",
   Genetics: "Генетика",
   ...
   GreatPeopleBirthday: "Дни рождения Великих Людей",
   GreatPeopleBirthdayDesc: "Дни рождения Великих Людей: %{names} - их эффекты удваиваются!",
   ...
   GreatSphinxDescV3: "Все здания в пределах X плиток получают +N к Множителю Производства. Для каждого затронутого здания, N это количество соседних зданий того же типа. X = уровень этого чуда",
   GreatWall: "Великая Китайская стена",
   GreatWallDescV2: "Все здания в пределах X плиток получают +N к Множителям Производства, Производительности Работников и Хранилища. N это количество эпох между текущей и эпохой, когда здание было открыто. X = уровень этого чуда. Постройка рядом с Запретным Городом увеличивает дальность действия на 1 плитку",
   ...
   Habitat67DescV2:
      "Это чудо может быть улучшено и каждый уровень дает +1 к Множителю Производства, Производительности Работников и Хранилища для ИИ Лабораторий. Дает +1 к Множителю Производства и Хранилища для ИИ Лабораторий за каждый уровень Мудрости Информационного Века. Дает +1 к Уровню Здания для ИИ Лабораторий за каждые 5 счастья (ограничено).",
   ...
   HangingGardenDesc: "+1 к Множителю Мощности Строительства. Соседние Акведуки получают +1 к Множителям Производства, Производительности Работников и Хранилища",
   Hannibal: "Ганнибал",
   ...
   Herding: "Стадо",
   Hermitage: "Эрмитаж",
   HermitageDesc: "Это чудо можно улучшать, и каждый уровень дает +1 к Множителю Хранилища для каждого типа зданий в радиусе 2 клеток",
   Herodotus: "Геродот",
   ...
   IronTech: "Железо",
   IrrigatedEstate: "Орошение земли",
   ...
   KeepersSpecialDay: "Особенный день Хранителей Нашего Сервера: %{names} (каждый из них дает +1 к Множителю Производства и +1 к Бонусу уровня здания для всех зданий)",
   KeepOurServerOnPackOptions: "Опции пакета Хранителя нашего сервера",
   ...
   KizhiPogostDescV2: "Все здания в радиусе 3 плиток получают +X к Множителю Производства. X = множитель производства, который получает это чудо",
   Knight: "Рыцарь",
   KnightCamp: "Лагерь Рыцарей",
   KoningsdagV3: "День короля: Кёкенхоф предоставляет зданиям, расположенным в пределах 3 плиток, Множитель производства, равный 25% от общего количества Счастья, которое они приносят. Бонус за коллекцию художников Маурицхёйса и бонус за диверсификацию удваиваются",
   Koti: "Коти",
   KotiInStorage: "Коти в хранилище",
   KotiProduction: "Коти производится",
   Kremlin: "Кремль",
   LakeBaikal: "Озеро Байкал",
   LakeBaikalDesc: "+X к Множителю Мощности Строительства. X = суммарный уровень чудес в радиусе 2 клеток",
   LakeLouise: "Озеро Луиза",
   LakeLouiseDesc: "Все соседи на торговой карте становятся союзниками (независимо от цивилизации). Каждая плитка союзника дает +2 к Уровню Зданий",
   ...
   LockTradeProfit: "Зафиксировать торговую прибыль",
   ...
   LunarNewYearV2: "Лунный Новый год: Великая Китайская стена и Башня Жёлтого журавля также предоставляет каждому затронутому зданию Бонус Уровня Здания, равный Множителю Производства, который он обеспечивает. Фарфоровая Пагода дает +1 уровень всем Великим людям из этого забега",
   ...
   Maslenitsa: "Масленица: Удваивает радиус действия Кижского погоста и Озера Байкал. Удваивает выходную мощность Академика Ломоносова",
   ...
   MauritshuisDesc: "На каждом уровне Маурицхёйса обнаруживается картина Голландского художника (всего 30 картин). Эти картины можно разместить в галерее, чтобы получить различные бонусы",
   ...
   MidsummerDesc: "Увеличивает уровень здания на +X для всех зданий в радиусе Y плиток. X = Множитель Производства, который получает здание от Мудрости Эпох. Y = Уровень Середины лета. Это чудо может быть построено только в период летнего солнцестояния (10.06 - 30.06)",
   ...
   MoveTileConfirm: "Вы уверены, что хотите занять эту плитку? Оккупированные вами плитки будут потеряны и вы не сможете получить новую плитку в течение %{time} часов.",
   Movie: "Фильм",
   MovieStudio: "Киностудия",
   Museum: "Музей",
   Music: "Музыка",
   MusiciansGuild: "Гильдия Музыкантов",
   MuteWhenBackgrounded: "Заглушить в фоновом режиме",
   ...
   NoKotiExportDesc: "Здания не смогут импортировать Коти из Швейцарского Банка, но они по-прежнему смогут импортировать Коти из других зданий.",
   ...
   OnlyYouCanSeeThis: "Только вы можете это видеть",
   OnYourSpecialDayDesc: "В ваш особенный день, все игроки получают +1 к Множителю Производства и +1 к Бонусу уровня здания для каждого здания. Ваш особенный день отмечен в игровом календаре. <b>Это можно изменить только один раз в %{cooldown} дней.</b>",
   ...
   OpetV3: "Опет: Великий Сфинкс также предоставляет каждому затронутому зданию Бонус Уровня Здания, равный Множителю Производства, который он обеспечивает",
   ...
   Pagoda: "Пагода",
   Painter: "Художник",
   PainterAdjacency: "По художнику",
   PaintersCollectionBonus: "Бонус Коллекции Художников",
   ...
   Parthenon: "Парфенон",
   ParthenonDescV3: "Каждый уровень дает 2 Великих человека Классического Века, и 4 варианта выбора для каждого. Гильдии Музыкантов и Гильдии Художников получают +1 к Множителям Производства, Производительности Работников и Хранилища и освобождаются от -1 Счастья",
   ...
   PhoenicianAlphabet: "Финикийское письмо",
   Physics: "Физика",
   PierreDeCoubertin: "Пьер де Кубертен",
   PincerMovement: "Захват в клещи",
   PinResourceTab: "Закрепить окно ресурсов",
   PinTodo: "Закрепить",
   PinTodoTooltip: "Закрепить вкладку списка дел в крайнем левом положении",
   Pizza: "Пицца",
   Pizzeria: "Пиццерия",
   ...
   PlayerMapOccupyThisTile: "Оккупировать эту плитку",
   ...
   Plus2ActiveTradesForKeeperOfOurServer: "+2 Активные Заявки для Хранителя Нашего Сервера",
   Plus2ActiveTradesForSupporter: "+2 Активные Заявки для Пакета Поддержки",
   ...
   PlusXBaseStorageForMarketWarehouseAndCaravansary: "+%{percent} Базового Хранилища для Рынка, Склада и Базара",
   PlusXGreatPeopleFromTheCurrentAge: "+%{count} Великих Людей из текущего века",
   ...
   PorcelainTowerDescV2: "+5 Счастья, плюс +1 к Счастью за каждый дополнительный уровень. После постройки, все ваши Дополнительные Великие Люди за Перерождение становятся доступны в текущем забеге, следуя тем же правилам выбора, что и постоянные Великие люди",
   ...
   PortOfSingaporeDesc: "Это чудо можно улучшать, и каждый уровень дает +1 к Производству (влияет на Мощность Транспортировки Ресурсов) и Множителю Хранилища для Рынков, Складов и Караван-сараев",
   Poseidon: "Посейдон",
   ...
   ProducedWorkers: "Произведено Работников",
   ...
   PunicCoinage: "Пуническая чеканка монет",
   ...
   QuickUiModeTooltip: "При выборе или отмене выбора ресурса количество за цикл и максимум будут автоматически перераспределены между выбранными ресурсами",
   QutbMinar: "Кутб-Минар",
   QutbMinarDescV2: "Когда постройка завершена, рождается Великий Человек из любой случайной эпохи, кроме текущей. Это чудо можно улучшать, и после каждого улучшения будет рождаться новый Великий Человек из любой случайной эпохи, кроме текущей. Каждый раз предлагается выбор из двух вариантов",
   ...
   RebirthAsX: "Переродиться в %{city}",
   RebirthHistory: "История перерождения",
   RebirthHistoryAll: "Все",
   RebirthHistoryEmpireValuePerCycle: "ВЛ/Цикл",
   RebirthHistoryEmpireValuePerWallSecond: "ВЛ/Секунду",
   RebirthHistoryEmpireValueV2: "Стоимость Империи",
   RebirthHistoryEmpty: "История Перерождений пока недоступна",
   RebirthHistoryExtraGreatPeopleAtRebirth: "дВЛ",
   ...
   RegenerateGreatPersonPortraitsDesc: "Для повышения производительности портреты великих людей кэшируются. Если кэшированные портреты устарели (например, при переключении между языками), вы можете принудительно обновить их",
   Regenerating: "Обновление...",
   Reichstag: "Рейхстаг",
   ReinforcedConcrete: "Железобетон",
   ReinforcedConcretePlant: "Фабрика Железобетона",
   Religion: "Религия",
   ...
   RembrandtVanRijn: "Рембрандт ван Рейн",
   RememberLastBuildRange: "Запомнить выбранный радиус строительства",
   RememberTheLastSelectedBuildRangeAfterYouBuildInRangeTheValueIsRememberedDuringTheCurrentGameSession: "Запомнить последний выбранный радиус строительства - это значение запоминается во время текущей игровой сессии",
   Renaissance: "Ренессанс",
   RenaissanceAge: "Ренессанс",
   ReneDescartes: "Рене Декарт",
   RequiredDeposit: "Требуется Месторождение",
   RequiredTotalWorkers: "Требуется всего работников",
   ...
   ResearchSuperintelligence: "Исследовать Сверхразум",
   ...
   RestitutorDescHTML:
      "Добавьте в список желаемого мою новую игру — <b>Restitutor: Empire Restored</b>. Это историческая инкрементальная глобальная стратегия, сосредоточенная на <i>искусстве управления государством, дипломатии и продуманной войне</i>. Действие происходит в Римской империи после смерти Коммода в 192 году н.э., когда империя распадается на враждующие провинции. Как наместник, возглавьте выбранную вами провинцию и восстановите империю.",
   RestitutorEmpireRestoredEarlyAccess: "Restitutor: Empire Restored Ранний Доступ",  
   ...
   SanchiStupa: "Ступа Санчи",
   SanchiStupaDescV2: "Транспортировка из зданий и в здания, в радиусе 2 плиток от Ступы Санчи, осуществляется мгновенно. Это чудо можно улучшить, за каждое улучшение +1 к радиусу",
   Sand: "Песок",
   ...
   School: "Школа",
   Science: "Наука",
   ScienceCarryingOver: "Переносимая Наука",
   ...
   SelectAdaptiveGreatPeopleBoost: "Выберите бонус Адаптивного Великого Человека",
   ...
   SendCartographerDescHTML: "Картограф исследует <b>все плитки</b> на карте. Отправка картографа стоит <b>%{science} Науки</b> и разблокируется технологией <b>Исследования</b> (Эпоха Возрождения)",
   SendCartographerTechDesc: "Картограф: Отправка картографа на неисследованную плитку откроет все плитки на карте",
   ...
   ShowTradesFrom: "Показать сделки от %{name}",
   ...
   SourceGreatPersonBirthday: "День рождения (Великий Человек): %{person}",
   SourceGreatPersonPermanent: "Постоянный Великий Человек: %{person}",
   SourceGreatPersonPermanentBirthday: "День рождения (Постоянный Великий Человек): %{person}",
   ...
   SpecialDayEffectDesc: "Все здания получают +1 к Множителю Производства и +1 к Бонусу уровня здания.",
   Spinner: "Спиннер",
   ...
   Sputnik1: "Спутник-1",
   Sputnik1DescV3:
      "Это чудо может быть улучшено и каждый уровень дает +1 уровень всем Великим людям Холодной войны в этом забеге (за исключением Великих людей, которые дают повышение уровня) и +1 к Множителю Производства и Хранилища для Космодрома. Дает +1 к Множителю Производства и Хранилища для Космодрома за каждый уровень Мудрости Эпохи Холодной войны",
   Stable: "Конюшня",
   Stadium: "Стадион",
   ...
   StatueOfZeusDescV2: "На прилегающих пустых плитках появляются случайные известные месторождения. Все здания в пределах X плиток получают +5 к Множителям Производства и Хранилища. X = уровень этого чуда",
   ...
   SuffeteAdministration: "Суффетская администрация",
   ...
   SwissBankDescV3: "Конвертируйте выбранный ресурс из всех доступных для торговли ресурсов игрока в Коти (10 миллионов на санскрите). Каждый уровень Швейцарского банка добавляет 1 Коти за цикл, на который влияет множитель производства. Швейцарский банк может хранить неограниченное количество Коти.",
   Sword: "Меч",
   ...
   ThankYouForSupporting: "Спасибо за поддержку разработки CivIdle и поддержание работы серверов",
   Theater: "Театр",
   Theme: "Тема",
   ThemeAdjacency: "По жанру",
   ...
   Today: "Сегодня",
   TodayIsTheBirthdayOfX: "Сегодня день рождения %{name} - эффект этого великого человека удваивается!",
   TodoTabs: "Вкладки списка дел",
   ToggleWatchForThisResourceWatchedResourcesAreDisplayedInADedicatedTopLeftTab: "Отслеживать этот ресурс: отслеживаемые ресурсы отображаются в отдельной вкладке в левом верхнем углу",
   ...
   TradesCanBeClaimedHTML: "Вы можете завершить %{count} обменов, убедитесь, что у вас достаточно места в хранилищах. Нажмите сюда для подробностей",
   TradeTile: "Торговая плитка",
   ...
   TranslatorCredit: "WingedLeo, schizophrenia, r1j1k, Luc1ferSam91, vladbaldin666, CaoLex, JunoCat, Akulka",
   ...
   TransportPlanCacheTimeout: "Время ожидания Кэша Транспортного плана",
   TransportPlanCacheTimeoutDescHTML: "Иногда кэш транспортного плана может устаревать. Это принудительно очистит кэш после указанного количества секунд. <b>Должно быть между %{min} и %{max} секундами</b>",
   TreatyDiplomacy: "Международный договор",
   ...
   TutorialBuildHutsHTML:
      "Чтобы построить хижину, нажмите на <b>пустую клетку</b>, а затем на <b>построить</b> рядом с <b>Хижина</b>. При завершении постройки, она раскрывает Туман Войны поблизости. Хижины производят небольшое количество рабочих, которые нужны для обеспечения работы других зданий, а также производства науки.",
   ...
   TutorialResearchCountingHTML:
      "Для исследования технологии, нажмите на вкладку <b>Наука</b>, выберите технологию, которую хотите изучить и нажмите <b>Открыть</b> на правой стороне панели. Если у вас недостаточно очков науки, вы можете продолжать улучшать свои хижины, т.к чем больше занятых рабочих, тем больше будет генерироваться очков науки.",
   ...
   UndoUpgradesForAllPermanentGreatPeopleThatAreEligibleForAgeWisdom: "Отменить улучшения для всех постоянных Великих Людей, имеющих право на Мудрость Эпох",
   ...
   UnitedNations: "ООН",
   UnitedNationsDescV2:
      "Все здания IV, V и VI тира получают +1 к Производству, Производственной Мощности за Работника и Множителю Хранилища. Каждую неделю участвуйте в голосовании Генеральной Ассамблеи ООН и совместно выбирайте дополнительные бонусы. Это чудо можно улучшить и каждое улучшение дает +1 к бонусам от Генеральной Ассамблеи ООН",
   ...
   UNVoteDescriptionHTML: "Здания, за которые проголосовали в Генеральной Ассамблее ООН, получают <b>+5 к Множителю Производства</b>",
   Upgrade: "Улучшить",
   ...
   UpgradeAllPermanentGreatPeopleThatAreEligibleForAgeWisdom: "Улучшить всех постоянных Великих Людей, имеющих право на Мудрость Эпох",
   UpgradeAllPermanentGreatPeopleThatAreUpgradeable: "Улучшить всех улучшаемых постоянных Великих Людей",
   ...
   UpgradeWisdomEligible: "Доступно улучшение Мудрости",
   Uranium: "Уран",
   ...
   View: "Посмотреть",
   ViewMenu: "Вид",
   ViewOnWikipedia: "Посмотреть %{name} на Википедии",
   ViewTechnology: "Посмотреть",
   VincentVanGogh: "Винсент ван Гог",
   ...
   WatchedTradeableResources: "Отслеживаемые торгуемые ресурсы",
   Water: "Вода",
   ...
   WinterCarnival: "Зимний карнавал: Удваивает радиус действия Северного Сияния. Удваивает бонус Уровня Зданий от Замка Фронтенак и Хабитата 67",
   ...
   WorldTradeOrganizationDesc: "Это чудо можно улучшать, и каждый уровень дает +1 к Множителю Производства для зданий с Бонусом Торговой Плитки. Участвуйте в еженедельном голосовании ВТО, которое увеличивает шанс появления выбранных зданий в Бонусе Торговой Плитки на следующей неделе",
   ...
   WTOVoteDescriptionHTML: "У зданий, за которые проголосовали во Всемирной торговой организации, <b>выше шанс</b> появиться в Бонусе Торговой Плитки",
   ...
   XBaseStorageForWarehouseAndCaravansary: "+%{percent} к Базовому Хранилищу для Рынков, Складов и Караван-сараев",
   XBuildingsWillBeBuilt: "Будет построено %{count} зданий",
   XDifferentMasterpieces: "%{count} Разные шедевры",
   XDifferentPainters: "%{count} Разные художники",
   XDifferentThemes: "%{count} Разные жанры",
   XhWarpStorageThisRun: "+%{hour}ч Хранилища Временного разрыва в этом прохождении",
   XPaintingsBy: "%{count} Картины автора %{painter}",
   XResourceHasBeenDestroyed: "<b>%{amount} %{resource}</b> было уничтожено",
   XRunsInTotal: "%{count} Забегов всего",
   XSpecialDay: "%{name} Особенный День",
   Xuanzang: "Сюаньцзан",
   ...
   YouAreOfflineHTML: "В настоящее время вы не подключены к серверу. Проверьте подключение к интернету и нажмите, чтобы перезагрузить игру. Возможно, потребуется перезапустить Steam, если перезагрузка не поможет",
   YouHaveAdaptiveGreatPeopleWithBoostToSelect: "У вас есть Адаптивные Великие люди, бонус которых нужно выбрать",
