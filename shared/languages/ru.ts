export const RU = {
   ...
   EndConstructionDesc:
      "При прекращении строительства все уже использованные ресурсы не будут возвращены",
   Stonehenge: "Стоунхендж",
   StonehengeDesc: "Все здания, которые потребляют или производят камень, получают +1 к Множителю для Производства",
   ...
   ProductionPriorityDesc: "Высокий приоритет означает, что здание транспортирует ресурсы, раньше других зданий",
   ...
   PlayerTradeCancelTrade: "Отменить",
   ...
   PetraNoMultiplier: "На Петру не действуют никакие множители (продукции, мощности рабочих, хранилища, и т.д.)",
