export const RU = {
   ...
   MaxOfflineProductionTimeDesc: "Максимальное время оффлайн-продикции %{time}. Остальное превращается в Ускорение Времени",
   ...
   ThemeSpinnerAlpha: "Спиннер Альфа",
   ...
   TutorialResearchBronzeTechHTML: "После изучения технологии Бронза откроются плитки <b>Copper</b>. Вы можете строить <b>Copper Mining Camp</b> на них для добычи меди.",
   TutorialResearchCountingHTML: "Для исследования технологии, нажми на вкладку <b>Research</b>, выбери технологию, которую хочешь изучить и нажми <b>Unlock</b> на правой стороне панели. Если у тебя недостаточно очков науки, ты можешь продолжать улучшать свои хижины, т.к чем больше занятых рабочих, тем больше будет генерироваться очков науки.",
   TutorialResearchHousingHTML:
     "Исследуй технологию Жильё, чтобы разблокировать <b>House</b>, который даёт бо́льшее количество рабочих чем Хижина. После исследования Жилья, твоя империя войдёт в <b>Bronze Age</b>, и родится великий человек Бронзового Века. Ты сможешь выбрать одного из трёх — великий человек даёт существенный прирост — выбирай с умом.",
   ...
   TutorialSetHousePriorityHTML: "Дома предоставляют рабочих, которые нужны для поддержи работы функционирующих зданий. Тебе нужно установить Приоритет на <b>Самый высокий</b> (который 10) для всех строений, дающих рабочих.",
   TutorialSetPriorityToX: "Установить %{building} Приоритет на %{priority}",
   TutorialUpgrade35LevelsHTML:
      "При улучшении строений ты можешь нажать <b>~5</b>, чтобы поднять его уровень 5 раз. Ты также можешь задать уровень улучшения в правой панели, пока здание улучшается. Повышая уровень строения, повышается количество производимого им товара и размер его <b>хранилища</b>. У строений ограниченная вместимость хранилища и при его заполнении они остановят производство.",
   ...
   UseMonospaceNumbersDescHTML: "Использовать моноширинный шрифт для цифр (все одинаковой ширины), что бы помочь с выравниванием в различных таблицах",
