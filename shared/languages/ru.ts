export const RU = {
   ...
   AccountUpgradeConfirmDescV2:
      "Улучшение вашего аккаунта приведет к <b>сбросу вашего текущего пробега</b> и переносу постоянных великих людей в пределах разрешенных уровней. Это <b>нельзя</b> отменить, вы уверены, что хотите продолжить?",
   Acropolis: "Акрополь",
   ...
   BuildingNoMultiplier:
      "%{building} <b>не зависит</b> ни от каких мультипликаторов (производство, количество рабочих, хранение и т.д.)",
   ...
   FontSizeScaleDescHTML:
      "Изменение размера шрифта в пользовательском интерфейсе игры. <b>Установка масштаба больше 1x может сломать интерфейс</b>",
   ...
   GoldenGateBridgeDesc:
      "Все электростанции получают +1 множитель производства. Обеспечивает энергией все плитки в радиусе 2 плиток",
   ...
   Hollywood: "Голливуд",
   HollywoodDesc:
      "+5 Счастья. +1 счастье за каждое хорошо укомплектованное здание, потребляющее или производящее культуру в радиусе 2 плиток",
   ...
   ManhattanProjectDesc:
      "Все урановые рудники получают множитель +2 к  множителю производству, мощности работников и хранилищу. Заводы по обогащению урана и атомные объекты получают +1 к множителю производства за каждую прилегающую урановую шахту, построенную на месте уранового месторождения",
   Marble: "Мрамор",
   ...
   NileRiver: "Река Нил",
   NileRiverDesc:
      "Удвойте эффект Хатшепсута (великий человек). Все пшеничные фермы получают +1 к Множителям Производства и Хранилища. Все прилегающие пшеничные фермы получают +5 к Множителям Производства и Хранилища",
   NoDepositDesc:
   ...
   Parthenon: "Парфенон",
   ParthenonDescV2:
      "Рождаются два великих человека Классического века, и вы получаете 4 варианта выбора для каждого. Гильдии Музыкантов и Гильдии Художников получают +1 к множителю производства, мощности работников и множителю хранения, а также освобождаются от -1 к счастья",
   ...
   ProductionPriorityDescV2:
      "Более высокий приоритет означает, что это здание транспортирует раньше других зданий. Большее число означает более высокий приоритет",
   Progress: "Прогресс",
   ...
   RequiredWorkersTooltip:
      "Необходимое количество рабочих для производства равно сумме всех потребляемых и производимых ресурсов с учетом множителей (кроме электрификации)",
   RequirePower: "Требуется Электричество",
   RequirePowerDesc:
      "Это здание должно быть построено на плитке с электричеством и может распространять электричество на прилегающие плитки",
   ...
   SagradaFamiliaDesc:
      "Все здания в радиусе 2 плиток получают +N к множителю производства, мощности работников и хранилища. N = максимальная разница в тирах между прилегающими зданиями",
   ...
   TajMahal: "Тадж-Махал",
   TajMahalDescV2:
      "Рождается великий человек Классического Века и великий человек Среднего Века. Множитель +5 к множителю мощности строительства при улучшении зданий выше 20-го уровня",
   ...
   UNGeneralAssemblyMultipliers:
      "<b>+%{count}</b> к Множителю Производства, Мощности Работников и Хранилища для <b>%{buildings}</b>",
   UNGeneralAssemblyNext: "Предстоящая Генеральная Ассамблея ООН #%{id}",
   UNGeneralAssemblyVoteEndIn:
      "Вы можете изменить свой голос в любое время до окончания голосования через <b>%{time}</b>",
   UniqueBuildings: "Уникальные здания",
   UnitedNations: "ООН",
   UnitedNationsDesc:
      "Все здания IV, V и VI тиров получают +1 к Множителю Производства, Мощности Работников и Хранилища. Участвуйте в Генеральной ассамблее ООН и голосуйте, чтобы каждую неделю получать дополнительный бонус",
   ...
   Water: "Вода",
   WellStockedTooltip:
      "Хорошо укомплектованные здания - это здания, у которых достаточно ресурсов для производства, к ним относятся здания, которые производят, имеют полное хранилище или не производят из-за отсутствия рабочих",
   Wheat: "Пшеница",
   ...
   Wood: "Дерево",
   Worker: "Работник",
   WorkerCapacityMultiplier: "Множитель Мощности Работников",
