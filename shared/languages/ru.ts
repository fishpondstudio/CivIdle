export const RU = {
   ...
   EachPairOfAdjacentPaintingsByTheSamePainter: "Каждая пара соседних картин одного и того же художника дает +1 к Множителю производства",
   EachPairOfAdjacentPaintingsOfTheSameSize: "Каждая пара соседних картин одинакового размера дает +1 к уровню здания",
   EachPairOfAdjacentPaintingsPaintedInTheSameCentury: "Каждая пара соседних картин, написанных в одном и том же столетии (100 лет), приносит +5 к Счастью",
   ...
   GalleryPaintingTheBanquetOfTheOfficersOfTheStGeorgeMilitiaCompany:
      "Банкет офицеров роты ополчения Святого Георгия",
   ...
   Dutch: "Голландия",
   Binnenhof: "Бинненхоф",
   KoningsdagV2: "День короля: Кёкенхоф предоставляет зданиям, расположенным в пределах 3 плиток, Множитель производства, равный 50% от общего количества Счастья, которое они приносят. Бонус за коллекцию художников Маурицхёйса и бонус за диверсификацию удваиваются",
   ...
   Keukenhof: "Кёкенхоф",
   KeukenhofDesc: "+X Счастья. X = количество различных ресурсов, производимых или потребляемых в пределах 3 плиток",
