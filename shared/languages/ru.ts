export const RU = {
   ...
   CathedralOfBrasiliaDesc:
      "Если каждое функционирующее здание в радиусе в 2 плитки от этого чуда составляет цепь производства, то есть ресурсы, производящиеся одними зданиями, потребляются другими зданиями в цепи, то каждое здание в цепи производства получает +X к модификатору производства, где X = длинна производственной цепи",
   CathedralOfBrasiliaWarningHTML: "Здания считается частью производственной цепи, если <b>все, кроме одного</b> ресурса, производимых зданием, потребляются другим зданием.",
   ...
   TradesCanBeClaimedHTML: "Вы можете заверишить %{count} обменов, убедитесь, что у вас на складах достаточно места. Нажмите сюда для подробностей",
   ...
   TurnOnTimeWarpDescV2: "Стоимость %{cost} очков ускорения за каждую секунды ваша Империя растет на %{speed}-й скорости.",
   TutorialBuildAqueductHTML: "Домам нужна вода, но ваши акведуки производят недостаточно. Улучшите имеющие или постройте новые, что бы удовлетворить эту потребность",
   ...
   UnclaimedGreatPeopleThisRun: "Великие Люди не выбранные в этот забег",
   UnclaimedGreatPeopleThisRunHTML: "У вас осталось не выбрано <b>%{count}</b> Великих Людей в этом забеге. Нажмите, что бы перейти к выбору",
   UnclaimedPermanentGreatPeople: "Выбрать постоянных Великих Людей",
   UnclaimedPermanentGreatPeopleHTML: "У вас осталось не выбрано <b>%{count}</b> постоянных Великих Людей, Нажмите, что бы перейти к выбору",
   ...
   UseMonospaceNumbers: "Использовать моноширный шрифт для цифр",
   UseMonospaceNumbersDescHTML: "Использовать моноширный шрифт для цифр (все одинаковой ширины), что бы помочь с выравниванием в различных таблицах",
