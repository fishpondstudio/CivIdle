export const RU = {
   ...
   Diwali: "Дивали: Увеличение радиуса действия реки Ганг (Ганга) до 3х плиток. Увеличение радиуса действия Санчи Ступа до 3х плиток. Удвоенное увеличение уровня зданий от Лал-Кила.",
   ...
   GangesRiverDesc: "Каждый тип здания в радиусе 2 клеток получает +N к множителю производства, N = уровень мудрости эпохи, в которой здание было открыто.",
   Garment: "Одежда",
   ...
   QutbMinarDesc:
      "После завершения строительства рождается великий человек — он может быть из любой эпохи, кроме текущей. Это чудо можно улучшать, и каждое последующее улучшение приводит к рождению ещё одного великого человека, который может быть из любой эпохи, кроме текущей. При выборе великих людей из этого чуда предоставляется 4 варианта.",
   ...
   SundarbansDesc: "Удваивает эффект всех Мудростей эпох",
