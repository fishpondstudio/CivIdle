export const RU = {
   ...
   GuyFawkesNight: "Ночь Гая Фокса: Ост-Индская Компания увеличивает производительность зданий, прилегающих к Базарам, в 2 раза. Тауэрский Мост на 20% быстрее генерирует великих людей",
