export const RU = {
   ...
   ShowTransportArrowDescHTML: "Отключение этого параметра скроет стрелки транспорта. Это может <i>немного</i> улучшить производительность на слабых устройствах.",
