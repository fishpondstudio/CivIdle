export const RU = {
   ...
   Laozi: "Лао-Цзы",
   Lapland: "Лапландия",
   LaplandDesc: "Когда открыто, раскрывает всю карту. Все здания в пределах двух плиток получают +5 к Множителю производства. Это чудо природы может быть обнаружено только в Декабре",
