export const RU = {
   ...
   DinosaurProvincialParkDesc: "Это чудо можно активировать в выбранное время, чтобы получить разовое количество Коти, равное 25% стоимости империи на тот момент",
