export const RU = {
   ...
   AkademikLomonosovDesc: "Это чудо можно улучшать, и каждый уровень дает 100 кВт энергии. Дает +X к Множителю Производства и Хранилища для Космодрома. X = Уровень Мудрости Эпохи Холодной Войны. Обеспечивает электроэнергией все плитки в радиусе 2 клеток. Это чудо можно перемещать",
   ...
   Habitat67Desc: "Это чудо можно улучшать, и каждый уровень дает +1 к Множителю Производства, Производительности Работников и Хранилища для ИИ Лабораторий. Дает +1 к Уровню Зданий для ИИ Лабораторий за каждые 5 единиц Счастья (с ограничением)",
   Hermitage: "Эрмитаж",
   ...
   KizhiPogostDesc: "Все здания в радиусе 2 клеток получают +X к Множителю Производства. X = Множитель производства, который получает это чудо",
   Koti: "Коти",
   Kremlin: "Кремль",
   ...
   Sputnik1: "Спутник-1",
   Sputnik1Desc: "Это чудо можно улучшать, и каждый уровень дает +1 уровень всем Великим Людям Эпохи Холодной Войны в этом забеге (кроме Великих Людей, дающих бонус к уровню)",
   Surplus: "Излишек",
