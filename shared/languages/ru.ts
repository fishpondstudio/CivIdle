export const RU = {
   ...
   BuildingExtractDeposit: "Данное строение способно добывать ресурс клетки",
   ...
   CappadociaDesc: "Все здания в радиусе 3 клетки получают +1 к Множителям Производства, Производительности Работников и Хранилища за каждый уровень выше 30-го",
   Capybara: "Капибара",
   CapybaraDesc: "Все здания в радиусе 2 клетки получают +X к Множителю производства, где X = количество пустых плиток в радиусе 2 клетки от этого чуда",
   Car: "Машина",
   Caravansary: "Базар",
   ...
   Carnival: "Карнавал: Капибара, Гигантская Выдра, Гоацин и Венценосный мухоед увеличивают свою зону эффекта до 3 клеток. Удваивает множитель производства от Кафедрального собора Пресвятой Девы Марии",
   ...
   ChooseGreatPersonChoicesLeft: "У вас осталось %{count} выбора",
   ...
   GiantOtterDesc: "Все здания в радиусе в 2 плитки получают +X к множителю продукции. X = количество пустых клеток в радиусе 2 плитки от чуда.",
   Glass: "Стекло",
   GlassFrog: "Стеклянная лягушка",
   GlassFrogDesc: "Все здания в радиусе в 3 плитки получают +X к множителю хранилища. X = количество пустых клеток в радиусе 3 плитки от чуда.",
   ...
   Hoatzin: "Гоацин",
   HoatzinDesc: "Все здания в радиусе в 2 плитки получают +X к уровню здания. X = количество пустых клеток в радиусе 2 плитки от чуда.",
   Hollywood: "Голливуд",
   ...
   ItaipuDamDesc: "Это чудо можно улучшать, каждый уровень можно либо увеличить множитель производства на +1, либо повысить уровень здания на +1 для зданий в радиусе 2 клеток. Обеспечивает электроэнергией все клетки в радиусе 2 клеток",
   ...
   MausoleumAtHalicarnassusDescV2: "Транспортировка в и из строений в радиусе двух клеток не использует рабочих",
   ...
   MiddleClickDescHTML: "Выберите построенное или строющеся здание, перенесите курсор на пустую клетку и нажмите на <b>колёсико мышки</b> для <b>копирования</b> выбранного здания",
   ...
   MountAraratDesc: "Все строения в радиусе в 2 клетки получают +X к множителям производства, производственной мощи за работника и хранилища. X = кубическому корню эффективного уровня Великих Людей",
   ...
   Pantheon: "Пантеон",
   PantheonDescV2: "Все здания в радиусе 2 клетки получают +1 к Множителю Производительности Работников и Хранилища. Генерирует науку, в зависимости от производства веры всех святилищ",
   Paper: "Бумага",
   ...
   PygmyMarmosetDesc: "Все здания в радиусе в 3 плитки получают +X к множителю хранилища. X = количество пустых клеток в радиусе 3 плитки от чуда.",
   ...
   RoyalFlycatcherDesc: "Все строения в радиусе в 2 плитки получают +X к уровню здания. X = количество пустых клеток в радиусе 2 плитки от чуда.",
   ...
   TutorialBuildLoggingCampsHTML: "Лесозаготовительные лагеря должны быть построены на клетке с <b>Деревом</b>. Выберите клетку с лесом и нажмите <b>Построить</b> рядом с <b>Лесозаготовительный лагерь</b>.",
   ...
   TutorialBuildStoneQuarriesHTML: "Каменный Карьер должен быть построен на плитке с <b>Камнем</b>. Выберите каменную плитку и нажмите на кнопку <b>Построить</b> рядом с <b>Каменным Карьером</b>.",
   TutorialBuildWheatFarmHTML: "Чтобы быстро построить много зданий, ты можешь <b>выбрать плитку с построенным зданием</b> и, наведясь на свободную плитку, нажать <b>колёсико мышки</b> - это автоматически скопирует выбранное здание в свободную плитку.",
   TutorialBuildX: "Построй %{building}",
   TutorialBuildXBuildings: "Построй %{count} %{building}",
   ...
   TutorialEnterClassicalAgeHTML: "Твоя империя войдёт в Классический Век после исследования любой технологии из Классического Века. Ты сможешь выбрать великого человека из Классического Века, Железного Века и Бронзового Века.",
   ...
   TutorialRebirthHTML: "Когда ощущается сильное замедление прогресса, тебе стоит решить переродиться. Когда перерождаешься, великие люди из этого забега превращаются в осколки постоянных великих людей, которые можно использовать для улучшения постоянных великих людей. Ты также можешь выбрать другую цивилизацию — у каждой цивилизации есть свой уникальный контент.",
   ...
   TutorialResearchCountingHTML: "Для исследования технологии, нажми на вкладку <b>Наука</b>, выбери технологию, которую хочешь изучить и нажми <b>Открыть</b> на правой стороне панели. Если у тебя недостаточно очков науки, ты можешь продолжать улучшать свои хижины, т.к чем больше занятых рабочих, тем больше будет генерироваться очков науки.",
   TutorialResearchHousingHTML:
     "Исследуй технологию Жильё, чтобы разблокировать <b>Дом</b>, который даёт бо́льшее количество рабочих чем Хижина. После исследования Жилья, твоя империя войдёт в <b>Бронзовый Век</b>, и родится великий человек Бронзового Века. Ты сможешь выбрать одного из трёх — великий человек даёт существенный прирост — выбирай с умом.",
   TutorialResearchLandTradeTechHTML: "После исследования Сухопутной Торговли твоя империя войдёт в Железный Век. Ты сможешь выбрать великого человека из Железного Века и Бронзового Века. Технология Сухопутная Торговля также разблокирует Базар.",
   TutorialResearchXTech: "Исследовать технологию %{tech}",
   TutorialSetHousePriorityHTML: "Дома предоставляют рабочих, которые нужны для поддержки работы функционирующих зданий. Тебе нужно установить Приоритет на <b>Самый высокий</b> (который 10) для всех строений, дающих рабочих.",
   TutorialSetPriorityToX: "Установить Приоритет у %{building} на %{priority}",
   TutorialUpgrade35LevelsHTML:
      "При улучшении зданий ты можешь нажать <b>~5</b>, чтобы поднять его уровень 5 раз. Ты также можешь задать уровень улучшения в правой панели, пока здание улучшается. Повышая уровень здания, повышается количество производимого им ресурса и размер его <b>хранилища</b>. У зданий ограниченная вместимость хранилища и при его заполнении оно остановит своё производство.",
   TutorialUpgradeHutsHTML: "Чтобы улучшить хижину, выбери <b>Хижину</b>, и нажми <b>+1</b>. На время улучшения хижина перестанет предоставлять работников, поэтому стоит улучшать их по одной за раз. Более высокие уровни улучшения требуют больше ресурсов.",
