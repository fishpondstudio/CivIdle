export const RU = {
   ...
   EachPairOfAdjacentPaintingsPaintedInTheSameCenturyV2: "Каждая пара соседних картин, написанных в одном и том же столетии (100 лет), дает +5 Науки за занятого рабочего",
