export const RU = {
   ...
   FestivalTech: "Разблокировать Фестиваль - положительное Счастье (макс. 50) конвертируется в Фестивальные Очки. За каждые 25 Фестивальных Очков ваша империя входит в Цикл Фестиваля, предоставляя значительный бонус, специфичный для карты",
   ...
   Thanksgiving: "День благодарения: Уолл-стрит обеспечивает двойной прирост для зданий и распространяется на взаимный фонд, хедж-фонд и майнер биткоинов. Исследовательские фонды получают +5 к Множителю Производства",
