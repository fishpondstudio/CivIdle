export const RU = {
   ...
   AdvisorElectricityContentV2:
      "Электростанции добавляют две новые системы. Первая из них, 'Электроэнергия', обозначается значком молнии на плитке рядом с построенной и работающей электростанцией. Некоторые здания (начиная с Радиостанции в эре Мировых Войн) имеют обозначение 'требуется электричество'. <b>Это означает, что оно должно быть построено на такой клетке</b>. Если это здание построено на такой клетке и функционирует, оно также будет распространять энергию на соседние плитки, а это означает, что электроэнергию можно распространять до тех пор, пока хотя бы одно из зданий в цепочке касается электространции.<br><br>Вторая система, 'Электрофикация', может быть применено <b>к любому зданию на любой плитке</b>, за исключением зданий, производязих науки или работников. Эта система использует энергию, производящуюся на электростанциях, для добавления дополнительных уровней зданию. Количество электроэнергии, требуемой для каждого нового уровня здания увеличивается. Здания, требующие электроэнергию, получают +5 бонусных уровней здания от электрофикации",
   ...
   BuildingLevelBoostFromElectrification: "Бонус уровня здания от электрофикации",
   ...
   ElectrificationLevel: "Уровень электрофикации",
   ...
   NoKotiExportDesc: "Здания не смогут импортировать Koti из Swiss Bank, но они по-прежнему смогут импортировать Koti из других зданий.",
   ...
   TranslatorCredit: "WingedLeo, schizophrenia, r1j1k, Luc1ferSam91, vladbaldin666, CaoLex",
   ...
   TutorialUpgrade35LevelsHTML:
      "При улучшении строений ты можешь нажать <b>~5</b>, чтобы поднять его уровень 5 раз. Ты также можешь задать уровень улучшения в правой панели, пока здание улучшается. Повышая уровень строения, повышается количество производимого им ресурса и размер его <b>хранилища</b>. У строений ограниченная вместимость хранилища и при его заполнении они остановят производство.",
   ...
   UnitedNationsDescV2: "Все здания IV, V и VI тира получают к +1 Производству, Производственной Мощности за Работника и Множителю Хранилища. Каждую неделю участвуйте в голосовании Генеральной Ассамблеи ООН и совместно выбирайте дополнительные бонусы. Это чудо можно улучшить и каждое улучшение дает +1 к бонусам от Генеральной Ассамблеи ООН",
