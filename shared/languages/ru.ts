export const RU = {
   ...
   DariusI: "Дарий I",
   Confucius: "Конфуций",
   ConfuciusDesc: "+%{value} Науки от Всех Работников, Если Больше 50% Работников Заняты",
   Socrates: "Сократ",
   ...
   IsidoreOfMiletusDesc: "+%{value} Множитель Вместимости Строителей",
   ...
   Fibonacci: "Фибоначчи",
   FibonacciDescV2:
      "+%{idle} Науки тт Свободных Работников. +%{busy} Науки от Занятых Работников. Стоимость Улучшения Фибоначчи Растет Согласно Последовательности Фибоначчи",
   ...
   EndConstructionDescHTML:
      "Если Вы Прекратите Строительство, Все Затраченные Ресурсы <b> Не Будут Возвращены</b>",
   ...
   CircusMaximusDescV2:
      "+5 к Счастью. Все Гильдии Музыкантов, Гильдии Писателей и Гильдии Художников Получат +1 к Множителям Производства и Хранилища",
   ...
   GreatDagonPagodaDesc: "Пагода Шведагон",
   SagradaFamília: "Саграда Фамилия",
   SagradaFamíliaDesc: "Саграда Фамилия",
   Petra: "Петра",
   PetraDesc:
   ...
   OxfordUniversityDescV2: "Каждое Улучшение Постройки в Вашей Империи Добавляет +5 к Науке Каждый Цикл",
   ...
   ForbiddenCityDesc:
      "Все Заводы Бумаги, Гильдии Писателей и Печатные Дома Получат +1 к Множителям Производства, Хранилища и Работника",
   Borobudur: "Боробудур",
   BorobudurDesc: "Боробудур",
   ItsukushimaShrine: "Храм Ицукусима",
   ItsukushimaShrineDesc: "Храм Итсукушимы",
