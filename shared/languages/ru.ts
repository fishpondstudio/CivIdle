export const RU = {
   ...
   HimejiCastleDesc:
      "Все Верфи Каравелл, Верфи Галеонов, и Верфи Фригатов получают +1 к Множителю Производства, Множителю Производительности Работников и Множителю Хранения",
   TajMahal: "Тадж-Махал",
   TajMahalDesc:
   ...
   MogaoCavesDescV2:
      "+1 счастья за каждые 10% занятых работников. Все примыкающие хранмы освобождаются от -1 счастья",
   Wonder: "Чудо",
   ...
   TechResourceTransportPreferenceDistance: "Дитсанция",
