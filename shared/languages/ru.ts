export const RU = {
   ...
   CathedralOfBrasiliaDesc: "Если каждое функционирующее здание в радиусе в 2 плитки от этого чуда составляет цепь производства, то есть ресурсы, производящиеся одними зданиями, потребляются другими зданиями в цепи, то каждое здание в цепи производства получает +X к модификатору производства, где X = длинна производственной цепи",
   ...
   LiberalismLevel5DescHTMLV2: "Все строения получают бонус <b>+5 к уровню здания</b> от электрификации",
   ...
   ReadPatchNotesHTML: "Вы обновились до <b>%{version}</b> (<b>%{build}</b>), пожалуйства, ознакомьтесь с описанием изменений на странице игры в <b>Steam</b>",
   Rebar: "Арматура",
   ...
   SwissBankDescV2: "Преобразует выбранный ресурс из соседнего склада в Koti (10 миллионов в Санскрите) — торговый ресурс, стоимостью в 10 миллионов. Каждый уровень of Швейцарского Банка добавляет 1 преобразование в Koti в цикл, на которое действует множитель производства. Швейцарский Банк может хранить неограниченное количество Koti",
   Sword: "Меч",
