export const RU = {
   ...
   BrandenburgGateDesc: "Все угольные шахты и нефтяные скважины получают +1 к Множителям Производства, Хранилища и Работника. Нефтеперерабатывающие заводы получают +1 к Множителям Производства, Хранилища и Работника за каждую примыкающую плитку Нефти",
   Bread: "Хлеб",
   Brewery: "Пивоварня",
   Brick: "Кирпич",
   ...
   BuildingColorMatchBuildingTooltip: "Копирует цвет с постройки, которая производит этот ресурс. Если есть более одного варианта, выбирает случайным образом",
   ...
   EiffelTowerDesc: "Все прилегающие Сталелитейные Заводы получают +N к Множителям Производства, Хранилища и Работника. N = Число прилегащих Сталелитейных Заводов",
   ...
   ForbiddenCityDesc: "Все Заводы Бумаги, Гильдии Писателей и Типографии получают +1 к Множителю Производства, Множителю Производительности Работников и Множителю Хранения",
   Frigate: "Фрегат",
   ...
   HangingGardenDesc: "+1 Множитель Производительности Строителей. Соседние акведуки получают +1 к Множителям Производства, Хранилища и Работника",
   Happiness: "Счастье",
   ...
   HatshepsutTempleDesc: "Открывает все водные плитки на карте после завершения строительства. Пшеничные фермы получают +1 Множитель Производства за каждую водную плтику прилегающую к Пшеничной Ферме",
   Headquarter: "Центральный Офис",
   HelpMenu: "Помощь",
   Herding: "Стадо",
   Herodotus: "Геродот",
   HimejiCastle: "Замок Химедзи",
   HimejiCastleDesc: "Все Верфи Каравелл, Верфи Галеонов, и Верфи Фрегатов получают +1 к Множителю Производства, Множителю Производительности Работников и Множителю Хранения",
   Hollywood: "Голливуд",
   ...
   NileRiver: "Река Нил",
   NileRiverDesc: "Удвойте эффект Хатшепсута (великий человек). Все пшеничные фермы получают +1 к Множителям Производства и Хранилища. Все прилегающие пшеничные фермы получают +5 к Множителям Производства и Хранилища",
   ...
   Parthenon: "Парфенон",
   ParthenonDescV2: "Рождаются два великих человека Классического века, и вы получаете 4 варианта выбора для каждого. Гильдии Музыкантов и Гильдии Художников получают +1 к множителю производства, мощности работников и множителю хранения, а также освобождаются от -1 к счастья",
   ...
   PersepolisDesc: "Все Меднодобывающие Лагеря, Лесозаготовительные Лагеря и Каменные карьеры получают +1 к Множителю Производства, Множителю Производительности Работников и Множителю Хранения",
   Petra: "Петра",
   ...
   RequiredWorkersTooltip: "Необходимое количество рабочих для производства равно сумме всех потребляемых и производимых ресурсов с учетом множителей (кроме электрификации)",
   ...
   RijksmuseumDesc: "+5 Счастья. Все здания, что производят или потребляют Культуру получают +1 к Мощности Производства, Хранилища и Работника",
   ...
   SaintBasilsCathedralDescV2: "Позволяет добывающим зданиям работать рядом с месторождением. Все соседние здания 1-го тира получают +1 к Множителю Производства, Множителю Производительности Работников и Множителю Хранения",
   Sand: "Песок",
   ...
   StatueOfLibertyDesc: "Все прилегающие постройки получают +N к Множителям Производства, Хранилища и Работника. N = Количество прилегающих построек одного типа",
   StatueOfZeus: "Статуя Зевса",
   StatueOfZeusDesc: "Производит на прилегающих плитках случайные месторождения, которые были обнаружены. Все прилегающие здания 1-го Тира получают +5 к Множителям Производства и Хранилища",
   ...
   SummerPalaceDesc: "Все прилегающие здания, потребляющие или производящие Порох, освобождаются от -1 Счастья. Все здания, потребляющие или производящие Порох, получают +1 к Множителям Производства, Хранилища и Работника",
   Sword: "Меч",
   ...
   TajMahal: "Тадж-Махал",
   TajMahalDescV2: "Рождается великий человек Классического Века и великий человек Среднего Века. Множитель +5 к множителю мощности строительства при улучшении зданий выше 20-го уровня",
   ...
   TempleOfArtemisDesc: "Все Кузницы Мечей и Арсеналы получат +5 к Уровню, когда завершится строительство. Все Кузницы Мечей и Арсеналы получают +1 к Множителю Производства, Множителю Производительности Работников и Множителю Хранения",
   ...
   TerracottaArmyDesc: "Все Железодобывающие Лагеря получают +1 к Множителю Производства, Множителю Производительности Работников и Множителю Хранения. Кузницы Железа получают +1 к Множителю Производства за каждый примыкающий Железодобывающий Лагерь, который построен на месте месторождения железа",
   Theater: "Театр",
   Theme: "Тема",
   ...
   UNGeneralAssemblyMultipliers: "<b>+%{count}</b> к Множителю Производства, Мощности Работников и Хранилища для <b>%{buildings}</b>",
   ...
   YangtzeRiverDesc: "Yangtze River Desc",
   YellowCraneTower: "Yellow Crane Tower",
   YellowCraneTowerDesc: "Yellow Crane Tower Desc",
   Zenobia: "Зенобия",
