export const RU = {
   ...
   BastilleDay: "День взятия Бастилии: Удваивает эффект от Центра Помпиду и Триумфальной арки. Удваивает произвоодство Кулбтуры от Мон Сен-Мишеля",
   Voltaire: "Вольтер",
   PlayerMapMapTileBonus: "Бонус торговой плитки",
   PlayerMapOccupyThisTile: "Занять эту плитку",
   PlayerMapOccupyTileCondition1: "Эта плитка прилигает к вашим домашней или занятым плиткам",
