export const ZH_CN = {
   ...
   GreatOceanRoad: "大洋路",
   GreatOceanRoadDesc: "该奇观可被升级，每一级为贸易地块加成相应建筑提供 +1 额外建筑等级（不包括相邻玩家加成）",
   GreatPeople: "伟人",
   ...
   Moomba: "蒙巴节：大洋路每一级额外为贸易地块加成相应建筑提供 +1 生产乘数。乌鲁鲁的范围增加至周围 3 地块范围",
   ...
   Zoroaster: "琐罗亚斯德",
   Zugspitze: "楚格峰",
   ZugspitzeDesc: "对于每个已解锁时代，获得一项点数。点数可被用于提升任意（本轮诞生的）此生伟人的额外等级（仅限生产乘数生效）",
};
