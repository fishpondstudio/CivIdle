export const ZH_CN = {
   ...
   CentrePompidouDesc:
      "建造完成后，所有建筑获得 +1 生产乘数和 +2 存储乘数。如果当前的游玩达到信息时代，下一次游玩是不同的文明，那么该奇观将持续存在。该奇观对于每次游玩未点亮的文明达到信息时代后，在重生时点亮重生前的文明，每一个点亮的文明额外提供 +1 生产乘数和 +2 存储乘数。该奇观的价值不计入帝国的总价值中，大英博物馆无法转换为该奇观。",
