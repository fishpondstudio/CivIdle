export const ZH_CN = {
   ...
   EuphratesRiverDesc: "从事生产（非运输）的忙碌劳动者占比每有 10% ，为所有不生产劳动者且为之前时代的解锁建筑，提供 +1 生产乘数（每个时代最大值如下：石器至铁器为1，古典至中世纪为2,文艺复兴至工业为3，世界大战至冷战为4，信息为5）。当空中花园在其旁建造完成，基于空中花园解锁后的每个时代，使空中花园获得 +1 效果。当此奇观被发现时，与该奇观相邻无沉积资源的地块生成水资源",
   ...
   Voltaire: "伏尔泰",
   WallOfBabylon: "巴比伦城墙",
   WallOfBabylonDesc: "所有建筑获得 +N 存储乘数， N 为（青铜至石器为1，古典至中世纪为2,文艺复兴至工业为3，世界大战至冷战为4，信息为5）",
   WallStreet: "华尔街",
