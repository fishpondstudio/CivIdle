export const ZH_CN = {
   ...
   Aqueduct: "引水渠",
   ArcDeTriomphe: "凯旋门",
   ArcDeTriompheDescV2: "每 1 幸福（最大值为 50）为所有建筑提供 +1 建造者能力乘数。",
   Archimedes: "阿基米德",
   Architecture: "建筑学",
   ...
   BroadwayDesc: "诞生一位当前时代伟人与一位上时代伟人。选择一位伟人使其效果翻倍（时代智慧除外）",
   BronzeAge: "青铜时代",
   BronzeTech: "青铜",
   ...
   CentrePompidouDesc:
      "建造完成后，所有建筑获得 +1 生产乘数和 +2 存储乘数。如果当前的游玩达到信息时代，下一次游玩是不同的文明，那么该奇观将持续存在。该奇观对于每次游玩未记录的文明达到信息时代后，在重生时记录重生前的文明，每拥有一个记录在册的文明额外提供 +1 生产乘数和 +2 存储乘数。该奇观的价值不计入帝国的总价值中，大英博物馆无法转换为该奇观。",
   ...
   DukeOfZhou: "周公旦",
   DuneOfPilat: "彼拉特沙丘",
   DuneOfPilatDesc: "在每一个时代时,都为上一个时代的时代智慧加成效果翻倍。",
   ...
   EasterBunny: "复活节兔子",
   EasterBunnyDesc: "建造完成后，重生时将复制 10％ 的额外伟人，并在下轮游玩中建造复活节兔子后根据已的解锁时代诞生这些伟人。该奇观仅可在四月建造",
   ...
   GrandCanyon: "大峡谷",
   GrandCanyonDesc: "当前时代的解锁建筑，获得 +2 生产乘数。约翰·皮尔庞特·摩根效果翻倍（时代智慧除外）",
   ...
   HolyEmpire: "神圣帝国",
   Homer: "荷马",
   Honor4UpgradeHTML: "<b>郑和</b>（伟人）效果翻倍（时代智慧除外）",
   ...
   MountTai: "泰山",
   MountTaiDesc: "所有产出科学的建筑，获得 +1 生产乘数。孔子（伟人）效果翻倍（时代智慧除外）。当被发现时，生成一批科学，生成量等同于已解锁最昂贵科技所需",
   MoveBuilding: "移动建筑",
   ...
   NileRiver: "尼罗河",
   NileRiverDesc: "哈特谢普苏特（伟人）效果翻倍（时代智慧除外）。所有小麦农场，获得 +1 生产与存储乘数。所有与该奇观相邻的小麦农场，获得 +5 生产与存储乘数",
   ...
   ProphetsMosqueDesc: "哈伦·拉希德效果翻倍（时代智慧除外）。其产生的科学，基于所有清真寺的信仰总产出",
   Province: "区域",
   ProvinceAegyptus: "埃及",
   ProvinceAfrica: "非洲",
   ProvinceAsia: "亚洲",
   ...
   SantaClausVillageDesc: "建成时，诞生一位当前时代伟人。该奇观可被升级，并且每一次额外升级，提供一位额外伟人。当从这座奇观进行伟人选择时，每位伟人有 4 项可选。该奇观仅可在十二月建造",
   SargonOfAkkad: "萨尔贡大帝",
   Satellite: "卫星",
   ...
   WallStreet: "华尔街",
   WallStreetDesc: "周围 2 地块范围内，所有产出硬币、钞票、债券、股票以及外汇的建筑，获得 +N 生产乘数。N 为 1 至 5 的随机值，每座受加成建筑单独取值，并且该值随每次市场更新而改变。约翰·D·洛克菲勒效果翻倍（时代智慧除外）",
   WaltDisney: "华特·迪士尼",
   Warehouse: "仓库",
   ...
   Xuanzang: "玄奘",
   YangtzeRiver: "长江",
   YangtzeRiverDesc: "所有消耗水的建筑，获得 +1 生产、劳动者能力以及存储乘数。被发现后，郑和（伟人）效果翻倍（时代智慧除外）；女皇武则天（伟人）作为永恒伟人，其每级使长江为所有建筑提供 +1 存储乘数",
   YearOfTheSnake: "巳蛇",
   ...
   ZagrosMountainsDesc: "所有低于 5 生产乘数的相邻建筑，获得 +2 生产乘数。尼布甲尼撒二世（伟人）效果翻倍（时代智慧除外）",
   ZahaHadid: "扎哈·哈迪德",
