export const ZH_CN = {
   ...
   EastIndiaCompanyDesc: "这个奇观累积您与玩家完成交易的总价值。每 2000 贸易价值获得一个周期, 使所有建筑每与一个运作的商队旅馆相邻获得 +1 生产乘数。该奇观可被升级，并且每一次额外升级获得 +1 生产乘数。当您完成了另一个玩家的一笔交易请求或您自己的一笔交易请求完成时，交易价值才算数。多次叠加延长持续时间。",
   Education: "教育学",
   ...
   TranslatorCredit: "Shallowsing、JLQ1134、NeKeSiTe",
   Translators: "翻译人员",
