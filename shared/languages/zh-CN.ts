export const ZH_CN = {
   ...
   GreatPersonLevelRequiredDesc: "在 %{city} 重生，需要永恒伟人等级达到 %{required} 且目前为 %{current}",
   ...
   GreatWall: "长城",
   GreatWallDesc: "周围 1 地块范围内的所有建筑都获得 +N 生产、劳动者能力和存储乘数。N=当前科技时代与建筑解锁时代之间的差值。若建成后与紫禁城相邻，则范围增加至 2 地块",
