export const ZH_CN = {
   ...
   AdvisorGreatPeopleContent:
      "每当你进入一个科技新时代，你将能选择一位当前时代伟人，之前每个时代也都能再选择一位。这些伟人带来全局加成，诸如增加生产、科学、幸福感以及许多其它方面。<br><br>这些加成在重生前一直保有。当你选择重生后，这些伟人将成为永恒伟人，他们的加成也将永久存在。<br><br>在一轮中选择一位相同的伟人，将叠加加成。若你重生并拥有重复伟人，重复项将被存储并可被用来升级永恒伟人。这项功能在你总部建筑内的<b>管理永恒伟人</b>界面中使用。",
   ...
   AdvisorScienceContent:
      "你的忙碌劳动者产出科学，这将允许你解锁新的科技以及推动你的文明发展。你有许多方式进入研究界面，比如点击科学计量表（资源栏）、查看你的总部建筑中你的可解锁科技或者使用“视图”菜单，这些都将展开以科技树为主体的研究界面。研究界面为你展示了科技，以及每项科技解锁需求的科学等。如果你有足够的科学用来学习一项新科技，只需单击目标科技再单击侧边栏的“解锁”即可。<b>每一新阶与时代之科技需求的科学不断增加，但你也将解锁新的、更好的方式以获得科学。</b>",
   AdvisorScienceTitle: "科学发现！",
   AdvisorSkipAllTutorials: "跳过教程",
   AdvisorStorageContent:
      "尽管建筑有许多存储空间，但仍会填满，若长时间闲置尤为如此。<b>建筑存满，不再生产。</b>这并不总是问题，毕竟建筑存储已满意味着拥有大量库存，只不过通常而言，保持持续生产更好。<br><br>通过仓库是一种调节方式。当你建成一座仓库，你将获得一份当前已发现的产物的名单，你可以设定仓库调用任意数量的任何产出，前提是产出的总量在仓库的调用范围内，而这一范围基于仓库等级与存储乘数。<br><br>设定一座仓库的简单方法，那就是勾选你想运入仓库的每种产出，然后使用“在选定对象中重新分配”来均分运速与限额。如果你希望建筑也能从仓库调用资源，那也请确保打开“低于限额仍输出”功能。",
   ...
   AdvisorWonderContent:
      "奇观是特殊建筑，它们可以提供全局效果，这将在你的游戏中产生深远影响。除了它们列出的功能，奇观还都能提供 +1 幸福感。你需要深思熟虑，因为<b>建造奇观需要大量资源，并且其建造者能力也高于正常水平。</b>这意味着它们可以轻易耗尽你库存中的需求资源，使得你的其它建筑缺少原料。<b>你可以自由设定每种资源是否运输</b>，这使你可以在你的库存资源能确保一切运转的状态下建造奇观。",
   ...
   AngkorWat: "吴哥窟",
   AngkorWatDesc: "相邻建筑，获得 +1 劳动者能力乘数。提供 1000 劳动者",
   AntiCheatFailure: "你的账户等级已受限。因为<b>未能通过反作弊</b>检查。若想就此进行申诉，请联系开发者",
   AoiMatsuri: "葵祭：富士山生成双倍扭曲时间",
   Apartment: "公寓",
   Aphrodite: "阿佛洛狄忒女神",
   AphroditeDescV2: "当升级超过等级 20 的建筑时，超过的每个等级获得 +2 建造者能力乘数。已解锁的古典时代永恒伟人，获得 +1 等级的本轮效果",
   ApolloProgram: "阿波罗计划",
   ...
   BaseMultiplier: "基础乘数",
   BaseProduction: "基础产出",
   BastilleDay: "国庆日：蓬皮杜市中心和凯旋门作用效果为 2 倍。圣米歇尔山产出 2 倍文化。",
   ...
   Broadway: "百老汇",
   BroadwayDesc: "诞生一位当前时代伟人与一位上时代伟人。选择一位伟人使其效果翻倍（智慧时代除外）",
   BronzeAge: "青铜时代",
   BronzeTech: "青铜",
   ...
   DukeOfZhou: "周公旦",
   DuneOfPilat: "彼拉特沙丘",
   DuneOfPilatDesc: "在每个时代时,都为上一个时代的智慧时代加成效果翻倍",
   ...
   EastIndiaCompanyDescV2: "这个奇观累积您与玩家完成交易的总贸易价值。每消耗 2000 贸易价值获得一个周期, 使所有建筑每与一个运转的商队旅馆相邻获得 +0.5 生产乘数。该奇观可被升级，并且每一次额外升级获得 +0.5 生产乘数。当您完成了另一个玩家的一笔交易请求或您自己的一笔交易请求被完成时，通过交易所获得物品其价值才被计入（税收也被计入）。多次交易延长持续时间，可多重叠加加成。",
   Education: "教育学",
   ...
   GrandCanyon: "大峡谷",
   GrandCanyonDesc: "当前时代的解锁建筑，获得 +2 生产乘数。约翰·皮尔庞特·摩根效果翻倍（智慧时代除外）",
   ...
   HolyEmpire: "神圣帝国",
   Homer: "荷马",
   Honor4UpgradeHTML: "<b>郑和</b>（伟人）效果翻倍（智慧时代除外）",
   ...
   MontSaintMichelDesc: "从空闲劳动者那里产生额外的文化。为 2 格范围地块内所有建筑物提供 +1 存储乘数。这个奇观可以使用生成的文化进行升级,并且每一次额外升级都为 2 格范围地块内所有建筑物额外提供 +1 存储乘数。",
   Mosque: "清真寺",
   MotionPicture: "电影",
   MountFuji: "富士山",
   ...
   MountTai: "泰山",
   MountTaiDesc: "所有产出科学的建筑，获得 +1 生产乘数。孔子（伟人）效果翻倍（智慧时代除外）。当被发现时，生成一批科学，生成量等同于已解锁最昂贵科技所需",
   MoveBuilding: "移动建筑",
   ...
   NileRiver: "尼罗河",
   NileRiverDesc: "哈特谢普苏特（伟人）效果翻倍（智慧时代除外）。所有小麦农场，获得 +1 生产与存储乘数。所有与该奇观相邻的小麦农场，获得 +5 生产与存储乘数",
   ...
   ProphetsMosqueDesc: "哈伦·拉希德效果翻倍（智慧时代除外）。其产生的科学，基于所有清真寺的信仰总产出",
   Province: "区域",
   ProvinceAegyptus: "埃及",
   ProvinceAfrica: "非洲",
   ProvinceAsia: "亚洲",
   ...
   SaintBasilsCathedralDescV2: "允许资源开采建筑在资源点相邻地块运转。所有相邻 I 阶建筑，获得 +1 生产、劳动者能力以及存储乘数",
   Saladin: "萨拉丁",
   Samsuiluna: "萨姆苏·伊路那",
   Sand: "沙",
   Sandpit: "采沙坑",
   ...
   WallStreet: "华尔街",
   WallStreetDesc: "周围 2 地块范围内，所有产出硬币、钞票、债券、股票以及外汇的建筑，获得 +N 生产乘数。N 为 1 至 5 的随机值，每座受加成建筑单独取值，并且该值随每次市场更新而改变。约翰·D·洛克菲勒效果翻倍（智慧时代除外）",
   WaltDisney: "华特·迪士尼",
   Warehouse: "仓库",
   ...
   Xuanzang: "玄奘",
   YangtzeRiver: "长江",
   YangtzeRiverDesc: "所有消耗水的建筑，获得 +1 生产、劳动者能力以及存储乘数。被发现后，郑和（伟人）效果翻倍（智慧时代除外）；女皇武则天（伟人）作为永恒伟人，其每级使长江为所有建筑提供 +1 存储乘数",
   YearOfTheSnake: "巳蛇",
   ...
   ZagrosMountainsDesc: "所有低于 5 生产乘数的相邻建筑，获得 +2 生产乘数。尼布甲尼撒二世（伟人）效果翻倍（智慧时代除外）",
   ZahaHadid: "扎哈·哈迪德",
