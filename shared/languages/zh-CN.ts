export const ZH_CN = {
   ...
   OfflineProductionTimeDescHTML: "对于 <b> 第一个 %{time} 离线时间</b> , 您可以选择离线生产或扭曲时间——您可以在这里选择分开。把 <b> 其余离线时间 </b> 只能转化为扭曲时间",
   OfflineTime: "离线时间",
   Oil: "石油",
   OilPress: "榨油机",
   OilRefinery: "炼油厂",
   ...
   Theocracy: "神权",
   ThePentagon: "五角大楼",
   ThePentagonDesc: "建造完成后，生成可用于移动非奇观建筑物的搬运劳动者。 2 地块范围内的所有建筑+1生产，劳动者能力和储存乘数",
   TheWhiteHouse: "白宫",
