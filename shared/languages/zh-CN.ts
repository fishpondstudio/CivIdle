export const ZH_CN = {
   ...
   CivilService: "公务员制度",
   ClaimedGreatPeople: "欢迎伟人",
   ClaimedGreatPeopleTooltip: "在重生时你将再拥有 %{total} 位伟人，他们中的 %{claimed} 位已经加入",
   ClassicalAge: "古典时代",
   ...
   EmperorWuOfHan: "汉武帝",
   EmpireValue: "帝国价值",
   EmpireValueFromBuilding: "来自建筑的帝国价值",
   EmpireValueFromBuildingsStat: "来自建筑",
   EmpireValueFromResources: "来自资源的帝国价值",
   ...
   NielsBohr: "尼尔斯·玻尔",
   NielsBohrDesc: "如果有超过 50% 的忙碌劳动者，则所有劳动者产出科学 +%{value} ",
   NileRiver: "尼罗河",
   ...
   Politics: "政治",
   PorcelainTower: "大报恩寺",
   PorcelainTowerDesc: "+5 幸福感。建成时，你可提前结算现有的重生额外伟人，并在本轮游戏获得此生伟人加成（他们与永久伟人遵循相同的规则）",
   Poseidon: "海神波塞冬",
   ...
   ResourceAmount: "数量",
   ResourceBar: "资源栏",
   ResourceBarExcludeStorageFullHTML: "未运转建筑中，排除 <b>满库存</b> 建筑",
   ResourceBarExcludeTurnedOffOrNoActiveTransportHTML: "未运转建筑中，排除 <b>已关闭</b> 建筑",
