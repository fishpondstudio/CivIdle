export const ZH_CN = {
   ...
   BranCastle: "布朗城堡",
   BranCastleDescV2: "产出 X 个劳动者。X =周围 2 地块范围内建筑产出的劳动者。如果有足够的劳动者，还会将该奇观产出的劳动者转化为吸血鬼。吸血鬼不参与生产或运输资源，但被视为忙碌的劳动者。布郎城堡的等级由劳动者总数决定，每一级获得 +1 闲置劳动者科学产出和 +2 忙碌劳动者科学产出。该奇观只能在万圣节（10.15 ~ 11.15）期间建造。",
   ...
   ElectrificationStatusDescV2: "无论建筑是否需要电力，都存在电气化可能。不同之处在于，需要电力的建筑可以从电气化中额外获得 +5 建筑等级",
