export const ZH_CN = {
   ...
   DinosaurProvincialParkDesc: "该奇观可以在选定的时间激活，一次性获得相当于当前帝国总价值 25% 的瑞士货币",
   Diplomacy: "外交",
   ...
   GreatOceanRoad: "大洋路",
   GreatOceanRoadDesc: "该奇观可被升级，每一级为贸易地块加成相应建筑提供 +1 额外建筑等级（不包括相邻玩家加成，相同地块仅生效一次）",
   GreatPeople: "伟人",
   ...
   LakeLouise: "路易斯湖",
   LakeLouiseDesc: "所有贸易地图上的相邻玩家都会成为盟友（不管文明如何）。每个盟友拥有地块相应建筑提供 +2 额外建筑等级",
   LandTrade: "陆上贸易",
   Language: "语言",
   Laozi: "老子",
   Lapland: "拉普兰区",
   ...
   Moomba: "蒙巴节：大洋路每一级额外为贸易地块加成相应建筑提供 +1 生产乘数（不包括相邻玩家加成，相同地块仅生效一次）。乌鲁鲁的范围增加至周围 3 地块范围",
   ...
   Wine: "葡萄酒",
   Winery: "葡萄酒厂",
   WinterCarnival: "冬季嘉年华：北极光的范围增加至周围 4 地块范围。弗朗特纳克城堡和栖息地67提供额外建筑等级翻倍",
   ...
   WorldTradeOrganizationDesc: "该奇观可被升级，每一级为贸易地块加成额外提供 +1 生产乘数。参加每周世界贸易组织大会，在世界贸易组织大会上获选的建筑将增加贸易地块加成数量",
   WorldWarAge: "世界大战",
   WorldWideWeb: "万维网",
   WritersGuild: "作家协会",
   Writing: "写作",
