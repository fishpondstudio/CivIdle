export const ZH_CN = {
   ...
   PlayerMapTileTilePoint: "地块点数",
   PlayerMapTileUsedTilePoint: "已使用地块点数",
   PlayerMapTileAvailableTilePoint: "可用地块点数（重新宣称将不保留生成的地块点数）",
   ...
   SwissBank: "瑞士银行",
   SwissBankDescV2: "将选定资源从相邻仓库中转换为💵瑞士货币——价值 10M 的可交易资源货币。每个周期基础产出1个💵瑞士货币（可被生产乘数影响），该奇观可被升级，并且每一次额外升级增加 1 基础产出。瑞士银行可以存储无限量的💵瑞士货币",
   Sword: "剑",
   SwordForge: "铸剑铺",
