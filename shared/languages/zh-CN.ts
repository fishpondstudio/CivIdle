export const ZH_CN = {
   ...
   Exploration: "勘探",
   Explorer: "探险家",
   ExploreThisTile: "派遣一位探险家",
   ExploreThisTileHTML:
      "探险家将探索 <b>此地块与相邻地块</b>. 探险家由 %{name} 培训。你还可以使用 %{count} 个探险家",
   ...
   Fibonacci: "斐波那契",
   FibonacciDescV2:
      "+%{idle} 闲置劳动者科学产出。+%{busy} 忙碌劳动者科学产出。永恒伟人斐波那契的升级需求，遵循斐波那契数列序列。",
   Fire: "火",
   Firearm: "火器",
   ...
   MogaoCaves: "莫高窟",
   MogaoCavesDescV2:
      "每有 10% 的忙碌劳动者占比，+1 幸福感。所有相邻的圣祠免除 -1 幸福感",
   Mosque: "清真寺",
   MotionPicture: "电影",
   MountSinai: "西奈山",
   MountSinaiDesc:
      "被发现时，一位此时代的伟人诞生。所有产出信仰的建筑，获得 +5 存储乘数",
   Movie: "电影",
   MovieStudio: "电影制片厂",
   Museum: "博物馆",
   Music: "音乐",
   ...
   SaintBasilsCathedralDescV2:
      "所有资源采集建筑可在对应资源点的相邻地块运作。所有相邻的 I 阶建筑，获得 +1 生产、劳动者能力以及存储乘数",
   Sand: "沙",
   Sandpit: "采沙坑",
   SargonOfAkkad: "萨尔贡大帝",
   SaveAndExit: "保存并退出",
   ...
   UseMirrorServerDescHTML:
      "如果在访问主服务器时遇到问题，可以改为连接到镜像服务器。<b>重启游戏以生效。</b>",
