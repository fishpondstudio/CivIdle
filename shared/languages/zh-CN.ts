export const ZH_CN = {
   ...
   BecomeAllyTooltip: "要成为相邻玩家的盟友，请选择与他们相同的旗帜（地球旗帜除外）",
   BigBen: "大本钟",
   ...
   Neighbors: "相邻玩家",
   NeighborsDescHTML:
      "对于每个相邻玩家拥有的地块，你得到<b> +%{neighbor} 生产乘数的贸易地块加成</b>，对于每个盟友拥有的地块，你得到<b> +%{ally} 生产乘数的贸易地块加成</b>。要成为相邻玩家的盟友，请选择与他们相同的旗帜（地球旗帜除外）",
   Neuschwanstein: "新天鹅堡",
   ...
   ReinforcedConcretePlant: "钢筋混凝土工厂",
   Religion: "宗教",
   ReligionBuddhism: "佛教",
