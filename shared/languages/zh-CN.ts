export const ZH_CN = {
   ...
   AdvisorStorageContent:
      "尽管建筑有许多存储空间，但仍会填满，若长时间闲置尤为如此。<b>建筑存满，不再生产。</b>这并不总是问题，毕竟建筑存储已满意味着拥有大量库存，只不过通常而言，保持持续生产更好。<br><br>通过仓库是一种调节方式。当你建造完成一座仓库，你将获得一份当前已发现的所有产物的名单，你可以设定仓库调用任意数量的任何产出，前提是所有产出的总量在仓库的调用范围内，而这一范围基于仓库等级与存储乘数。<br><br>设定一座仓库的简单方法，那就是勾选你想运入仓库的每种产出，然后使用“在选定对象中重新分配”来均分运速与限额。如果你希望建筑也能从仓库调用资源，那也请确保打开“低于限额仍输出”功能。",
   ...
   BitcoinMiner: "比特币矿工",
   BlackForest: "黑森林",
   BlackForestDesc: "当此奇观被发现时，显露地图上的所有原木资源地块并在该奇观相邻地块生成原木资源。所有消耗原木或木材的建筑，获得 +5 生产乘数",
   Blacksmith: "工匠铺",
   Blockchain: "区块链",
   BobHope: "鲍勃·霍普",
   ...
   EuphratesRiverDesc: "从事生产（非运输）的忙碌劳动者占比每有 10% ，为所有不生产劳动者且为之前时代的解锁建筑，提供 +1 生产乘数（最大值为已解锁时代数/2）。当空中花园在其旁建造完成，于空中花园解锁后的每个时代，使空中花园获得 +1 效果。当此奇观被发现时，所有无沉积资源的相邻地块，将生成水资源",
   ...
   GrandCanyon: "大峡谷",
   GrandCanyonDesc: "当前时代的解锁建筑，获得 +2 生产乘数。约翰·皮尔庞特·摩根效果翻倍（此生伟人与永恒伟人的效果翻倍，时代智慧除外）",
   ...
   HolyEmpire: "神圣帝国",
   Homer: "荷马",
   Honor4UpgradeHTML: "<b>郑和</b>（伟人）效果翻倍（此生伟人与永恒伟人的效果翻倍，时代智慧除外）",
   ...
   MountTai: "泰山",
   MountTaiDesc: "所有产出科学的建筑，获得 +1 生产乘数。孔子（伟人）效果翻倍（此生伟人与永恒伟人的效果翻倍，时代智慧除外）。当此奇观被发现时，生成一批科学，生成量等同于已解锁最昂贵科技所需",
   MoveBuilding: "移动建筑",
   ...
   NileRiver: "尼罗河",
   NileRiverDesc: "哈特谢普苏特（伟人）效果翻倍（此生伟人与永恒伟人的效果翻倍，时代智慧除外）。所有小麦农场，获得 +1 生产与存储乘数。所有与该奇观相邻的小麦农场，获得 +5 生产与存储乘数",
   ...
   Xuanzang: "玄奘",
   YangtzeRiver: "长江",
   YangtzeRiverDesc: "所有消耗水的建筑，获得 +1 生产、劳动者能力以及存储乘数。当此奇观被发现后，郑和（伟人）效果翻倍（此生伟人与永恒伟人的效果翻倍，时代智慧除外）；女皇武则天（伟人）作为永恒伟人，其每级使长江为所有建筑提供 +1 存储乘数",
   YearOfTheSnake: "巳蛇",
   ...
   ZagrosMountainsDesc: "所有低于 5 生产乘数的相邻建筑，获得 +2 生产乘数。尼布甲尼撒二世（伟人）效果翻倍（此生伟人与永恒伟人的效果翻倍，时代智慧除外）",
   ZahaHadid: "扎哈·哈迪德",
