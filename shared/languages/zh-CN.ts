export const ZH_CN = {
   ...
   Combustion: "内燃机",
   Commerce4UpgradeHTMLV2: "解锁时，与该奇观相邻的<b>银行</b>获得免费升级至<b>等级 30</b>",
   ...
   StatueOfZeus: "宙斯神像",
   StatueOfZeusDesc: "与该奇观相邻的空白地块，随机生成并显露沉积资源。与该奇观相邻 I 阶建筑，获得 +5 生产与存储乘数",
   ...
   Voltaire: "伏尔泰",
   WallOfBabylon: "巴比伦城墙",
   WallOfBabylonDesc: "所有建筑获得 +N 存储乘数， N 为（青铜——铁器=1，古典——中世纪=2,文艺复兴——工业=3，世界大战——冷战=4，信息=5）",
   WallStreet: "华尔街",
   ...
   ZhengHe: "郑和",
   ZigguratOfUr: "乌尔大塔庙",
   ZigguratOfUrDescV2: "每有正向 10 幸福感（最大值为 50），为所有不生产劳动者且为之前时代的解锁建筑，提供 +1 生产乘数（每个时代最大值为：古典——中世纪=2,文艺复兴——工业=3，世界大战——冷战=4，信息=5）。奇观（包括自然奇观）不再提供 +1 幸福感。效果可关闭。",
   Zoroaster: "琐罗亚斯德",
   Zugspitze: "楚格峰",
