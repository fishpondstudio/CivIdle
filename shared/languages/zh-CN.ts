export const ZH_CN = {
   ...
   Diwali: "排灯节：恒河和桑奇大塔的范围增加至周围 3 地块范围。红堡的建筑等级提升一倍（包括伟人提供建筑等级）",
   ...
   Gameplay: "游戏设置",
   GangesRiver: "恒河",
   GangesRiverDesc: "周围 3 地块范围内的所有建筑，提供 +N 额外建筑等级，N 为解锁该建筑时代的时代智慧等级",
   Garment: "服装",
   ...
   Petra: "佩特拉",
   PetraDesc: "解锁更高扭曲倍速，该奇观可以升级，每一级提供1小时的扭曲存储。当你离线时生成扭曲时间，你可以用来加速你的帝国",
   ...
   TutorialUpgradeHutsHTML: "升级时选择“一个 <b>小棚屋</b>”，单击“<b>+1</b>”。小棚屋在升级时将<b>不再提供劳动者</b>，所以避免一起升级。更高的级别需要更多的资源来升级。",
   TV: "电视",
   TVStation: "电视台",
