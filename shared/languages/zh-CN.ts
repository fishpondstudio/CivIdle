export const ZH_CN = {
   ...
   HatshepsutTempleDesc: "当完成建造时，在地图上揭示所有水资源地块。与小麦农场相邻的每个水资源地块，使小麦农场获得 +1 生产乘数",
   Headquarter: "总部",
   HelpMenu: "帮助",
   HenryFord: "亨利·福特",
   Herding: "放牧",
   ...
   SubmarineYard: "潜艇船坞",
   SummerPalace: "颐和园",
   SummerPalaceDesc: "所有消耗或产出火药的相邻建筑，免去 -1 幸福感。所有消耗或产出火药的建筑，获得 +1 生产、存储以及劳动者能力乘数",
   Sword: "剑",
   SwordForge: "铸剑铺",
   ...
   Synthetics: "合成材料",
   TajMahal: "泰姬陵",
   TajMahalDescV2: "建造完成时，诞生一位古典时代伟人与一位中世纪伟人。 20 级以上建筑升级时，获得 +5 建造者能力乘数",
   TangOfShang: "商汤",
   ...
   Wheat: "小麦",
   WheatFarm: "小麦农场",
   WildCardGreatPersonDesc: "升级同时代的任何永恒伟人（转化为同时代其他永恒伟人）",
