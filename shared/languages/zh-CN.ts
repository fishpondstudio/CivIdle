export const ZH_CN = {
   ...
   ElbphilharmonieDesc: "周围 3 地块范围内的所有建筑，A建筑每相邻不同于A建筑的阶且运转的建筑，则A建筑获得 +1 生产乘数（例：伐木场( I 阶)相邻邻3个砖窑( II 阶)，伐木场获得+3生产乘数）",
   Electricity: "电能",
   Electrification: "电气化",
   ...
   YearOfTheSnake: "巳蛇",
   YearOfTheSnakeDesc: "建造完成后，进入一个新时代时，由每一个已解锁时代获取一位伟人改为获取相同数量的当代伟人。周围 2 地块范围内的所有建筑，获得 +1 生产乘数。该奇观可被升级，并且每一次额外升级为周围 2 地块范围内的所有建筑提供 +1 生产乘数。该奇观只能在农历新年期间（1.20 ~ 2.10）建造",
