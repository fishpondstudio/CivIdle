export const ZH_CN = {
   ...
   BuildingsStorageFull: "建筑存储已满",
   BuildingsStorageFullHTML: "%{count} 建筑不生产，因为它们存储已满，点击高亮它们",
   BuildingsTurnedOff: "建筑关闭的",
   BuildingsTurnedOffHTML: "%{count} 建筑不生产，因为它们是关闭的，点击高亮它们",
   BuildingTier: "阶",
   ...
   Gameplay: "游戏设置",
   GangesRiver: "恒河",
   GangesRiverDescV2: "周围 2 地块范围内的每种建筑（产出劳动者建筑除外），每种建筑所有同类型建筑获得 +N 生产乘数，N 为解锁该建筑时代的时代智慧等级",
   Garment: "服装",
   ...
   TutorialBuildHutsHTML: "要建造小屋，点击<b>空白地块</b>，然后点击<b>小棚屋</b>旁边的<b>建造</b>。建造完成后，会驱散周围的迷雾。小棚屋提供劳动者，这需要保持建筑的运转，也产生相应科学。",
   TutorialBuildLoggingCampsHTML: "伐木场需要建在含有<b>原木</b>地块上。选择一个含有原木地块，点击<b>伐木场</b>旁边的<b>建造</b>。",
   TutorialBuildLumberMillsHTML: "木材厂消耗原木来生产木材，这是一种重要的建筑材料。确保你有足够的伐木场来供应它们——您可以使用统计局来帮助平衡您的生产和消费。",
   ...
   TV: "电视",
   TVStation: "电视台",
   UnclaimedGreatPeopleThisRun: "未迎接的此生伟人",
   ...
   UnclaimedPermanentGreatPeople: "未迎接的永恒伟人",
