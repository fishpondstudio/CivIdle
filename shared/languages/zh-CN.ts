export const ZH_CN = {
   ...
   CologneCathedralDesc:
      "建成时，生成一批科学，生成量等同于当前时代最昂贵科技所需。所有产出科学的建筑（不包括克隆实验室），获得 +1 生产乘数。该奇观可被升级，并且每一次额外升级，为所有产出科学的建筑（不包括克隆实验室）提供 +1 生产乘数",
   Colonialism: "殖民主义",
   Colosseum: "斗兽场",
   ...
   Language: "语言",
   Lapland: "拉普兰区",
   LaplandDesc: "被发现时，显示完整地图。周围 2 地块范围内的所有建筑，获得 +5 生产乘数。该自然奇观仅可被发现于十二月",
   ...
   ProductionPriorityDescV3:
      "优先级决定了建筑运输与生产的顺序——数字越大，意味着一座建筑运输与生产将越早进行。但是，更高的优先级并不能确保建筑首先运输资源。例如，给定如下优先级顺序：燃煤电厂>煤矿> 炼钢厂，炼钢厂将获得同一周期内产出的所有煤，这是因为它的运输与生产紧随煤矿",
