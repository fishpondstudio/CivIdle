export const ZH_CN = {
   ...
   ApolloProgram: "阿波罗计划",
   ApolloProgramDesc: "所有火箭工厂，获得 +2 生产、劳动者能力以及存储乘数。对于卫星工厂、航天器工厂以及核导弹发射井，其相邻每座火箭工厂，都会使它们获得 +1 生产乘数",
   ApplyToAll: "应用于全部",
   ...
   AtomicTheory: "原子理论",
   Atomium: "原子塔",
   AtomiumDesc: "周围 2 地块范围，所有产出科学的建筑，获得 +5 生产乘数。该奇观产生的科学，等于周围 2 地块范围内的科学总产出值",
   Autocracy: "专制",
   Aviation: "航空",
   BackToCity: "返回城市",
   BackupRecovery: "备份恢复",
   ...
   Colonialism: "殖民主义",
   Colosseum: "斗兽场",
   ColosseumDesc: "所有 战车工坊 免除 -1 幸福感。消耗 10 战车并产出 10 幸福感",
   ...
   ConfirmYes: "确认",
   Confucius: "孔子",
   ConfuciusDesc: "如果忙碌劳动者占比超过 50% ，则获得 +%{value} 劳动者科学产出",
   Constitution: "宪法",
   Construction: "结构",
   ...
   CristoRedentorDesc: "周围 2 地块范围内的所有建筑，免除 -1 幸福感",
   Cryptocurrency: "加密货币",
   Culture: "文化",
   ...
   Education: "教育学",
   EiffelTower: "埃菲尔铁塔",
   EiffelTowerDesc: "所有相邻的炼钢厂获得 +N 生产、存储以及劳动者能力乘数。 N 取决于该奇观相邻炼钢厂数量",
   Electricity: "电能",
   Electrification: "电气化",
   ...
   GoldMiningCamp: "金矿",
   GrandBazaar: "大巴扎",
   GrandBazaarDesc: "可在该奇观处管理你的所有市场，且相邻的市场拥有不同的交易项。相邻的商队旅馆获得 +5 生产与存储乘数",
   GrandBazaarFilters: "筛选",
   GrandBazaarFilterWarningHTML: "在显示任何市场交易之前，必须选择一个筛选选项",
   ...
   HatshepsutTempleDesc: "当完成建造时，在地图上揭示所有水资源的地块。与小麦农场相邻的每个水资源地块，使小麦农场获得 +1 生产乘数",
   Headquarter: "总部",
   HelpMenu: "帮助",
   HenryFord: "亨利·福特",
   Herding: "放牧",
   ...
   MoaiDesc: "翻译时未实装",
   MogaoCaves: "莫高窟",
   MogaoCavesDescV2: "每有 10% 忙碌劳动者占比，获得 +1 幸福感。相邻圣祠免去 -1 幸福感",
   MonetarySystem: "货币体系",
   Mosque: "清真寺",
   MotionPicture: "电影",
   MountSinai: "西奈山",
   ...
   MountTai: "泰山",
   MountTaiDesc: "所有产生科学的建筑，获得 +1 生产乘数。使孔子（伟人）的效果加倍。当被发现时，产出一次性科学点，其值等同于已解锁最昂贵科技所需科学点",
   Movie: "电影",
   MovieStudio: "电影制片厂",
   Museum: "博物馆",
   Music: "音乐",
   ...
   Neuschwanstein: "新天鹅堡",
   NeuschwansteinDesc: "建造奇观时，获得 +10 建造者能力乘数",
   Newspaper: "报纸",
   NextExplorersIn: "新的探险家就位剩余时间",
   NextMarketUpdateIn: "下次市场更新剩余时间",
   NielsBohr: "尼尔斯·玻尔",
   NielsBohrDesc: "如果忙碌劳动者占比超过 50% ，则获得 +%{value} 劳动者科学产出",
   NileRiver: "尼罗河",
   NileRiverDesc: "使伟人哈特谢普苏特的效果加倍。所有小麦农场都获得 +1 的生产和存储乘数。该奇观相邻的小麦农场获得 +5 的生产和存储乘数",
   ...
   StPetersBasilicaDesc: "所有产出信仰的建筑，获得 +1 存储乘数。其产生的信仰，等于其它产出信仰建筑中信仰存储总量的 1% ",
   Submarine: "潜艇",
   SubmarineYard: "潜艇船坞",
   SummerPalace: "颐和园",
