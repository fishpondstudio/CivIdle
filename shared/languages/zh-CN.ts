export const ZH_CN = {
   ...
   TribuneUpgradeDescV3: "如果您不打算参与 <b>可选</b> 在线功能，可以以保民官的身份玩完整的游戏, 要获得对在线功能的无限制访问，您需要升级到财务官. <b>这是一种反机器人措施，可以让每个人都免费游玩.</b> 但是, <b>升级到财务官时</b> 您可以继承伟人: <ul><li>青铜、铁器和古典时代<b>3</b> 最高等级</li><li>中世纪、文艺复兴和工业时代 <b>2</b> 最高等级</li><li>世界大战、冷战和信息时代 <b>1</b> 最高等级</li></ul>超过该级别的部分无法结转.",
   TurnOnTimeWarpDesc: "每秒消耗 %{speed} 扭曲时间，同时加速你的帝国，使其以 %{speed} 倍速度运行。",
   Tutorial: "教程",
   Tutorial1: "欢迎使用 CivIdle 安装程序。（译者：若翻译存疑，请参照英文版。若欲修改、更新翻译，可在Discord上反馈问题并提出意愿。欢迎更多人的加入！）<br><br>    在游戏中，你将运营你自己的帝国城市：管理生产、解锁科技、与其他玩家开展资源贸易、获得伟人相助以及修建世界奇观。<br><br>    拖动鼠标进行移动。使用滚轮放大或缩小。单击空地块以建造新建筑，单击一座建筑以查看详情。<br><br>",
   Tutorial2: "我从未玩过类似游戏，并且我愿意通读一篇简短教程。（译者：前作玩家初次接触此游戏，可速读了解基础框架。）",
   Tutorial3: "我玩过 Industry Idle 并且我知道正确游玩方式，请跳过基础教程。",
   Tutorial4: "建筑是你帝国的基本组成部分，请将它们放在已探索地图的地块上。某些建筑（比如采石场和引水渠）可获取沉积资源，要正常运行，首先就需要将它们建造在含相应沉积资源的地块上。一座建筑可以驱散其周围（目前半径为2格）地块的迷雾。<br><br>    建筑往往消耗资源并产生新的资源。它们会<b>自动地</b>运送所需资源。所产出的资源将被存储在产出建筑中，可被运送至其它需要这些资源的建筑。然而，一座建筑本身的存储空间是有限的。<br><br>    建筑需要<b>劳动者</b>来进行运输与生产，这意味着你需要建造提供居住的建筑（比如<b>小棚屋</b>）来增加劳动者人口。你可以升级一座建筑，以此来增加它的生产能力与存储空间。",
   Tutorial5: "<b>科学</b>被用来在科技树中解锁科技。一项科技研究可能解锁新的建筑、奇观以及增强。<br><br>    <b>忙碌劳动者</b>可产出少量科学。随着发展，你将解锁一些能产出科学的建筑（比如图书馆与学校）。<br><br>    可获劳动者数量受到<b>幸福感</b>的影响。每座建筑将会消耗 1 幸福感。你也可以从科技、奇观以及伟人获得幸福感。确保你麾下劳动者们的幸福，否则你帝国的生产将陷入停滞。<br><br>    <b>奇观</b>是独一无二的建筑，你只能建造一座，并且它们一旦建成将不能被移除。奇观可以提供显著增强或者解锁新的机制。",
   Tutorial6: "当你进入一个新时代，一位新的<b>伟人</b>将会诞生。你能从三位候选人中选出一位来辅佐你的帝国。<br><br>    伟人提供加成并且能加入你的永恒收集中。一旦你重生，你会收集到此轮所有你选中的伟人，这些永恒伟人将辅佐你建设今后的每个帝国。<br><br>    <b>永恒</b>伟人能通过每轮收集对应伟人进行升级。他们将帮助你的帝国达到新的高度。以上是你所需要了解的基础部分。<br><br>    如果你有疑问，获取帮助的最好途径就是求助于<b>聊天</b>。我们有一个友好的社区，随时准备提供帮助。",
