export const ZH_CN = {
   ...
   Feudalism: "封建主义",
   Fibonacci: "斐波那契",
   FibonacciDescV2: "+%{idle} 闲置工人科学产出. +%{busy} 忙碌工人科学产出. 斐波那契的升级成本遵循斐波那奇序列",
   Fire: "火",
   Firearm: "火器",
   ...
   NileRiver: "尼罗河",
   NileRiverDesc: "使哈特谢普苏特的效果加倍。所有小麦农场都获得 +1 的生产和储存乘数。所有相邻的小麦农场都获得 +5 的生产和储存乘数",
   ...
   Winery: "葡萄酒厂",
   Wonder: "奇观",
   WonderBuilderCapacityDescHTML: "建造奇观时的<b>建造者能力</b>，受解锁奇观的<b>时代</b>与<b>科技</b>的影响。",
   WondersBuilt: "现有世界奇观",
