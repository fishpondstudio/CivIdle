export const ZH_CN = {
   ...
   CentrePompidouDesc:
      "建造完成后，所有建筑获得 +1 生产乘数和 +2 存储乘数。对于每次游玩该奇观未记录的文明达到信息时代后，在重生时记录重生前的文明，每拥有一个记录在册的文明额外提供 +1 生产乘数和 +2 存储乘数。该奇观的价值不计入帝国的总价值中。如果当前的游玩达到信息时代，下一次游玩的文明与当前是不同的，那么该奇观可被继承！",
