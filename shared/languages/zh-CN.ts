export const ZH_CN = {
   ...
   DukeOfZhou: "周公旦",
   DuneOfPilat: "彼拉特沙丘",
   DuneOfPilatDesc: "在每一个时代时,都为上一个时代的智慧时代加成效果翻倍。",
   ...
   EasterBunny: "复活节兔子",
   EasterBunnyDesc: "建造完成后，重生时将 10％ 的额外伟人以此生伟人方式进入下轮游玩不再以永恒碎片，并在下轮游玩中建造复活节兔子后根据已解锁时代诞生这些伟人。该奇观只能在4月份建造。",
   ...
   PlayerMapOccupyTileCondition2: "你还没有达到你等级的最大占领地块",
   PlayerMapMenu: "贸易",
   ...
   ZhengHe: "郑和",
   ZigguratOfUr: "乌尔大塔庙",
   ZigguratOfUrDescV2: "每有 10 幸福感（最大值为 50），为所有不生产劳动者且为之前时代的解锁建筑，提供 +1 生产乘数（最大值为已解锁时代数/2）。奇观（包括自然奇观）不再提供 +1 幸福感。效果可关闭。",
   Zoroaster: "琐罗亚斯德",
   Zugspitze: "楚格峰",
