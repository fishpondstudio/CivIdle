export const ZH_CN = {
   ...
   Diwali: "排灯节：恒河和桑奇大塔的范围增加至周围 3 地块范围。红堡提供双倍加成效果",
   ...
   Gameplay: "游戏设置",
   GangesRiver: "恒河",
   GangesRiverDescV2: "周围 2 地块范围内的每种建筑（产出劳动者建筑和克隆实验室除外），每种建筑所有同类型建筑获得 +N 生产乘数，N 为解锁该建筑时代的时代智慧等级",
   Garment: "服装",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDesc: "建造完成后，诞生一个除当前时代之外的伟人。该奇观可被升级，并且每一次升级都会诞生一个除当前时代之外的伟人。（伟人随机区间：青铜~信息）当从这座奇观进行伟人选择时，每位伟人有 4 项可选。",
   ...
   RedFort: "红堡",
   RedFortDesc: "周围 4 地块范围内的所有建筑获得 +5 额外建筑等级。该奇观可被升级，并且每一次额外升级为周围 4 地块范围内的所有建筑提供 +1 额外建筑等级",
