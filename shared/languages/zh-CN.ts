export const ZH_CN = {
   ...
   GreatWall: "长城",
   GreatWallDesc: "周围 1 地块范围内的所有建筑都获得 +N 生产、劳动者能力和存储乘数。 N 为当前科技时代与建筑解锁时代之间的差值。若建成后与紫禁城相邻，则范围增加至 2 地块",
   ...
   Hollywood: "好莱坞",
   HollywoodDesc: " +5 幸福感。周围 2 地块范围所有消耗或产出文化、具有良好库存的建筑，获得 +1 幸福感",
   HolyEmpire: "神圣帝国",
   Horse: "马",
   HorsebackRiding: "马术",
   House: "房屋",
   ...
   PorcelainTowerDesc: "+5 幸福感。建成时，所有你重生时可获取的额外伟人，将可在本轮获取（他们与永恒伟人遵循相同的规则）（并在本轮游戏获得此生伟人加成）",
   Poseidon: "海神波塞冬",
   ...
   SagradaFamiliaDesc: "周围 2 地块范围内的建筑，获得 +N 生产、劳动者能力以及存储乘数。 N 为周围建筑最大阶差",
