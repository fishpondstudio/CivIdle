export const ZH_CN = {
   ...
   PromotionGreatPersonDesc: "提升同时代的任一永恒伟人至下一时代",
   ...
   RequiredWorkersTooltip: "生产所需劳动力（基础劳动者数量），等于乘数加成后（电气化除外）消耗与产出的资源（科学除外）数量之和",
   RequirePower: "需要电能",
   ...
   StatueOfZeus: "宙斯神像",
   StatueOfZeusDesc: "在相邻的空白地块，随机产生并显露沉积资源。所有相邻 I 阶建筑，获得 +5 生产与存储乘数",
   ...
   TraditionHonor: "荣耀",
   Train: "火车",
   TranslationPercentage: "%{language}的翻译进度目前为%{percentage}。可在GitHub上帮助改进此语言翻译。（为确保效率，建议优先与当前译者们联系；初次翻译时，请在翻译人员中，添加自己的游戏昵称）",
   ...
   Wheat: "小麦",
   WheatFarm: "小麦农场",
   WildCardGreatPersonDesc: "升级同时代的任一永恒伟人（转化为同时代其他永恒伟人）",
   ...
   Xuanzang: "玄奘",
   YangtzeRiver: "长江",
   YangtzeRiverDesc: "所有消耗水的建筑，获得 +1 生产、劳动者能力以及存储乘数。被发现后，郑和（伟人）效果翻倍；女皇武则天（伟人）作为永恒伟人，其每级为所有建筑提供 +1 存储乘数",
