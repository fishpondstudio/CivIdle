export const ZH_CN = {
   ...
   ChateauFrontenacDesc: "该奇观可被升级，每次升级时，将随机抽取三种当前时代的建筑。选择其中一种建筑来获得 +1 额外建筑等级（一旦选择了就不能改变）",
   ...
   DinosaurProvincialParkDesc: "该奇观可手动进行激活，一次性获得相应的💵瑞士货币。（价值等同于当前帝国总价值的 %{percent} ）",
   ...
   Habitat67: "栖息地67住宅区",
   Habitat67DescV2: "该奇观可被升级，每一级为AI实验室提供 +1 生产、劳动者能力以及存储乘数。为AI实验室提供 +N 生产和存储乘数，N 为信息时代智慧等级。每有正向 5 幸福感（最大值为 50 ）为AI实验室提供 +1 额外建筑等级",
   HagiaSophia: "圣索菲亚大教堂",
   ...
   SagradaFamiliaDesc: "周围 2 地块范围内的所有建筑，获得 +N 生产、劳动者能力以及存储乘数。 N 为该奇观相邻建筑最大阶差（例：市场( I 阶)和议会( VI 阶)相邻圣家族大教堂，则周围 2 地块范围内的所有建筑获得 +5 生产、劳动者能力以及存储乘数）",
   ...
   StatueOfLibertyDesc: "与该奇观相邻建筑，获得 +N 生产、劳动者能力以及存储乘数。 N 为被加成建筑其相邻同类型建筑数量（例：相邻自由女神像的A建筑，A建筑相邻 3 个相同建筑，则A建筑获得 +3 生产、劳动者能力以及存储乘数）",
   StatueOfZeus: "宙斯神像",
