export const ZH_CN = {
   ...
   AgeWisdomUpgradeWarningHTMLV2: "<b>时代智慧</b> 只适用于 <b>财务官</b> 及以上等级",
   ...
   EuphratesRiverDesc: "从事生产（非运输）的忙碌劳动者占比每有 10% ，为所有不生产劳动者且为之前时代的解锁建筑，提供 +1 生产乘数（每个时代最大值为：青铜——铁器=1，古典——中世纪=2,文艺复兴——工业=3，世界大战——冷战=4，信息=5）。当空中花园在其旁建造完成，基于空中花园解锁后的每个时代，使空中花园获得 +1 效果。当此奇观被发现时，与该奇观相邻无沉积资源的地块生成水资源",
   ...
   MausoleumAtHalicarnassusDesc: "周围 2 地块范围内的建筑互免费运输（实际效果范围是被圈完全覆盖的12个建筑组成的六芒星，这12个建筑之间互免费运输）",
   ...
   SwissBank: "瑞士银行",
   SwissBankDesc: "将选定资源从相邻仓库中转换为💵（梵语为千万）——价值 10M 的可交易资源。每个周期基础转换1个💵（可被生产乘数影响）。瑞士银行可以存储无限量的💵",
   Sword: "剑",
   SwordForge: "铸剑铺",
   ...
   TribuneUpgradeDescV4:
      "若你无计划体验<b>可选的</b>在线功能，作为保民官，你能游玩完整版游戏（永恒伟人无等级上限）。为获取不受限制的在线功能访问权限（交易限制、贸易地块加成数量、时代智慧功能与重置永恒伟人功能），你将需要提升至财务官。<b>这是一项反机器人措施，旨在让每个人都可以免费玩游戏。</b>然而，<b>当账号等级升至财务官的这一瞬间</b>，你能继承伟人的等级有一定限制：<ul><li>青铜、铁器以及古典时代最高可继承至等级 <b>3</b> </li><li>中世纪、文艺复兴时期以及工业时代最高可继承至等级 <b>2</b> </li><li>世界大战、冷战以及信息时代最高可继承至等级 <b>1</b> </li></ul>超过等级限制的伟人碎片和<b>时代智慧</b>等级将<b>不能</b>被继承。",
