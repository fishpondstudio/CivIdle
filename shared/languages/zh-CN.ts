export const ZH_CN = {
   ...
   Herodotus: "希罗多德",
   HideSpinner: "显示转轮指示",
   HideSpinnerDescHTML: "关闭将隐藏建筑运转的转轮指示。<b>这应该不会影响性能</b>>",
   ...
   ShowFloaterText: "显示地块产量指示",
   ShowFloaterTextDescHTML: "关闭将隐藏地块产量指示。将其关闭可能会略微提高性能。",
   ...
   Spinner: "转轮",
   SpinnerSpeed: "转轮速度",
   SpinnerSpeedDescHTML: "调整转轮指示的速度，作为区分电气化的建筑转轮指示速度为两倍。<b>调整值必须位于0.01到100之间。默认值为1</b>（调整转轮指示的速度不会影响每周期生产）",
   Sports: "体育运动",
   Stable: "马厩",
   Stadium: "体育场",
   StartFestival: "欢度佳节吧！",
