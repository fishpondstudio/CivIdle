export const ZH_CN = {
   ...
   Knight: "骑士",
   KnightCamp: "骑士营地",
   KoningsdagV2: "国王节：库肯霍夫公园为范围内的所有建筑提供 +N 生产乘数，N 为库肯霍夫公园提供幸福感的一半。莫瑞泰斯皇家美术馆的展览画家作品奖励和展览多元化奖励提供双倍加成",
   Koti: "💵瑞士货币",
   KotiInStorage: "已存储",
   KotiProduction: "💵瑞士货币",
   Kremlin: "克里姆林宫",
   ...
   Midsummer: "仲夏节",
   MidsummerDesc: "为周围 Y（仲夏节等级） 块地范围内的所有建筑提供 +N 生产等级，N 为该建筑获得时代智慧生产乘数的数值。该奇观仅可在仲夏期间（6 月 10 日至 6 月 30 日）建造。",
