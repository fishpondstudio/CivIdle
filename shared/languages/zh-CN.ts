export const ZH_CN = {
   ...
   BranCastle: "布朗城堡",
   BranCastleDescV2: "该奇观产出的劳动者等同于周围 2 地块范围内的劳动者总产出。如果有足够的劳动者，还会将该奇观产出的劳动者转化为吸血鬼。吸血鬼不参与生产或运输资源，但被视为忙碌的劳动者。布郎城堡的等级由劳动者总数决定，每一级获得 +1 闲置劳动者科学产出和 +2 忙碌劳动者科学产出。该奇观只能在万圣节（10.15 ~ 11.15）期间建造。",
   ...
   CathedralOfBrasiliaWarningHTML: "为了形成生产链，一个建筑生产的资源只能有一种资源没被消耗（只能一种资源产出没被✅），其他所有资源都需要被另一个建筑消耗（奇观、旅馆、仓库、市场、克隆工厂和克隆实验室除外）",
   Census: "劳动者统计",
