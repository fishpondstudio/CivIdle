export const ZH_CN = {
   ...
   Gameplay: "游戏设置",
   GangesRiver: "恒河",
   GangesRiverDescV2: "周围 2 地块范围内的每种建筑（产出劳动者建筑除外），所有同类型建筑获得 +N 生产乘数，N 为解锁该建筑时代的时代智慧等级",
   Garment: "服装",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDesc: "建造完成后，诞生一个除当前时代之外的伟人。该奇观可被升级，并且每一次升级都会诞生一个除当前时代之外的伟人。（随机区间：青铜~信息）当从这座奇观进行伟人选择时，每位伟人有 4 项可选。",
