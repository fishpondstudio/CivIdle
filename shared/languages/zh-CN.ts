export const ZH_CN = {
   ...
   AccountLevelUpgradeConditionAnyHTML: "要升级您的帐户至支持者，您只需要满足<b>以下</b>标准之一:",
   ...
   AlanTuring: "艾伦·图灵",
   AlanTuringDesc: "+%{value} 闲置劳动者科学产出",
   ...
   BaseMultiplier: "基础乘数",
   BaseProduction: "基础产出",
   BatchModeTooltip: "%{count} 当前已选择建筑物。升级将适用于所有选定的建筑",
   BatchSelectAllSameType: "所有相同类型",
   BatchSelectAnyType1Tile: "1 地块中任意类型",
   BatchSelectAnyType2Tile: "2 地块中任意类型",
   BatchSelectAnyType3Tile: "3 地块中任意类型",
   BatchSelectSameType1Tile: "1 地块中相同类型",
   BatchSelectSameType2Tile: "2 地块中相同类型",
   BatchSelectSameType3Tile: "3 地块中相同类型",
   BatchSelectThisBuilding: "此建筑",
   BatchUpgrade: "批量升级",
   Battleship: "战列舰",
   ...
   BuildingName: "建筑名",
   BuildingNoMultiplier: "%{building} <b>不受任何</b> 乘数（生产、工人能力、存储等）的影响",
   ...
   CivilService: "公务员制度",
   ClaimedGreatPeople: "认领伟人",
   ClaimedGreatPeopleTooltip: "你重生时有 %{total} 个伟人,其中 %{claimed} 个已认领",
   ClassicalAge: "古典时代",
   ...
   CristoRedentorDesc: "2 地块范围内的所有建筑都不受-1幸福的影响",
   Cryptocurrency: "加密货币",
   Culture: "文化",
   ...
   GreatMosqueOfSamarraDescV2: "+1 建筑视野范围。随机揭示5个未勘探的矿床地块，并在每个揭示的地块上建造一个10级该资源的生产建筑",
   GreatPeople: "伟人",
   ...
   GreatPersonLevelRequired: "需要永久伟人级别",
   GreatPersonLevelRequiredDesc: "在 %{city} 重生需要 %{required} 永久伟人等级。您当前有 %{current}",
   GreatPersonOnlyIn: "这位伟人只出生在 %{city}",
   GreatPersonThisRunEffectiveLevel: "您此轮拥有 %{count} %{person}。额外的 %{person} 将拥有该效果的 1/%{effect} ",
   GreatPersonWildCardBirth: "出生",
   GreatSphinx: "狮身人面像",
   GreatSphinxDesc: "周围 2 地块范围内的所有 II 阶及以上建筑，获得 +N 消费、生产乘数(N=其相邻相同类型建筑数量）",
   GreatWall: "长城",
   GreatWallDesc: "1个地块范围内的所有建筑都获得+N生产、劳动者能力和存储乘数。N=当前科技时代与建筑解锁时代之间的差值。在紫禁城旁边建造时，范围增加到2地块",
   ...
   MoaiDesc: "复活节岛摩艾石像",
   MogaoCaves: "莫高窟",
   MogaoCavesDescV2: "每 10% 忙碌工人获得 +1 幸福感 . 所有相邻的圣祠免去 -1 幸福感",
   Mosque: "清真寺",
   MotionPicture: "电影",
   MountSinai: "西奈山",
   MountSinaiDesc: "当此奇观被发现时，诞生一个当今时代的伟人. 所有生产信仰的建筑获得 +5 存储乘数",
   MountTai: "泰山",
   MountTaiDesc: "所有产生科学的建筑获得+1的生产乘数。使孔子（伟人）的效果加倍。当被发现时，产生相当于最昂贵的解锁技术成本的一次性科学点",
   Movie: "电影",
   MovieStudio: "电影制片厂",
   Museum: "博物馆",
   Music: "音乐",
   ...
   NileRiver: "尼罗河",
   NileRiverDesc: "使伟人哈特谢普苏特的效果加倍。所有小麦农场都获得 +1 的生产和储存乘数。所有相邻的小麦农场都获得 +5 的生产和储存乘数",
   ...
   OxfordUniversityDescV3: "产出科学的建筑获得+10%的科学产出加成。完成后，产生相当于最昂贵的解锁技术成本的一次性科学点",
   PaintersGuild: "画家协会",
   Painting: "绘画",
   Pantheon: "万神殿",
   PantheonDesc: "万神殿",
   ...
   Parliament: "议会",
   Parthenon: "帕特农神庙",
   ParthenonDescV2: "诞生两个古典时代的伟人，每个伟人有4个选择。音乐家协会和画家协会获得 +1 的生产乘数、劳动者生产能力和存储乘数，并免除 -1 幸福感",
   PatchNotes: "更新日志",
   ...
   PlayerTradeFillSuccessV2: "<b>%{success}/%{total}</b> 交易已完成。您支付了 <b>%{fillAmount} %{fillResource}</b> 并收到了 <b>%{receivedAmount} %{receivedResource}</b>",
   ...
   PorcelainTowerDesc: "+5幸福度。当建造完成时，你可提前结算现有的重生额外伟人并在本轮游戏获得此生伟人加成（他们与永久伟人遵循相同的规则）",
   Poseidon: "海神波塞冬",
   ...
   ResourceBarShowUncappedHappiness: "显示无上限的幸福度",
   ResourceColor: "资源色彩",
   ...
   SagradaFamiliaDesc: "2 范围内的所有建筑都获得+N生产、劳动者能力和存储乘数。N=范围内相邻建筑之间的最大层差",
   SaintBasilsCathedral: "瓦西里升天教堂",
   SaintBasilsCathedralDescV2: "允许资源开采建筑物在矿床相邻地块工作。所有 I 建筑都获得 +1 生产乘数、劳动者生产能力乘数和存储乘数",
   Saladin: "萨拉丁",
   Sand: "沙",
   Sandpit: "采沙坑",
   SargonOfAkkad: "萨尔贡大帝",
   ...
   SeaTradeCost: "海上贸易成本",
   SeaTradeUpgrade: "与玩家跨海贸易。每个海洋地块关税: %{tariff}",
   SelectedAll: "全选",
   ...
   ShortcutBuildingPageUpgrade1: "升级按钮 1（+1）",
   ShortcutBuildingPageUpgrade2: "升级按钮 2 (+5)",
   ShortcutBuildingPageUpgrade3: "升级按钮 3 (+10)",
   ShortcutBuildingPageUpgrade4: "升级按钮 4 (+15)",
   ShortcutBuildingPageUpgrade5: "升级按钮 5 (+20)",
   ShortcutClear: "清除",
   ...
   StatisticsOfficeDesc: "提供帝国的统计数据。生成用于探索地图的探险者",
   ...
   Synthetics: "合成材料",
   TajMahal: "泰姬陵",
   TajMahalDescV2: "建造完成时，诞生一个古典时代的伟人和一个中世纪的伟人。升级20级以上建筑时获得 +5 建造能力乘数",
   TangOfShang: "商汤",
   ...
   TempleOfArtemisDesc: "当完成建造时，所有铸剑铺与军械库，获得 +5 等级。所有铸剑铺与军械库，获得 +1 生产乘数、劳动者能力乘数以及存储乘数",
   TempleOfHeaven: "天坛",
   TempleOfHeavenDesc: "所有等级 10 或更高的建筑，获得 +1 劳动者能力乘数",
   TempleOfPtah: "卜塔神庙",
   TerracottaArmy: "兵马俑",
   TerracottaArmyDesc: "所有铁矿，获得 +1 生产乘数、劳动者能力乘数以及存储乘数。与铁锻铺相邻的每座铁矿，使铁锻铺获得 +1 生产乘数",
   Theater: "剧院",
   Theme: "主题",
   ThemeColor: "主题色彩",
   ...
   UnitedNations: "联合国",
   UnitedNationsDesc: "所有 IV、V 和 VI 阶建筑，生产、劳动者和存储能力乘数 +1。 参加联合国大会并每周投票支持额外奖励",
   ...
   WarehouseSettingsAutopilotDesc: "这座仓库将会使用它的闲置能力，从无存储空间的建筑中运送资源。当前闲置能力为 %{capacity}",
   ...
   Water: "水",
   WellStockedTooltip: "库存充足的建筑是指有足够资源进行生产的建筑，包括正在生产、储存充足或因缺少劳动者而无法生产的建筑",
   Wheat: "小麦",
   WheatFarm: "小麦农场",
   WildCardGreatPersonDesc: "升级为任何同时代的永久伟人",
   ...
   YangtzeRiver: "长江",
   YangtzeRiverDesc: "所有消耗水的建筑都获得+1的生产、劳动者能力和存储乘数。使郑和（伟人）的效果加倍。武则天（伟人）每级为所有建筑提供+1存储乘数",
   YellowCraneTower: "黄鹤楼",
   YellowCraneTowerDesc: "选择伟人时+1个可选项。1个地块范围内的所有建筑都将获得+1的生产、劳动者能力和存储乘数。当建在长江边时，范围增加到2地块",
   Zenobia: "芝诺比娅",
