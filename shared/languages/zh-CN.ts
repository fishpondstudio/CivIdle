export const ZH_CN = {
   ...
   GoldenPavilion: "金阁寺",
   GoldenPavilionDesc: "周围 3 地块范围内的所有建筑，A建筑相邻B建筑,且B生产是A消耗所需,则A建筑获得 +1 生产乘数（克隆实验室与克隆工厂除外,需建筑都运转。例：石雕铺相邻3个工匠铺，石雕铺获得+3生产乘数）",
   GoldMiningCamp: "金矿",
   GordonMoore: "戈登·摩尔",
   GrandBazaar: "大巴扎",
   ...
   PlayerMapTileFromOccupying: "来自使用账号等级点数地块",
   PlayerMapTileFromOccupyingTooltipHTML: "使用账号等级点数的地块每个将每小时生成<b>%{point}</b>地块点数（从第一个宣称地块开始，每个地块最多累计生成%{max}天）",
   ...
   Skyscraper: "摩天大楼",
   Socialism: "社会主义",
   SocialismLevel4DescHTMLV2: "生成一批科学，生成量等(577.3B)同于<b>世界大战时期</b>最廉价科技所需",
   SocialismLevel5DescHTMLV2: "生成一批科学，生成量等(9.741T)同于<b>冷战时期</b>最廉价科技所需",
