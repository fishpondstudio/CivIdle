export const ZH_CN = {
   ...
   Gameplay: "游戏设置",
   GangesRiver: "恒河",
   GangesRiverDesc: "周围 2 地块范围内的每种建筑获得 +N 生产乘数，N 为解锁该建筑时代的时代智慧等级",
   Garment: "服装",
   ...
   LargeHadronColliderDescV3: "所有信息时代的伟人（包括未拥有过的）额外获得 +2 等级。该奇观可被升级，并且每一次额外升级，为所有信息时代的伟人（包括未拥有过的）提供 +1 等级（不包括给与奇观额外等级的信息时代伟人）",
   Law: "法律",
   LeeKuanYew: "李光耀",
   Lens: "镜头",
   LensWorkshop: "镜头工坊",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDesc: "建造完成后，诞生一个之前时代的伟人。该奇观可被升级，并且每一次升级都会诞生一个之前时代的伟人。当从这座奇观进行伟人选择时，每位伟人有 4 项可选。",
   ...
   RedFort: "红堡",
   RedFortDesc: "周围 4 地块范围内的所有建筑获得 +5 额外建筑等级。该奇观可被升级，并且每一次额外升级为周围 4 地块范围内的所有建筑额外提供 +1 额外建筑等级",
