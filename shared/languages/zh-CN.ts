export const ZH_CN = {
   ...
   BuildingLevelBoostDesc: "为 %{building} 提升 +%{value} 额外建筑等级",
   ...
   ItaipuDam: "伊泰普大坝",
   ItaipuDamDesc: "该奇观可被升级，并且每一次额外升级，为周围 2 地块范围的建筑提供 +1 生产乘数或 +1 额外建筑等级。为周围 2 地块范围提供电力。",
   ...
   Justinian: "查士丁尼",
   Kanagawa: "神奈川",
   KanagawaDesc: "当此奇观被发现后，所有当前时代的伟人，额外获得 +1 等级（芝诺比娅除外）",
   KarlMarx: "卡尔·马克思",
   Knight: "骑士",
   KnightCamp: "骑士营地",
   Koti: "💵瑞士货币",
