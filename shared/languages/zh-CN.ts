export const ZH_CN = {
   ...
   MausoleumAtHalicarnassusDesc: "周围 2 地块范围免费运输",
   HangingGarden: "空中花园",
   HangingGardenDesc: "+1 建造者能力乘数。相邻引水渠获得 +1 生产、存储以及劳动者能力乘数",
   Colosseum: "斗兽场",
   ColosseumDesc: "对所有战车工坊，影响的幸福感之和免除 -1 幸福感。消耗 10 战车，并且产出 10 幸福感",
   SummerPalace: "颐和园",
   ...
   EiffelTower: "埃菲尔铁塔",
   EiffelTowerDesc: "所有相邻炼钢厂，获得 +N 生产、存储以及劳动者能力乘数。 N 取决于其相邻炼钢厂数量",
