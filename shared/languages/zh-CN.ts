export const ZH_CN = {
   ...
   StatisticsTransportationBuilding: "建筑",
   StatisticsTransportationResource: "资源",
   StatisticsTransportationAmount: "数量",
   PlayerTrade: "玩家贸易",
   PlayerTradeIWant: "购入",
   ...
   PlayerTradeFillSuccess: "订单已成功交付",
   ...
   ResourceImportImportPerCycle: "输入",
   ResourceImportImportCap: "限额",
   ...
   ShortcutBuildingPageUpgradeX5: "预升5级",
   ...
   UnclaimedGreatPerson: "你有未迎接的伟人，点此欢迎其加入",
   ...
   Ok: "确认",
   Cancel: "取消",
   ChooseGreatPersonFromLastReborn: "从最近一次的重生中选择伟人",
   ...
   Tutorial6:
      "    当你进入一个新时代，一位新的<b>伟人</b>将会诞生。你能从三位候选人中选出一位来辅佐你的帝国。<br><br>    伟人提供加成并且能加入你的永恒收集中。一旦你重生，你会收集到此轮所有你选中的伟人，额外的一些会消失，这些永恒伟人将仍伴你左右。<br><br>    <b>永恒</b>伟人能通过每轮收集对应伟人进行升级。他们将帮助你的帝国达到新的高度。这些都是你所需了解的基础。<br><br>    如果你有疑问，获取帮助的最好途径就是求助于<b>聊天</b>。我们有一个友好的社区，随时准备提供帮助。",
   ...
   TribuneUpgradeDesc:
      "    从保民官升至财务官，将允许你的账号解锁全部在线内容。然而，只有<b>升至等级 %{level} 的永恒伟人</b>能被携带。",
