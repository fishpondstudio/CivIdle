export const KR = {
   ...
   AlanTuring: "앨런 튜링",
   AlanTuringDesc: "잉여 일꾼 당 +%{value} 과학 생산",
   ...
   AngkorWat: "앙코르 와트",
   AngkorWatDesc: "모든 인접한 건물이 +1의 일꾼 용량 배수를 얻습니다. 1000 일꾼를 생산합니다.",
   ...
   ApolloProgramDesc: "모든 로켓 공장은 생산, 일꾼 수용량, 저장 배수 +2를 얻습니다. 위성 공장, 우주선 공장, 핵 미사일 사일로는 인접한 로켓 공장마다 생산 배수 +1을 얻습니다.",
   ApplyToAll: "일괄 적용",
   ...
   AtomicTheory: "원자론",
   Atomium: "아토미움",
   AtomiumDesc: "2타일 범위 내에서 과학을 생산하는 모든 건물은 +5 생산 배수를 얻습니다. 2타일 범위 내의 과학 생산량과 동일한 과학을 생성합니다.",
   Autocracy: "독재",
   Aviation: "비행",
   BackToCity: "도시로 돌아가기",
   ...
   BrandenburgGateDesc: "모든 석탄광산과 유정이 +1의 생산, 저장소, 일꾼 용량 배수를 얻습니다. 정유 공장이 인접한 석유 타일 하나당 +1의 생산, 저장소, 일꾼 용량 배수를 얻습니다.",
   Bread: "빵",
   Brewery: "양조장",
   Brick: "벽돌",
   Brickworks: "벽돌 공장",
   ...
   BuildingName: "이름",
   BuildingNoMultiplier: "%{building}은 생산, 일꾼 용량, 저장 등의 배수에 <b>영향을 받지 않습니다</b>.",
   ...
   ChichenItza: "치첸 이트사",
   ChichenItzaDesc: "모든 인접한 건물이 +1의 생산, 저장소, 일꾼 용량 배수를 얻습니다.",
   ...
   ColossusOfRhodesDesc: "일꾼를 생산하지 않는 모든 인접한 건물이 +1의 행복도를 얻습니다.",
   Combustion: "연소",
   Computer: "컴퓨터",
   ...
   ConfirmYes: "예",
   Confucius: "공자",
   ConfuciusDesc: "일꾼의 50% 이상이 노동중이면 모든 일꾼의 과학 +%{value}",
   Constitution: "헌법",
   Construction: "건축",
   ...
   Education: "교육",
   EiffelTower: "에펠탑",
   EiffelTowerDesc: "모든 인접한 제강공장이 +N 의 생산, 저장소, 일꾼 용량 배수를 얻습니다. N = 인접한 제강공장의 수",
   Electricity: "전력",
   Electrification: "전기화",
   ...
   ExploreThisTileHTML: "탐험가는 <b>선택한 타일과 인접한 타일</b>을 탐색합니다. Explorer는 %{name}에서 생성됩니다. %{count}명의 탐험가가 남았습니다.",
   ...
   Feudalism: "봉건제",
   Fibonacci: "피보나치",
   FibonacciDescV2: "잉여 일꾼 과학 생산 +%{idle}. 노동중인 일꾼 과학 생산 +%{busy}. 피보나치의 영구 업그레이드 비용은 피보나치 수열을 따릅니다.",
   FighterJet: "전투기",
   ...
   GalileoGalileiDesc: "잉여 일꾼 과학 생산 +%{value}",
   Galleon: "갤리온",
   GalleonBuilder: "갤리온 조선소",
   Gameplay: "일반",
   GameVisual: "게임 비주얼",
   GameVisualShowEmpireValue: "건물 타일에 제국 가치 표시",
   Garment: "의류",
   ...
   HangingGardenDesc: "+1 일꾼 용량 배수. 인접한 수로가 +1의 생산, 저장소, 일꾼 용량 배수를 얻습니다.",
   Happiness: "행복도",
   ...
   Herodotus: "헤로도토스",
   HimejiCastle: "히메지 성",
   HimejiCastleDesc: "모든 캐러벨 조선소, 갤리온 조선소, 프리깃 조선소가 +1의 생산, 저장소, 일꾼 용량 배수를 얻습니다.",
   Hollywood: "할리우드",
   HollywoodDesc: "+5 행복도. 2타일 범위 내에서 문화를 소비하거나 생산하는 재고가 풍부한 건물마다 행복 +1",
   HolyEmpire: "신성제국",
   Horse: "말",
   HorsebackRiding: "승마",
   House: "집",
   ...
   IronTech: "철",
   IsaacNewton: "아이작 뉴턴",
   IsaacNewtonDesc: "일꾼의 50% 이상이 노동중이면 모든 일꾼의 과학 생산 +%{value}",
   ...
   MoaiDesc: "모아이 석상",
   MogaoCaves: "막고굴",
   MogaoCavesDescV2: "바쁜 노동자 10%마다 행복도가 1 증가합니다. 인접한 모든 성소는 행복도 -1에서 면제됩니다.",
   ...
   NielsBohr: "닐스 보어",
   NielsBohrDesc: "일꾼의 50% 이상이 바쁘면 모든 일꾼의 과학 생산 +%{value}",
   NileRiver: "나일 강",
   ...
   Parliament: "국회",
   Parthenon: "파르테논 신전",
   ParthenonDescV2: "고전 시대의 위인 둘이 태어나고 각각 4개의 선택권을 얻습니다. 음악가 길드와 화가 길드가 +1 생산력, 일꾼 수용량, 저장 배수를 얻고 -1 행복에서 면제됩니다.",
   PatchNotes: "패치노트",
   PermanentGreatPeople: "영구적인 위인",
   PermanentGreatPeopleAcquired: "영구적인 위인 획득",
   PermanentGreatPeopleLevels: "영구적인 위인 레벨",
   Persepolis: "페르세폴리스",
   PersepolisDesc: "모든 벌목장, 채석장, 구리광산이 +1의 생산, 저장소, 일꾼 용량 배수를 얻습니다.",
   Petra: "페트라",
   ...
   PyramidOfGizaDesc: "일꾼를 생산하는 모든 건물이 +1의 생산배수를 얻습니다.",
   QinShiHuang: "진시황제",
   Radio: "라디오",
   ...
   RequiredWorkersTooltip: "생산에 필요한 근로자 수는 배수 계산 후 소비 및 생산되는 모든 자원의 합계와 같습니다(전력화 제외).",
   RequirePower: "요구 전력",
   ...
   ScienceFromIdleWorkers: "잉여 일꾼 과학 생산",
   SciencePerBusyWorker: "노동중인 일꾼 당",
   SciencePerIdleWorker: "잉여 일꾼 당",
   ...
   StatueOfLibertyDesc: "모든 인접한 건물이 +N의 생산, 저장소, 일꾼 용량 배수를 얻습니다. N = 동일한 유형의 인접한 건물 수",
   StatueOfZeus: "제우스 상",
   ...
   TangOfShang: "탕왕",
   TangOfShangDesc: "+%{value} 잉여 일꾼당 과학 생산",
   Tank: "탱크",
   TankFactory: "탱크 공장",
   TechAge: "Age",
   ...
   TempleOfHeaven: "천단",
   TempleOfHeavenDesc: "레벨 10이상의 모든 건물이 +1의 일꾼 용량 배수를 얻습니다.",
   TempleOfPtah: "프타 사원",
   TerracottaArmy: "병마용",
   TerracottaArmyDesc: "모든 철 광산이 +1의 생산, 저장소, 일꾼 용량 배수를 얻습니다. 철 대장간이 인접한 철 광산 하나당 +1의 생산 배수를 얻습니다.",
   Theater: "극장",
   Theme: "테마",
   ThemeColor: "테마 색상",
   ...
   Wood: "나무",
   Worker: "노동자",
   WorkerCapacityMultiplier: "일꾼 용량 배수",
   ...
   WorkersRequiredForProductionMultiplier: "일꾼당 생산능력",
