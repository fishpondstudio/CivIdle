export const KR = {
   ...
   OxfordUniversityDescV3: "과학을 생산하는 건물의 과학 생산량이 10% 증가 합니다. 완공 시 가장 비싼 잠금 해제 기술 비용에 해당하는 1회성 과학을 생성합니다.",
   ...
   Synthetics: "합성화학",
   TajMahal: "타지마할",
   TajMahalDescV2: "고전시대의 위인과 중세시대의 위인이 탄생합니다. 레벨 20 이상의 건물을 업그레이드할 때 건설자 용량 배수 +5",
   TangOfShang: "탕왕",
   ...
   Carnival: "카니발: 카피바라, 거대 수달, 호아친 및 Royal Flycatcher의 범위가 3타일로 증가합니다. 브라질리아 대성당의 생산 배수을 두 배가 됩니다",
   Cartographer: "지도 제작자",
