export const KR = {
   ...
   TutorialAdvices:
      "우리는 경험이 풍부한 플레이어들에게 게임을 시작한 플레이어를 위한 조언을 부탁했습니다. 게임에 뛰어들기 전에 매우 유용한 팁이 있습니다.<ol><li><b>모든 건물을 동시에 업그레이드 하지 마세요.</b>: 업그레이드를 시작한 건물은 더 이상 자원을 생산하지 않습니다.</li><li><b>당신의 행복도에 주의하세요</b>: 행복도가 음수가 되면 사용 가능한 노동자가 줄어들고 -50에 도달하면 모든 생산이 중단됩니다.</li><li><b>과도하게 확장하지 마세요</b>: 건물은 작동하기 위해 행복도를 요구합니다. 확장하기 전에 행복도가 충분한지 확인하세요.</li><li><b>집, 아파트, 콘도의 우선순위 설정</b>: 이 건물들의 우선순위를 높게 설정하면 갑작스러운 노동자 감소를 방지할 수 있습니다.</li><li><b>당신은 언제든지 환생할 수 있어요</b>: 첫번째 맵이 엉망이라면 다시 시작해도 괜찮아요.</li></ol>",
