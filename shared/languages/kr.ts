export const KR = {
   ...
   SwissBank: "스위스 은행",
   SwissBankDescV2: "인접한 창고에서 선택한 자원을 Koti로 변환합니다.(Sanskrit로 1천만) - 1 Koti는 1천만의 가치의 거래 가능 자원 입니다. 스위스 은행의 각 레벨은 생산 배수의 영향을 받는 사이클 당 1개의 Koti로 변환되어 추가 합니다. 스위스 은행은 무제한으로 Koti를 저장 할 수 있습니다.",
   Sword: "검",
   SwordForge: "검 대장간",
