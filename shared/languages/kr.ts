export const KR = {
   ...
   AngkorWat: "앙코르 와트",
   AngkorWatDesc: "모든 인접한 건물이 +1의 일꾼 당 생산량 배수를 얻습니다. 1000 일꾼를 생산합니다.",
   ...
   BrandenburgGateDesc: "모든 석탄광산과 유정이 +1의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다. 정유 공장이 인접한 석유 타일 하나당 +1의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다.",
   Bread: "빵",
   Brewery: "양조장",
   Brick: "벽돌",
   Brickworks: "벽돌 공장",
   ...
   BuildingName: "이름",
   BuildingNoMultiplier: "%{building}은 생산, 일꾼 당 생산량, 저장 등의 배수에 <b>영향을 받지 않습니다</b>.",
   ...
   ChichenItza: "치첸 이트사",
   ChichenItzaDesc: "모든 인접한 건물이 +1의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다.",
   ...
   Education: "교육",
   EiffelTower: "에펠탑",
   EiffelTowerDesc: "모든 인접한 제강공장이 +N 의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다. N = 인접한 제강공장의 수",
   Electricity: "전력",
   Electrification: "전기화",
   ...
   HangingGardenDesc: "+1 일꾼 당 생산량 배수. 인접한 수로가 +1의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다.",
   Happiness: "행복도",
   ...
   Herodotus: "헤로도토스",
   HimejiCastle: "히메지 성",
   HimejiCastleDesc: "모든 캐러벨 조선소, 갤리온 조선소, 프리깃 조선소가 +1의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다.",
   Hollywood: "할리우드",
   ...
   MoaiDesc: "모아이 석상",
   MogaoCaves: "막고굴",
   MogaoCavesDescV2: "노동중인 노동자 10%마다 행복도가 1 증가합니다. 인접한 모든 성소는 행복도 -1에서 면제됩니다.",
   ...
   Parliament: "국회",
   Parthenon: "파르테논 신전",
   ParthenonDescV2: "고전 시대의 위인 둘이 태어나고 각각 4개의 선택권을 얻습니다. 음악가 길드와 화가 길드가 +1 생산력, 일꾼 수용량, 저장 배수를 얻고 -1 행복도에서 면제됩니다.",
   PatchNotes: "패치노트",
   PermanentGreatPeople: "영구적인 위인",
   PermanentGreatPeopleAcquired: "영구적인 위인 획득",
   PermanentGreatPeopleLevels: "영구적인 위인 레벨",
   Persepolis: "페르세폴리스",
   PersepolisDesc: "모든 벌목장, 채석장, 구리광산이 +1의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다.",
   Petra: "페트라",
   ...
   StatueOfLibertyDesc: "모든 인접한 건물이 +N의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다. N = 동일한 유형의 인접한 건물 수",
   StatueOfZeus: "제우스 상",
   ...
   TempleOfHeaven: "천단",
   TempleOfHeavenDesc: "레벨 10이상의 모든 건물이 +1의 일꾼 당 생산량 배수를 얻습니다.",
   TempleOfPtah: "프타 사원",
   TerracottaArmy: "병마용",
   TerracottaArmyDesc: "모든 철 광산이 +1의 생산, 저장소, 일꾼 당 생산량 배수를 얻습니다. 철 대장간이 인접한 철 광산 하나당 +1의 생산 배수를 얻습니다.",
   Theater: "극장",
   Theme: "테마",
   ThemeColor: "테마 색상",
   ...
   Wood: "나무",
   Worker: "노동자",
   WorkerCapacityMultiplier: "일꾼 당 생산량 배수",
