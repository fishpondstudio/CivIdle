export const KR = {
   ...
   ApolloProgramDesc: "모든 로켓 공장은 생산, 노동 능력, 저장소 배수 +2를 얻습니다. 위성 공장, 우주선 공장, 핵 미사일 사일로는 인접한 로켓 공장마다 생산 배수 +1을 얻습니다.",
   ApplyToAll: "일괄 적용",
   ...
   BuildingName: "이름",
   BuildingNoMultiplier: "%{building}은 생산, 노동 능력, 저장 등의 배수에 <b>영향을 받지 않습니다</b>.",
   ...
   CNTower: "CN 타워",
   CNTowerDesc: "모든 영화 스튜디오, 라디오 방송국 및 TV 방송국은 행복도 -1이 면제됩니다. 세계 대전과 냉전에서 잠금 해제된 모든 건물은 +N 생산, 노동자 능력 및 저장소 배수를 얻습니다. N = 건물의 티어와 시대의 차이",
   Coal: "석탄",
   CoalMine: "석탄 광산",
   ...
   FreeThisWeekDescHTML: "<b>매주</b> 프리미엄 도시 중 하나를 무료로 플레이할 수 있습니다. 이번 주 무료 도시는 <b>%{city}</b>입니다.",
   Frigate: "프리깃",
   ...
   ManhattanProjectDesc: "모든 우라늄 광산이 +2 생산, 노동 능력, 저장소 배수를 얻습니다. 우라늄 농축 공장과 핵 물질 재처리시설은 우라늄 매장지 위에 건설된 인접한 우라늄 광산마다 +1 생산 배수를 얻습니다.",
   Marble: "대리석",
   Marbleworks: "대리석 공장",
   MarcoPolo: "마르코 폴로",
   MarieCurie: "마리 퀴리",
   ...
   Parliament: "국회",
   Parthenon: "파르테논 신전",
   ParthenonDescV2: "고전 시대의 위인 둘이 태어나고 각각 4개의 선택권을 얻습니다. 음악가 길드와 화가 길드가 +1 생산력, 노동 능력, 저장소 배수를 얻고 행복도 -1이 면제됩니다.",
   PatchNotes: "패치노트",
   ...
   SaintBasilsCathedralDescV2: "자원 추출 건물이 광산 근처에서 작동하도록 허용합니다. 모든 티어 1 건물은 생산량 배수, 노동 능력, 저장소 배수 +1을 얻습니다.",
   Saladin: "살라딘",
   Sand: "모래",
   Sandpit: "모래 채취장",
   ...
   Shelter: "주거",
   Shenandoah: "셰넌도어",
   ShenandoahDescV2: "현대 시대에 잠금 해제된 건물은 +2 생산 배수를 얻습니다. J.P. 모건의 효과 2배",
   Shortcut: "단축키",
   ...
   TheMet: "메트로폴리탄 미술관",
   TheMetDesc: "건설 후에는 건물을 이동하는 데 사용할 수 있는 텔레포트를 생성합니다. 2타일 범위 내의 모든 건물은 생산량, 노동자 능력, 저장소 배수 +1을 얻습니다.",
   ...
   UnitedNations: "연합 국가",
   UnitedNationsDesc: "모든 티어 IV, V, VI 건물은 +1 생산량, 노동 능력, 저장소 배수를 얻습니다. UN 총회에 참여하고 매주 추가 부스트에 투표하세요",
   ...
   Xuanzang: "현장",
   YangtzeRiver: "양쯔강",
   YangtzeRiverDesc: "물을 소비하는 모든 건물은 생산력, 노동 능력, 저장소 배수를 +1 얻습니다. 정화(위인)의 효과가 두 배로 증가합니다. 영구적인 측천무후(위인)은 레벨 당 모든 건물에 +1 저장소 배수를 제공합니다.",
