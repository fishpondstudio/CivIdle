export const KR = {
   ...
   SantaClausVillageDesc: "완성 시, 현시대 위인 한 명이 탄생합니다. 이 불가사의는 업그레이드할 수 있으며, 업그레이드할 때마다 위인 한 명을 추가로 생성됩니다. 이 불가사의로 인한 위인 선택 시 4명의 위인 중 한 명을 선택하여 고를 수 있습니다. 이 불가사의는 12월에만 발견됩니다.",
