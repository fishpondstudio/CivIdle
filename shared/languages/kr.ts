export const KR = {
   ...
   BrandenburgGateDesc: "모든 석탄광산과 유정이 +1의 생산, 저장소, 작업자 용량배수를 얻습니다. 정유 공장이 인접한 석유 타일 하나당 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다.",
   Bread: "빵",
   Brewery: "양조장",
   Brick: "벽돌",
   Brickworks: "벽돌 공장",
   ...
   Education: "교육",
   EiffelTower: "에펠탑",
   EiffelTowerDesc: "모든 인접한 제강공장이 +N 의 생산, 저장소, 작업자 용량 배수를 얻습니다. N = 인접한 제강공장의 수",
   Electricity: "전력",
   Electrification: "충전",
   ...
   Herodotus: "헤로도토스",
   HimejiCastle: "히메지 성",
   HimejiCastleDesc: "모든 캐러벨 조선소, 갤리온 조선소, 프리깃 조선소가 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다.",
   Hollywood: "Hollywood",
   ...
   RijksmuseumDesc: "행복도 +5, 문화를 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 작업자 용량배수를 얻습니다.",
   RoadAndWheel: "도로와 바퀴",
   Robotics: "로봇공학",
   Rocket: "Rocket",
   ...
   StatueOfLibertyDesc: "모든 인접한 건물이 +N의 생산, 저장소, 작업자 용량 배수를 얻습니다. N = 동일한 유형의 인접한 건물 수",
   StatueOfZeus: "제우스 상",
   ...
   SummerPalace: "이화원",
   SummerPalaceDesc: "화약을 생산하거나 소비하는 모든 인접한 건물은 행복도 -1이 면제되며, 화약을 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 작업자 용량배수를 얻습니다.",
   Sword: "검",
   SwordForge: "검 대장간",
   ...
   TempleOfArtemisDesc: "완성시 모든 검 대장간과 무기고가 +5레벨을 얻습니다. 모든 검 대장간과 무기고가 +1의 생산, 저장소, 작업자 용량배수를 얻습니다.",
   TempleOfHeaven: "천단",
   TempleOfHeavenDesc: "레벨 10이상의 모든 건물이 +1의 작업자 용량 배수를 얻습니다.",
   TempleOfPtah: "Temple of Ptah",
   TerracottaArmy: "병마용",
   TerracottaArmyDesc: "모든 철 광산이 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다. 철 대장간이 인접한 철 광산 하나당 +1의 생산 배수를 얻습니다.",
   Theater: "극장",
   Theme: "테마",
   ThemeColor: "테마 색상",
