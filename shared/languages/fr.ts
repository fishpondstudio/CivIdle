export const FR = {
   ...
   Dido: "Didon",
   DinosaurProvincialParkDesc: "Cette merveille peut être activée au moment de votre choix pour obtenir des Koti unique correspondant à 25 % de la valeur de l'empire à ce moment-là",
   ...
   AkademikLomonosovDescV2: "Cette merveille peut être améliorée, et chaque niveau fournit 100 kW d'énergie. Elle alimente toutes les tuiles situées dans un rayon de 2 cases. Cette merveille peut être déplacée.",
   AkbarTheGreat: "Akbar The Great",
   AlanTuring: "Alan Turing",
   AlbertEinstein: "Albert Einstein",
   AldersonDisk: "Alderson Disk",
   AlpsDescV2: "Tous les 10 niveaux d'un bâtiment, le multiplicateur de production augmente de +1",
   ...
   AuroraBorealisDesc: "Tous les bâtiments qui ne produisent pas de travailleurs dans un rayon de 2 cases bénéficient d'un multiplicateur de production de +X. La valeur de X dépend du temps écoulé depuis la découverte de la merveille.",
   Australian: "Australian",
   AustralianUniqueEffectHTML: "Une merveille naturelle aléatoire issue d'autres civilisations apparaît sur la carte",
   Aviation: "Aviation",
   ...
   BranCastleDescV2:
      "Produit X ouvriers. X = nombre d'ouvriers produits dans un rayon de 3 cases. S'il y a suffisamment d'ouvriers, X d'entre eux seront également affectés au rôle de vampires. Les vampires ne produisent ni ne transportent de ressources, mais sont comptabilisés comme des ouvriers actifs. Le niveau du château de Bran est déterminé par le nombre total d'ouvriers ; chaque niveau confère +1 en Science par ouvrier inactif et +2 en Science par ouvrier actif. Cette merveille ne peut être construite que pendant la période d'Halloween (du 15 au 15 novembre).",
   BrianSchmidt: "Brian Schmidt",
   BritishMuseum: "British Museum",
   Broadway: "Broadway",
   BronzeTech: "Bronze",
   BuddhismLevelX: "Buddhism %{level}",
   BuildWithin0TileRange: "Construire sur la tuile sélectionnée",
   BuildWithinXTileRange: "Construire sur les tuiles vides à l'intérieur de %{range}-tile range",
   BuySupporterPack: "Acheter un pack de soutien",
   Canadian: "Canadian",
   ...
   ChateauFrontenacDesc: "Cette merveille peut être améliorée. À chaque fois qu'elle gagne un niveau, trois bâtiments aléatoires de l'âge actuel sont sélectionnés. Choisissez-en un pour bénéficier d'un bonus de +1 au niveau de construction (ce choix ne peut pas être modifié une fois effectué).",
   ...
   CrossPlatformSaveDescHTML: "Pour synchroniser votre progression (y compris votre rang de compte et votre pack de soutien) sur vos appareils mobiles, vous devez acheter Cross Platform Cloud Save sur Steam",
   ...
   DestroyAllResources: "Détruire toutes les ressources",
   DestroyAllResourcesContent: "Êtes-vous sûr de vouloir détruire toutes les ressources de ce bâtiment ? Cette action ne peut pas être annulée.",
   DestroyResource: "Détruire la ressource",
   DinosaurProvincialPark: "Dinosaur Provincial Park",
   DinosaurProvincialParkNotUsedWarningHTML: "Vous n'avez pas encore activé le Parc provincial des Dinosaures ; pensez à l'activer avant votre renaissance",
   ...
   EmpireValueImpactAfterTariff: "Impact sur la valeur d'Empire (après application des droits de douane)",
   EmployedVampires: "Employed Vampires",
   EnableTodo: "Enable",
   EnricoFermi: "Enrico Fermi",
   EnterExitMinimizedMode: "Activer/désactiver le mode minimisé",
   EstimatedTimeLeftShort: "Durée estimée restante",
   ExpansionLevelX: "Expansion %{level}",
   Exploration: "Exploration",
   ExtraTileForNextRebirthTooltip: "Vous recevez %{count} tuile(s) supplémentaire(s) pour votre prochaine réincarnation, offerte(s) par l'Opéra de Sydney",
   Festival: "Festival",
   Fibonacci: "Fibonacci",
   FindPlayers: "Rechercher des joueurs",
   ...
   FusionFuel: "Combustible de fusion",
   FusionFuelPlant: "Usine de combustible de fusion",
   FusionPowerPlant: "Centrale à fusion",
   Future: "Future",
   ...
   GreatBarrierReefDesc: "Chaque point de bonheur rapporte +0,2*X en science par ouvrier occupé et +0,1*X en science par ouvrier inactif. X = ère actuelle (Âge de pierre = 1, Âge du bronze = 2, Âge de l'information = 10)",
   GreatOceanRoad: "Great Ocean Road",
   GreatOceanRoadDesc: "Cette merveille peut être améliorée, et chaque niveau confère un bonus de +1 au niveau de construction des bâtiments bénéficiant du bonus des cases de commerce",
   GreatPeoplePermanentColumn: "Permanent",
   GreatPeoplePermanentShort: "Permanent",
   GreatPeopleShardsAcquired: "Acquisition de fraguement de personnage illustre",
   GreatSphinxDescV2: "Tous les bâtiments de niveau II ou supérieur situés dans un rayon de 2 cases bénéficient d'un multiplicateur de production de +N. N = nombre de bâtiments adjacents du même type",
   Habitat67: "Habitat 67",
   Habitat67DescV2: "Cette merveille peut être améliorée, et chaque niveau confère +1 en production, en capacité d'ouvriers et en multiplicateur de stockage aux laboratoires de l'IA. Elle confère +1 en production et en multiplicateur de stockage aux laboratoires de l'IA pour chaque niveau de sagesse de l'ère de l'information. Elle confère un bonus de +1 au niveau de construction des laboratoires de l'IA tous les 5 points de bonheur (plafonné).",
   Hammurabi: "Hammurabi",
   HarryMarkowitz: "Harry Markowitz",
   HeitorVillaLobos: "Heitor Villa-Lobos",
   HenryFord: "Henry Ford",
   Hermitage: "Hermitage",
   HermitageDesc: "Cette merveille peut être améliorée, et chaque niveau confère un multiplicateur de stockage de +1 à chaque type de bâtiment situé dans un rayon de 2 cases",
   ...
   Kanagawa: "Kanagawa",
   KarlMarx: "Karl Marx",
   KeepTheWindowOpenAfterPlacingTrade: "Laissez la fenêtre ouverte après avoir passé votre ordre",
   KingDavid: "King David",
   KizhiPogost: "Kizhi Pogost",
   KizhiPogostDescV2: "Tous les bâtiments situés dans un rayon de 3 cases bénéficient d'un multiplicateur de production de +X. X = le multiplicateur de production attribué à cette merveille",
   Koti: "Koti",
   Kremlin: "Kremlin",
   LakeBaikal: "Lake Baikal",
   LakeBaikalDesc: "+X Multiplicateur de capacité de construction. X = nombre total de niveaux des merveilles situées dans un rayon de 2 cases",
   LakeLouise: "Lake Louise",
   LakeLouiseDesc: "Tous les voisins sur la carte commerciale deviennent des alliés (quelle que soit leur civilisation). Chaque case alliée confère un bonus de +2 au niveau de construction.",
   Laozi: "Laozi",
   Lapland: "Lapland",
   ...
   Maslenitsa: "Maslenitsa : une autonomie deux fois supérieure à celle du Pogost de Kizhi et du lac Baïkal. Une puissance deux fois supérieure à celle de l'Akademik Lomonosov",
   MatrioshkaBrain: "Matrioshka Brain",
   MatrioshkaBrainDescV3:
      "La science est prise en compte dans le calcul de la valeur impériale (5 points de science = 1 point de valeur impériale). +5 points de science par ouvrier actif et inactif. Cette merveille peut être améliorée ; chaque amélioration supplémentaire confère +1 point de science par ouvrier actif et inactif, ainsi qu'un multiplicateur de production de +1 pour les bâtiments produisant de la science (y compris le laboratoire de clonage).",
   MaxOfflineProductionTimeDesc: "La durée maximale de production hors ligne est de %{time}. Les autres sont converties en Time Warp",
   ...
   Moomba: "Moomba : La Great Ocean Road confère également un multiplicateur de production de +1 par niveau aux bâtiments bénéficiant du bonus des cases de commerce. Augmente la portée d'Uluru à 3 cases.",
   ...
   Ok: "OK",
   Olive: "Olive",
   OpenPlayerTrades: "commerce entre  joueurs",
   OperationSuccessful: "Opération réussie",
   OpetV2: "Opet : Le Grand Sphinx confère un bonus de niveau de bâtiment +N à tous les bâtiments de niveau II ou supérieur situés dans un rayon de 2 cases. N = nombre de bâtiments adjacents du même type.",
   OptionsMenu: "Options",
   ...
   PinTodo: "Pin",
   PinTodoTooltip: "Épingler l'onglet « Tout » à l'extrême gauche",
   Pizza: "Pizza",
   Pizzeria: "Pizzeria",
   PlatformAndroid: "Android",
   PlatformiOS: "iOS",
   PlatformSteam: "Steam",
   PlayerFlag: "Drapeau du joueur",
   PlayerMapMenuShort: "Commerce",
   PlayerMapMenuV2: "Carte commerciale",
   PlayerTradeFlagFilter: "Drapeau du joueur",
   PlayerTradeMenu: "Échange de joueurs",
   PlayerTradeTabAvailableTrades: "Négociable",
   PlusXLevelToXBuilding: "+%{value} Level to %{building}",
   PolytheismLevelX: "Polytheism %{level}",
   PortOfSingapore: "Port of Singapore",
   PortOfSingaporeDesc: "Cette merveille peut être améliorée et chaque niveau offre +1 en production (affecte la capacité de transport des ressources) et un multiplicateur de stockage pour le marché, l'entrepôt et le caravansérail.",
   Produced: "Produit",
   ProducedWorkers: "Travailleurs produits",
   Province: "Province",
   ...
   QuickUiModeTooltip: "Lorsque vous sélectionnez ou désélectionnez une ressource, le montant par cycle et le montant maximal seront automatiquement redistribués entre les ressources sélectionnées.",
   QutbMinar: "Qutb Minar",
   RabindranathTagore: "Rabindranath Tagore",
   Radio: "Radio",
   RashtrapatiBhavan: "Rashtrapati Bhavan",
   RecoverFromServer: "Récupérer depuis le serveur (réinitialisera l'exécution en cours)",
   RegenerateGreatPersonPortraits: "Régénérer les portraits des personnages illustre",
   RegenerateGreatPersonPortraitsDesc: "Pour des raisons de performances, les portraits des personnages illustre sont mis en cache. Si les portraits mis en cache sont obsolètes (par exemple, lorsque vous passez d'une langue à l'autre), vous pouvez forcer leur régénération.",
   ...
   Resource: "Resource",
   ResourcePanelSections: "Sections du panneau Ressources",
   ...
   SaturnaliaV2: "Saturnalia : Alps confère un bonus de +1 au niveau de construction pour chaque tranche de 10 niveaux d'un bâtiment.",
   Science: "Science",
   SendACartographer: "Send a Cartographer",
   SendCartographerDescHTML: "Un cartographe explorera <b>toutes les tuiles</b> de la carte. Envoyer un cartographe coûte <b>%{science} Science</b> et est débloqué par la technologie <b>Exploration</b> (Renaissance).",
   SendCartographerTechDesc: "Cartographe : envoyer un cartographe sur une tuile inexplorée révélera toutes les tuiles de la carte.",
   ServerBackup: "Sauvegarde du serveur",
   ServerBackupDescHTML: "Vous pouvez sauvegarder votre <b>personnages illustre pour toujours</b> et <b>age wisdom</b> sur le serveur. Cela se fait automatiquement lorsque vous recommencez une partie. Les sauvegardes sur le serveur peuvent être utiles lorsque votre fichier de sauvegarde est corrompu et que vous ne disposez pas de sauvegardes locales.",
   ShortcutUpgradePageCancelAllUpgrades: "Annuler toutes les mises à niveau",
   ...
   Sputnik1: "Sputnik 1",
   Sputnik1DescV3:
      "Cette merveille peut être améliorée et chaque niveau confère +1 niveau à tous les personnages illustre de l'ère de la guerre froide pour cette partie (à l'exception des personnages illustre qui confèrent un bonus de niveau) et +1 à la production et au multiplicateur de stockage du cosmodrome. Confère +1 à la production et au multiplicateur de stockage du cosmodrome pour chaque niveau de sagesse de l'ère de la guerre froide.",
   ...
   SydneyHarbourBridgeDesc: "Cette merveille peut être améliorée et chaque niveau offre un multiplicateur de production +1 à toutes les centrales électriques.",
   SydneyOperaHouseDesc: "Cette merveille peut être améliorée et chaque niveau augmente la taille de la carte de la prochaine renaissance de 1.",
   TajMahal: "Taj Mahal",
   Tank: "Tank",
   ...
   TerryFox: "Terry Fox",
   ThankYouForSupporting: "Merci de soutenir le développement de CivIdle et de contribuer au fonctionnement du serveur.",
   ThemeBuildingStatusIconAlpha: "Icône d'état du bâtiment Alpha",
   ThemeBuildingStatusIconFollowBuildingColor: "Icônes d'état du bâtiment Suivre la couleur du bâtiment",
   ThemeBuildingStatusIconFollowBuildingColorDescHTML: "Les icônes d'état du bâtiment (en haut à gauche du bâtiment) reprendront la couleur du bâtiment.",
   ThemeSpinnerAlpha: "Spinner Alpha",
   ThomasEdison: "Thomas Edison",
   ThomasGresham: "Thomas Gresham",
   TimBernersLee: "Tim Berners-Lee",
   TodoTabs: "Todo Tabs",
   ToggleWatchForThisResourceWatchedResourcesAreDisplayedInADedicatedTopLeftTab: "Activer/désactiver la surveillance de cette ressource : les ressources surveillées sont affichées dans un onglet dédié en haut à gauche.",
   TopkapiPalace: "Topkapı Palace",
   TotalOfflineTime: "Temps total hors ligne",
   TowerBridge: "Tower Bridge",
   TradeMapStatistics: "Statistiques de la carte commerciale",
   TradeSCanBeClaimed: "Les échanges peuvent être réclamés",
   TradesCanBeClaimedHTML: "Vous avez %{count} échanges pouvant être réclamés - assurez-vous d'avoir suffisamment d'espace de stockage pour les réclamer. Cliquez pour voir les détails",
   TraditionExpansion: "Expansion",
   Train: "Train",
   TutorialBuildX: "Construire %{building}",
   TutorialBuildXBuildings: "Construire %{count} %{building}",
   TV: "TV",
   Uluru: "Uluru",
   UluruDesc: "Tous les bâtiments qui ne produisent pas de travailleurs dans un rayon de 2 cases obtiennent un multiplicateur de production de +0,5*X.. X = nombre de personnage illustre issues de cette série",
   UndoAll: "Tout annuler",
   UndoUpgradesForAllPermanentGreatPeopleThatAreEligibleForAgeWisdom: "Annuler les améliorations pour tous les grands personnages permanents éligibles à la sagesse de l'âge.",
   UniqueEffects: "Unique Effects",
   UniquePermanentGreatPeople: "Unique, permanent, personnage illustre.",
   UNVoteDescriptionHTML: "Les bâtiments votés à l'Assemblée générale des Nations unies obtiennent <b>+5 Multiplicateur de production</b>",
   UpgradeAll: "Tout mettre à niveau",
   UpgradeAllPermanentGreatPeopleThatAreEligibleForAgeWisdom: "Améliorez tous les grands personnages permanents qui sont éligibles à la sagesse de l'âge.",
   UpgradeAllPermanentGreatPeopleThatAreUpgradeable: "Améliorez tous les personnages permanents qui peuvent être améliorés.",
   UpgradeWisdomEligible: "Mise à niveau Wisdom éligible",
   Uranium: "Uranium",
   UseMirrorServer: "Utiliser le serveur miroir",
   UseMirrorServerDescHTML: "Utilisez un serveur miroir pour vous connecter au jeu. Cela peut être utile si vous rencontrez des difficultés pour vous connecter au serveur principal. <b>Nécessite de redémarrer le jeu pour que les modifications prennent effet.</b>",
   VeraRubin: "Vera Rubin",
   Voltaire: "Voltaire",
   WallStreet: "Wall Street",
   WaltDisney: "Walt Disney",
   WatchedResources: "Ressources visionnées",
   WernherVonBraun: "Wernher von Braun",
   Westminster: "Westminster",
   WilliamShakespeare: "William Shakespeare",
   WilliamShepherd: "William Shepherd",
   WinterCarnival: "Carnaval d'hiver : doublez la portée des aurores boréales. Doublez le bonus de niveau de bâtiment du Château Frontenac et de l'Habitat 67.",
   WishlistSpaceshipIdle: "Wishlist Spaceship Idle",
   WonderFullHTML: "Wonder<b>full</b>!",
   WorkersRequiredOutput: "Production",
   WorldTradeOrganization: "Organisation mondiale du commerce",
   WorldTradeOrganizationDesc: "Cette merveille peut être améliorée et chaque niveau offre un multiplicateur de production +1 aux bâtiments bonus de la tuile Commerce. Participez chaque semaine au vote de l'OMC qui augmente les chances que les bâtiments votés apparaissent dans le bonus de la tuile Commerce de la semaine suivante.",
   WTOVoteCurrent: "Vote actuel à l'OMC #%{id}",
   WTOVoteDescriptionHTML: "Les bâtiments votés à l'Organisation mondiale du commerce ont une <b>probabilité plus élevée</b> apparaître dans le bonus de tuile commerciale",
   WTOVoteNext: "Prochain vote à l'OMC #%{id}",
   XBaseStorageForWarehouseAndCaravansary: "+%{percent} Stockage de base pour marché, entrepôt et caravansérail",
   XBuildingsWillBeBuilt: "%{count} bâtiment(s) sera construit",
   XResourceHasBeenDestroyed: "<b>%{amount} %{resource}</b> a été détruit",
   Xuanzang: "Xuanzang",
