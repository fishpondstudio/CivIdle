export const FR = {
   ...
   BastilleDay: "Bastille Day: Doublez l'effet du Centre Pompidou et de l'Arc de Triomphe. Doublement de la génération culturelle du Mont Saint-Michel",
   ...
   PlayerMapOccupyTileCondition2: "Vous n'avez pas atteint le nombre maximum de tuiles occupées pour votre rang",
