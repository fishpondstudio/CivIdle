export const FR = {
   ...
   HelpMenu: "Aide",
   Census: "Rescensement",
   OptionsUseModernUI: "Interface adaptée pour les yeux sensibles",
   About: "À propos de CivIdle",
   ResearchMenu: "Rechercher",
   CityViewMap: "Ville",
   ...
   GoldMiningCamp: "Campminier d'or",
   ...
   StatisticsTransportationBuilding: "Bâtiment",
   ...
   ThemeInactiveBuildingAlpha: "Épaisseur des bâtimes inactifs",
   ...
   TranslationPercentage: "Le %{language} est traduit à %{percentage}. Aidez-nous à amélioration cette traduction sur GitHub",
