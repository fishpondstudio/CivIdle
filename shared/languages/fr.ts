export const FR = {
   ...
   ExploreThisTileHTML: "Un explorateur peut découvrir <b>cette case et celles adjacentes</b>. Les explorateurs peuvent être recrutés dans un(e) %{name}. Il vous reste encore %{count} explorateur(s).",
