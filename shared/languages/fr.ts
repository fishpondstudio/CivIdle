export const FR = {
   ...
   FestivalTech: "Débloquer le festival - le bonheur positif (max. 50) est converti en points de festival. Pour chaque 25 points de festival, votre empire entre dans un cycle de festival, accordant un boost important spécifique à la carte.",
   Feudalism: "Féodalité",
   Fibonacci: "Fibonacci",
   ...
   FirstTimeTutorialWelcome3HTML: "Maintenant que vous connaissez les bases du jeu, vous pouvez commencer à construire votre empire. Mais avant de vous laisser partir, vous devriez <b>choisir un pseudo</b> et dire bonjour dans le chat du jeu. Nous avons une communauté incroyablement utile : si vous vous perdez, n'ayez pas peur de demander !",
   Fish: "Poisson",
   FishPond: "Vivier",
   ...
   GreatPersonLevelRequiredDesc: "La renaissance dans %{city} nécessite %{required} niveaux de personnages illustres permanents. Vous avez actuellement %{current}.",
   GreatPersonOnlyIn: " Ce personnage illustre ne naît que dans %{city}",
   ...
   GreedyTransportDescHTML: "Cela permettra aux bâtiments de continuer à transporter des ressources même s'ils ont suffisamment de ressources pour l'amélioration en cours, ce qui peut rendre l'amélioration de plusieurs niveaux <b>plus rapide</b>, mais entraînera le transport de <b>plus de ressources que nécessaire</b>. ",
   ...
   ManhattanProjectDesc: "Toutes les mines d'uranium reçoivent +2 en Production, Capacité de Travailleurs et Multiplicateur de Stockage. Les usines d'enrichissement de l'uranium et les installations atomiques reçoivent +1 en Multiplicateur de Production pour chaque mine d'uranium adjacente construite sur un dépôt d'uranium. ",
   Marble: "Marbre",
   ...
   MatrioshkaBrainDescV2: "Autoriser la science à être comptabilisée lors du calcul de la valeur de l'empire (5 Science = 1 Valeur de l'Empire). +5 Science par travailleur occupé et inactif. Cette merveille peut être améliorée, et chaque amélioration supplémentaire offre +1 Science par travailleur occupé et inactif ainsi que +1 Multiplicateur de Production pour les bâtiments produisant de la Science.",
   ...
   ProductionPriorityDescV2: "Une priorité plus élevée signifie que ce bâtiment transporte avant les autres bâtiments. Un numéro plus élevé signifie une priorité plus élevée.",
   ...
   ZigguratOfUrDescV2: "Chaque 10 bonheur (plafonné) procure +1 Multiplicateur de Production à tous les bâtiments qui ne produisent pas de travailleurs et qui sont débloqués dans les ères précédentes (max = nombre d'ères débloquées / 2). Les merveilles (y compris naturelles) ne fournissent plus de +1 Bonheur. L'effet peut être désactivé.",
   Zoroaster: "Zoroastre",
   ...
   CologneCathedralDesc: "Lors de sa construction, génère une science unique équivalente au coût de la technologie la plus chère de l'ère actuelle. Tous les bâtiments produisant de la science (à l'exception du Laboratoire de Clonage) reçoivent +1 en Multiplicateur de Production. Cette merveille peut être améliorée, et chaque amélioration supplémentaire offre +1 en Multiplicateur de Production à tous les bâtiments produisant de la science (à l'exception du Laboratoire de Clonage).",
