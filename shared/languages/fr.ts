export const FR = {
   ...
   ProductionPriorityDescV3:
      " La priorité détermine l'ordre dans lequel les bâtiments transportent et produisent - un nombre plus élevé signifie qu'un bâtiment transporte et produit avant les autres bâtiments. Cependant, une priorité plus élevée ne garantit pas que le bâtiment transportera la ressource en premier. Par exemple, étant donné l'ordre de priorité suivant : Centrale à charbon > Mine de charbon > Aciérie, l'aciérie recevra tout le charbon produit dans le même cycle, car elle transporte et produit immédiatement après la mine de charbon",
