export const FR = {
   ...
   Mosque: "Mosquée",
   School: "École",
   WorkersAvailable: "Ouvriers disponbiles",
   ...
   Colosseum: "Colisée",
   ColosseumDesc:
      "Le fonctionnement des fabriques de chariots vous coûtent 1 Bonheur de moins que d'habitude. Consomme 10 chariots et produit 10 bonheur",
   SummerPalace: "Palais d'Été",
   SummerPalaceDesc:
      "Le fonctionnement de tous les bâtiments adjacents qui consomment ou produisent de la poudre à canon vous coûtent 1 bonheur de moins que d'habitude. Tous les bâtiments qui consomment ou produisent de la poudre à canon obtiennent +1 Production, Stockage et Capacité des Ouvriers",
   ...
   ProductionPriorityDesc:
      "Plus la priorité d'un bâtiment est élévée, plus le transport des matériaux passera avant celui des autres",
   ...
   StatisticsTransportationPercentage: "Pourcentage d'ouvriers occupés avec le transport",
   ...
   UnclaimedGreatPerson: "Vous avez des personnages illustres non collectées, cliquez ici pour les récupérer",
   ...
   AccountLevelUpgradeConditionAny:
      "Pour passer au rang supérieur, vous devez remplir une des conditions suivantes :",
