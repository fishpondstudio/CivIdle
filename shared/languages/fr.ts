export const FR = {
   ...
   Diwali: "Diwali: Augmentez la portée du fleuve Gange à 3 cases. Augmentez la portée du stupa de Sanchi à 3 cases. Doublez le bonus de niveau du Fort Rouge.",
   ...
   GangesRiverDesc: "Chaque type de bâtiment situé dans un rayon de 2 cases bénéficie d'un multiplicateur de production +N, où N = niveau de sagesse de l'âge auquel le bâtiment est débloqué.",
   Garment: "Vêtement",
   ...
   QutbMinarDesc:
      "Une fois achevée, un personnage illustre voit le jour. Elle peut provenir de n'importe quelle époque, à l'exception de l'époque actuelle. Cette merveille peut être améliorée, et chaque amélioration supplémentaire entraîne la naissance d'un personnage illustre, qui peut provenir de n'importe quelle époque, à l'exception de l'époque actuelle. Lorsque vous choisissez des personnalités éminentes issues de cette merveille, 4 choix vous sont proposés.",
   ...
   SwissBankDescV3: "Convertit une ressource choisie parmi toutes les ressources échangeables par les joueurs en Koti (10 millions en sanskrit). Chaque niveau de la Banque suisse ajoute 1 conversion Koti par cycle, qui est affectée par le multiplicateur de production. La Banque suisse peut stocker une quantité illimitée de Koti.",
   Sword: "Épée",
   ...
   TutorialBuildHutsHTML: "Pour construire une hutte, cliquez sur une <b>empty tile</b>, et cliquez <b>Build</b> à côté de <b>Hut</b>. Une fois la construction terminée, elle révélera le brouillard adjacent. Les cabanes fournissent les ouvriers nécessaires au bon fonctionnement des bâtiments et génèrent également de la science..",
   ...
   TutorialBuildLumberMillsHTML: "Les scieries consomment du bois et produisent du bois d'œuvre, un matériau de construction important. Assurez-vous d'avoir suffisamment de camps forestiers pour les approvisionner. Vous pouvez utiliser le bureau des statistiques pour équilibrer votre production et votre consommation..",
   ...
   TutorialClaimTradeTileHTML: "Avant de pouvoir échanger avec d'autres joueurs, vous devez revendiquer votre tuile d'échange. Lorsque vous échangez avec un autre joueur, une route commerciale sera établie entre votre tuile et celle de l'autre joueur. Si cette route passe par les tuiles d'autres joueurs, vous devrez leur payer des droits de douane..",
