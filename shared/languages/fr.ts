export const FR = {
   ...
   AdaptiveGreatPersonDesc: "+%{value} Multiplicateur de production et de stockage pour la selection %{age} building",
   AdaptiveGreatPersonTooltip: "Une fois sélectionné, il ne peut plus être modifié pour la run en cours.",
   ...
   TutorialEnterClassicalAge: "Entrer dans l'ére antiquité",
   TutorialEnterClassicalAgeHTML: "Votre empire entrera dans l'ére antiquité après avoir recherché n'importe quelle technologie de l'ére antiquité. Vous pouvez choisir un personnage illustre de l'ére antiquité, de l'âge du fer ou de l'âge du bronze..",
