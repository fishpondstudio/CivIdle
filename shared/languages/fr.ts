export const FR = {
   ...
   KeeperOfOurServerThankYou: "CivIdle est maintenu grâce à la générosité des gardiens de notre serveur suivants.",
   ...
   WorldTradeOrganizationDesc:
      "Cette merveille peut être améliorée et chaque niveau offre un multiplicateur de production +1 aux bâtiments bonus de la tuile Commerce. Participez chaque semaine au vote de l'OMC qui augmente les chances que les bâtiments votés apparaissent dans le bonus de la tuile Commerce de la semaine suivante.",
