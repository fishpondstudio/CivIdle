export const PT_BR = {
  ...
  AccountPlayTimeRequirement: "Tempo de Jogo Necessário",
   ...
   AccountRankUpDesc: "Todo o seu progresso será transferido para o seu novo rank.",
   AccountRankUpTip: "Parabéns, sua conta é elegível para um rank mais alto – clique aqui para atualizar!",
