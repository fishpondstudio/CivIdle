export const PT_BR = {
   ...
   GoldenPavilionDesc: "Todos os edifícios dentro do alcance de 3 blocos ganham +1 Multiplicador de Produção para cada edifício adjacente que produz qualquer um dos seus recursos consumidos (excluindo Clone Lab e Clone Factory e o edifício não pode ser desligado).",
   ...
   Pantheon: "Panteão",
   PantheonDescV2: "Todos os edifícios dentro de 2 blocos ganham +1 Multiplicador de Capacidade de Trabalhador e Armazenamento. Gere ciência com base na produção de fé de todos os santuários.",
   Paper: "Papel",
   PaperMaker: "Fábrica de Papel",
   Parliament: "Parlamento",
   Parthenon: "Partenon",
   ParthenonDescV2: "Duas grandes pessoas da Era Clássica nascem e você tem 4 escolhas para cada uma. Associação de Músicos e Associação de Pintores ganham +1 Multiplicador de Produção, Capacidade de Trabalho e Armazenamento e estão isentas de -1 Felicidade.",
   ...
   TotalWorkers: "Total Trabalhadores",
