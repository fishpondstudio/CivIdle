export const PT_BR = {
   ...
   GreatWallDesc: "Todas as construções dentro de 1 espaço ganham +N Produção, Capacidade de Trabalhadores e Multiplicador de Armazenamento. N = número das diferentes eras entre a era atual e a era em que a construção foi desbloqueada pela primeira vez. Quando construída ao lado da Cidade Proibida, o alcance aumenta para 2 espaços",
   ...
   HagiaSophiaDesc: "Construções com 0% de Capacidade de Produção são isentas da penalidade de -1 de felicidade. Consome 10 de Fé e produz 10 de felicidade",
