export const PT_BR = {
   ...
   TechResourceTransportPreferenceStorage: "Armazenar",
   ...
   TheMet: "The Met",
   TheMetDesc: "Após construído, gera teletransportes que podem ser usados ​​para mover edifícios. Todos os edifícios dentro do alcance de 2 blocos recebem +1 de Produção, Capacidade de Trabalhadores e Multiplicador de Armazenamento",
   ...
   TribuneUpgradeDescV3:
      "Você pode jogar o jogo completo como Tribuno se não planeja participar dos recursos online <b>opcionais</b>. Para adquirir acesso irrestrito aos recursos online, você precisará atualizar para Quaestor. <b>Esta é uma medida anti-bot para manter o jogo gratuito para todos.</b> No entanto, <b>ao atualizar para Quaestor</b> você pode transferir grandes pessoas: <ul><li>Até o nível <b>3</b> para Bronze, Ferro e Idade Clássica</li><li>Até o nível <b>2</b> para Idade Média, Renascença e Era Industrial</li><li>Até o nível <b>1</b> para Guerras Mundiais, Guerra Fria e Era da Informação</li></ul>O progresso parcial acima do nível não pode ser transferido.",
   ...
   UseMirrorServerDescHTML: "Se você tiver problemas para acessar o servidor principal, você pode se conectar ao servidor espelho. <b>É necessário reiniciar o jogo para que ele tenha efeito</b>",
   ...
   YangtzeRiverDesc: "Todos os edifícios que consomem água recebem +1 de Produção, Capacidade de Trabalhadores e Multiplicador de Armazenamento. Dobra o efeito de Zheng He (Figura Histórica). Cada nível de Imperatriz Permanente Wu Zetian (Figura Histórica) fornece +1 de Multiplicador de Armazenamento para todos os edifícios.",
   ...
   ZigguratOfUrDescV2: "Cada 10 de felicidade (limitado) fornece +1 Multiplicador de Produção para todos os edifícios que não produzem trabalhadores e são desbloqueados em eras anteriores (máx. = número de eras desbloqueadas / 2). Maravilhas (incl. Naturais) não fornecem mais +1 de Felicidade. O efeito pode ser desativado.",
   Zoroaster: "Zoroaster",
};
