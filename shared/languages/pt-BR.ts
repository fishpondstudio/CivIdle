export const PT_BR = {
   ...
   FestivalTech: "Desbloqueie o festival - Felicidade positiva (máx. 50) é convertida em pontos de festival. Para cada 25 pontos de festival, seu império entra em um ciclo de festival, concedendo um aumento significativo específico do mapa.",
   ...
   RebornModalDescV3: "Você começará um novo império, mas todas as suas figuras históricas <b>desta corrida</b> se tornarão fragmentos permanentes, que podem ser usados ​​para atualizar seu <b>nível de figuras históricas permanentes</b>. Você também obterá fragmentos extras de figuras históricas com base no seu <b>valor total do império</b>.",
