export const PT_BR = {
   ...
   KeeperOfOurServerThankYou: "O CivIdle se mantém à tona graças à generosidade dos seguintes guardiões do nosso servidor",
   ...
   TutorialHappinessHTML:
      "Construir novos edifícios consome happiness e, quando sua happiness fica abaixo de 0, seus workers disponíveis diminuem. -50 de happiness fará com que seu império pare completamente, então não expanda demais. Você pode ver o detalhamento da happiness clicando no ícone de felicidade no painel superior.",
   ...
   TutorialRebirthHTML:
      "Quando o progresso parecer lento, você deve considerar rebirth. Ao realizar rebirth, as great people desta rodada se tornam permanent great people shards, que podem ser usadas para fazer upgrade de permanent great people. Você pode escolher uma civilização diferente — cada civilização possui conteúdo único.",
   ...
   UnitedNationsDescV2:
      "Todos os edifícios de Tier IV, V e VI recebem +1 de Produção, Capacidade de Trabalhadores e Multiplicador de Armazenamento. Participe da Assembleia Geral da ONU e vote em um bônus adicional a cada semana. Esta maravilha pode ser aprimorada e cada nível fornece +1 aos multiplicadores da Assembleia Geral",
