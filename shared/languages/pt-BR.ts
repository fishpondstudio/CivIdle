export const PT_BR = {
   ...
   CathedralOfBrasiliaDesc: "Se cada edifício em funcionamento dentro de um alcance de 2 casas formar uma cadeia de produção, ou seja, o recurso produzido por um edifício for consumido por outro, então cada tipo de edifício nessa cadeia de produção recebe +X Multiplicador de Produção. X = comprimento dessa cadeia de produção.",
   ...
   LiberalismLevel5DescHTMLV2: "Todos os edifícios recebem <b>+5 de Aumento no Nível do Edifício</b> com a eletrificação",
   ...
   ReadPatchNotesHTML: "Você atualizou para a versão <b>%{version}</b> (<b>%{build}</b>), leia as notas de correção na <b>Steam</b>",
   Rebar: "Vergalhão",
   ...
   SwissBankDescV2: "Converta um recurso escolhido de armazéns adjacentes para Crore (10 milhões em sânscrito) - um recurso negociável que vale 10 milhões. Cada nível do Banco Suíço adiciona 1 conversão de Crore por ciclo, que é afetada pelo Multiplicador de Produção. O Banco Suíço pode armazenar uma quantidade ilimitada de Crore.",
   Sword: "Espada",
