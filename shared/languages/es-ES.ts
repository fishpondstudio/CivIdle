export const ES_ES = {
   ...
   WorkerScienceProduction: "Producción de ciencia",
   ScienceFromIdleWorkers: "Producción de ciencia de trabajadores en paro",
   ...
   RamessesIIDesc: "+%{value} multiplicador de capacida de construcción",
   Agamemnon: "Agamenón",
   ...
   HangingGardenDesc:
      "+1 multiplicador de capacidad de construcción. Los acueductos adyacentes obtienen +1 de producción, almacenamiento y multiplicador de capacidad de trabajo",
   Colosseum: "Coliseo",
   ColosseumDesc:
   ...
   StatueOfZeusDesc:
      "Genera depósitos aleatorios de entre los que han sido revelados en casillas adyacentes vacías. Todas las construcciones de rango I obtienen +5 de producción y multiplicador de almacenamiento",
   Poseidon: "Poseidón",
   ...
   StPetersBasilicaDesc:
      "Todas las construcciones que producen fé obtienen +1 multiplicador de almacenamiento. Generan fé basado en la fé almacenada.",
   ForbiddenCity: "La Ciudad Prohibida",
   ForbiddenCityDesc:
      "Todas las papeleras, gremios de escritores, e imprentas obtienen +1 multiplicador de producción, multiplicador de capacidad de trabajo y multiplicador de almacenamiento",
   Borobudur: "Borobudur",
   ...
   TajMahal: "Taj Mahal",
   TajMahalDesc:
      "Una nueva personaje histórico de la Edad Media ha nacido. +5 multiplicadores de capacida de construcción cuando se mejoran construcciones por encima del nivel 20",
   StatueOfLiberty: "Estatua de la Libertad",
   StatueOfLibertyDesc:
      "Todas las construcciones adyacentes obtienen +N de producción, almacenamiento y multiplicador de capacidad de trabajo. N = Número de construcciones adyacentes del mismo tipo",
   Moai: "Moai",
   MoaiDesc: "Moai",
   ...
   SaintBasilsCathedralDescV2:
      "Permite que las construcciones de extracción de recursos funcionen en casillas adyacentes a un depósito. Todas las construcciones adyacentes de rango I obtienen +1 multiplicador de producción, multiplicador de capacidad de trabajo, y multiplicador de almacenamiento",
   ChichenItza: "Chichén Itzá",
   ChichenItzaDesc:
      "Todas las construcciones adyacentes obtienen +1 multiplicador de producción, almacenamiento y multiplicador de capacidad de trabajo",
   Aqueduct: "Acueducto",
   FishPond: "Fish Pond",
   ...
   PersepolisDesc:
      "Todas las minas de cobre, campamentos madederos y canteras de piedra obtienen +1 multiplicador de producción, multiplicador de capacidad de trabajo y multiplicador de almacenamiento",
   ...
   NeuschwansteinDesc: "+10 multiplicador de capacidad de construcción al construir maravillas",
   ...
   BrandenburgGateDesc:
      "Todas las minas de carbón y pozos de petróleo obtienen +1 de producción, almacenamiento y multiplicador de capacidad de trabajo. Las refinerias de petróleo obtienen +1 de producción, almacenamiento and multiplicador de capacidad de trabajo por cada casilla de petróleo adyacente",
   ...
   PlayerTradeFillSuccess: "El comercio ha sido enviado con éxito",
   ...
   ResourceImportImportPerCycle: "Importado",
   ResourceImportImportCap: "Límite",
   ...
   WarehouseSettings: "Ajustes del almacén",
   WarehouseSettingsAutopilot: "Piloto automático",
   ...
   TechResourceTransportPreferenceOverrideTooltip: "Este recurso tiene la preferencia sobreescrita: %{mode}",
