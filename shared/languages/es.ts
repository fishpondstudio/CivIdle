export const ES = {
   ...
   Wonder: "Maravilla",
   PauseConstructionPause: "Pausa",
   ResumeConstructionResume: "Continuar",
   Upgrade: "Mejora",
   ...
   GreatPeopleWiki: "Wiki de los personajes históricos",
   GoBack: "Volver atrás",
   CivIdle: "CivIdle",
   ...
   StatisticsTransportationBuilding: "Construcción",
   StatisticsTransportationResource: "Recurso",
   StatisticsTransportationAmount: "Cnt",
   ...
   ShortcutBuildingPageUpgradeX5: "Mejorar x5",
   ...
   PetraNoMultiplier:
      "Ningún multiplicador afecta a Petra (producción, capacidad de trabajo, almacenamiento, etc)",
   ...
   ElectrificationDesc:
      "Usa %{power}W de energía y provee +%{level} mutiplicadores de consumo y producción",
