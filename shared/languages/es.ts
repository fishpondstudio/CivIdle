export const ES = {
   ...
   YangtzeRiverDesc: "Todos los edificios que consumen agua obtienen +1 Multiplicador de Producción, Capacidad de Trabajadores y Almacenamiento. Duplica el efecto de Zheng He (Personaje Histórico). Cada nivel permanente de la Emperatriz Wu Zetian (Personaje Histórico) proporciona +1 Multiplicador de Almacenamiento a todos los edificios",
   ...
   ZigguratOfUrDescV2: "Cada 10 puntos de felicidad (limitado) otorga +1 Multiplicador de Producción a todos los edificios que no produzcan trabajadores y que se hayan desbloqueado en eras anteriores (máximo = número de eras desbloqueadas / 2). Las maravillas (incluidas las naturales) ya no otorgan +1 de felicidad. El efecto se puede desactivar",
