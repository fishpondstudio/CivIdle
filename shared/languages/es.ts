export const ES = {
   ...
   AdvisorElectricityContent:"Las plantas de energía le brindan dos nuevos sistemas. El primero, 'Energía', está indicado por los mosaicos de rayos adyacentes a la planta de energía. Algunos edificios (comenzando con Radio en las Guerras Mundiales) tienen un indicador de 'requiere energía' en su lista de entradas. <b>Esto significa que deben construirse sobre una loseta de rayo para funcionar</b>. Los edificios que requieren energía y la tienen, también transmitirán energía a las losas adyacentes a ese edificio, por lo que pueden alimentarse entre sí siempre que al menos una esté tocando una planta de energía.<br><br>El otro sistema de electrificación se puede aplicar a <b>cualquier edificio</b> en cualquier lugar del mapa, siempre y cuando no produzca ciencia ni trabajadores. Esto utiliza la energía generada por la central eléctrica para aumentar tanto el consumo como la producción del edificio. Más niveles de electrificación requieren cantidades cada vez mayores de energía. Electrificar edificios que también 'requieren energía' es más eficiente que electrificar los que no la tienen.",
   AdvisorElectricityTitle: "Energía y electrificación",
   AdvisorGreatPeopleContent: "Cada vez que entres en una nueva era de tecnología, podrás seleccionar a un Personaje Histórico de esa era, así como de cada era anterior. Estos Personajes Históricos otorgan bonificaciones globales que pueden aumentar la producción, la ciencia, la felicidad y muchas otras cosas.<br><br>Estas bonificaciones son permanentes durante el resto del renacimiento.<br><br>Cuando renaces, todas tus Personajes Históricos se vuelven permanentes, y su bonificación dura para siempre.Seleccionar al mismo Personaje Histórico en una partida posterior acumulará tus bonificaciones permanentes y las obtenidas en la partida, y cuando renaces con duplicados, los adicionales se almacenan y pueden usarse para mejorar la bonificación permanente. Eso se gestiona en el menú <b>Gestionar Personajes Históricos permanentes</b> en tu Edificio Principal.",   
   AdvisorGreatPeopleTitle: "Gran personaje",
   AdvisorHappinessContent: "La felicidad es la mecánica central en CivIdle que limita la expansión. Obtienes felicidad al desbloquear nueva tecnología, avanzar a nuevas eras, construir maravillas, con Personajes Históricos que la proporcionan, y de algunas otras maneras que podrás descubrir mientras aprendes. <b>Cada nuevo edificio cuesta 1 de felicidad</b>. Por cada punto por encima/debajo de 0 de felicidad, obtienes un bono o penalización del 2% a tu total de trabajadores (con un límite de -50 y +50 de felicidad). Puedes ver un desglose detallado de tu felicidad en la <b>sección de Felicidad del Edificio Principal</b>.",   
   AdvisorHappinessTitle: "Manten tu población contenta",
   AdvisorOkay: "¡Entendido, gracias!",
   AdvisorScienceContent:"Tus trabajadores ocupados generan ciencia, lo que te permite desbloquear nuevas tecnologías y avanzar tu civilización. Puedes acceder al menú de investigación de varias formas: haciendo clic en el medidor de ciencia, accediendo a tus tecnologías desbloqueables en tu Edificio Principal, o usando el menú 'Ver'. Todas estas opciones te llevarán al árbol de tecnología, donde podrás ver todas las tecnologías, así como la cantidad de ciencia requerida para cada una. Si tienes suficiente ciencia para aprender una nueva tecnología, simplemente haz clic en ella y presiona 'desbloquear' en el menú lateral. <b>Cada nuevo nivel y era de tecnología requiere cada vez más ciencia, pero también desbloquearás nuevas y mejores formas de obtener ciencia.</b>",   
   AdvisorScienceTitle: "Descubrimiento científico!",
   AdvisorSkipAllTutorials: "Saltar todos los tutoriales",
   AdvisorStorageContent: "Aunque los edificios tienen una cantidad decente de almacenamiento, pueden llenarse, especialmente si se dejan inactivos durante mucho tiempo. <b>Cuando los edificios están llenos, ya no pueden producir</b>. Esto no siempre es un problema, ya que claramente tienes una gran reserva si el edificio está lleno. Pero generalmente es mejor mantener las cosas produciendo.Una forma de solucionar el almacenamiento completo es mediante un almacén. Cuando construyes un almacén, obtienes un menú de cada producto que has descubierto y puedes configurar el almacén para extraer cualquier producto en cualquier cantidad, siempre que el total para todos los productos esté dentro de lo que el almacén puede manejar según su nivel y multiplicador de almacenamiento.Una manera sencilla de configurar un almacén es marcar cada producto que desees importar en el almacén y usar los botones de 'redistribuir entre seleccionados' para dividir equitativamente tu tasa de importación y almacenamiento. Si deseas que los edificios también puedan extraer del almacén, asegúrate de activar la opción de 'exportar por debajo de la cantidad máxima'.",   
   ...
   Aeschylus: "Esquilo",
   Agamemnon: "Agamenón",
   AgeWisdomDescHTML: "Cada nivel de Sabiduría de la Edad proporciona <b>un nivel equivalente</b> de Personajes Históricos Permanentes elegibles de esa era; se puede mejorar con fragmentos de Personajes Históricos Permanentes elegibles.",
   AgeWisdomGreatPeopleShardsNeeded: "Necesitas %{amount} más fragmentos de personajes históricos para la próxima mejora de la Sabiduría de la Edad.",
   AgeWisdomGreatPeopleShardsSatisfied: "Tienes suficientes fragmentos de personajes históricos para la próxima mejora de la Sabiduría de la Edad.",
   AgeWisdomNeedMoreGreatPeopleShards: "Necesitas más fragmentos de personajes históricos",
   AgeWisdomNotEligible: "Este personaje históricos no es elegible para la Sabiduría de la Edad.",
   AgeWisdomSource: "%{age} Sabiduría: %{person}",
   AgeWisdomUpgradeWarningHTML: "Tu rango actual de cuenta es Tribuno. Al ascender a Cuestor, la Sabiduría de la Edad <b>no se puede transferir</b>",
   ...
   AlanTuringDesc: "+%{value} Ciencia de trabajadores ociosos",
   ...
   Broadway: "Broadway",
   BroadwayDesc: "Nace un gran personaje de la época actual y un gran personaje de la época anterior. Selecciona un gran personaje y duplica su efecto.",
   ...
   CarlFriedrichGaussDesc: "+%{idle} Ciencia de Trabajadores Ociosos. +%{busy} Ciencia de Trabajadores Ocupados",
   ...
   Cultivation4UpgradeHTML: "Un gran personaje de la <b>Edad del Renacimiento</b> ha nacido",
   ...
   Embassy: "Embajada",
   EmperorWuOfHan: "Emperador Wu of Han",
   ...
   ManhattanProjectDesc: "Todas las minas de uranio obtienen +2 al multiplicador de producción, capacidad de trabajo y almacenamiento. Las plantas de enriquecimiento de uranio y las instalaciones atómicas obtienen +1 al multiplicador de producción por cada mina de uranio adyacente que se construya sobre un depósito de uranio.",
   Marble: "Mármol",
