export const ES = {
   ...
   LargeHadronColliderDescV2: "Todos los personajes históricos de la era de la informacion obtienen +2 niveles durante esta partida. Esta maravilla puede ser mejorada, y cada mejora adicional proporciona +1 nivel a todos los personajes históricos de la era de la información durante esta partida",
   Law: "Ley",
   Lens: "Lentes",
   ...
   Petra: "Petra",
   PetraDesc: "Genera impulsos temporales cuando estás desconectado, que puedes usar para acelerar tu imperio",
   ...
   SwissBankDescV2: "Convierte el recurso elegido de los almacenes adyacentes a Koti (10 millones en sánscrito) - un recurso comercializable con un valor de 10M. Cada nivel del Swiss Bank añade 1 conversión a Koti por ciclo, que es afectada por el multiplicador de producción. El Swiss Bank puede almacenar una cantidad ilimitada de Koti",
   Sword: "Espada",
   ...
   TurnOnTimeWarpDesc: "Consume %{speed} impulsos temporales cada segundo y acelera tu imperio a una velocidad %{speed} veces mayor.",
   Tutorial: "Tutorial",
   ...
   UnitedNationsDesc: "Todos los edificios de rango IV, V y VI obtienen +1 Multiplicador de Producción, Capacidad de Trabajadores y Almacenamiento. Participa en la Asamblea General de la ONU y vota por un aumento adicional cada semana",
