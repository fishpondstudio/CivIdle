export const ES = {
   ...
   CathedralOfBrasiliaDesc: "Si todos los edificios en funcionamiento en un rango de 2 casillas forman una cadena de producción (p. ej., el recurso producido por un edificio es consumido por otro), entonces cada tipo de edificio en esa cadena de producción recibe +X Multiplicador de Producción, X = longitud de la cadena de producción",
   ...
   GreatWallDesc: "Todos los edificios a 1 casilla de distancia obtienen +N Multiplicador de Producción, Capacidad de Trabajadores y Almacenaje. N = número de eras diferentes entre la era actual y la era en que el edificio fue desbloqueado. Al ser construido junto a la Ciudad Prohibida, el rango se incrementa en 2 casillas",
   ...
   Reborn: "Renacimiento",
   RebornModalDescV3: "Iniciarás un nuevo imperio, pero todos tus personajes históricos <b>de esta partida</b> se convierten en fragmentos permanentes, que pueden usarse para mejorar tu <b>nivel de personajes históricos permanentes</b>. También recibirás fragmentos de personajes históricos extra según tu <b>valor total de imperio</b>",
   ...
   SantaClausVillageDesc: "Tras completarlo, nace un personaje histórico de la era actual. Esta maravilla puede ser actualizada y cada mejora adicional proporciona un personaje histórico extra. Al elegir personajes históricos de esta maravilla, se ofrecen 4 elecciones. Esta maravilla sólo puede construirse en Diciembre",
   ...
   TutorialResearchCountingHTML: "Para investigar una tecnología, haz click en la pestaña <b>Investigación</b>, elige la tecnología que quieras invesigar y haz clic en <b>Desbloquear</b> en el panel lateral derecho. Si no tienes suficiente ciencia, puedes mejorar tus cabañas, ya que más trabajadores ocupados generarán más ciencia.",
