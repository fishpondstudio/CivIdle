export const ES = {
   ...
   FestivalTech: "Desbloquea el festival: la felicidad positiva (máximo 50) se convierte en puntos del festival. Por cada 25 puntos del festival, tu imperio entra en un ciclo de festivales, lo que otorga una importante bonificación del mapa",
