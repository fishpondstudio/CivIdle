export const TR = {
   ...
   ApplyToAllBuilding: "Hepsi İçin Yap %{building}",
   ...
   BuildingPriority: "Bina Önceliği",
   ...
   ChatHideLatestMessageDesc: "En son sohbet mesajının içeriğini sohbet çubuğunda yıldız işaretleriyle değiştirin",
   ...
   EmpireValueFromBuildings: "Binalardan",
   ...
   PorcelainTowerDesc: "Nanjing Porselen Kulesi Desc",
   Poseidon: "Poseidon",
   ...
   Shelter: "Barınak",
   Shortcut: "Kısayol",
   ShortcutBuildingPageSellBuilding: "Bina Sat",
   ...
   ShortcutBuildingPageUpgradeToNext10: "10 Seviye Yükselt",
   ShortcutBuildingPageUpgradeX1: "1 Seviye Yükselt",
   ShortcutBuildingPageUpgradeX5V2: "5 Seviye Yükselt",
   ...
   StockpileSettingsHeading: "Stok Alanı Ayarları",
   Stone: "Taş",
   StoneAge: "Taş Devri",
   ...
   UnitedNationsDesc: "Birleşmiş Milletler Descriptions",
   ...
   YangtzeRiverDesc: "Yangtze Nehri Desc",
   YellowCraneTower: "Sarı Vinç Kulesi",
   YellowCraneTowerDesc: "Sarı Vinç Kulesi Desc",
   Zenobia: "Zenobia",
