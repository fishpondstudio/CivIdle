export const JP = {
   ...
   AccountUpgradeConfirmDescV2: "アカウントをアップグレードすると、<b>現在の進行状況はリセットされ、</b>許可されたレベルの範囲内の permanent 偉人を持ち越すことが出来ます。<b>この操作はやり直すことは出来ません。</b>続けますか？",
   Acropolis: "Acropolis",
