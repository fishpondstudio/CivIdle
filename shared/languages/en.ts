export const EN = {
   ...
   BlueMosqueDesc: "All wonders provide +1 Production, Worker Capacity and Storage Multiplier to adjacent buildings. When Mosque is constructed next to Hagia Sophia, increase the bonus to +2",
   BobHope: "Bob Hope",
   ...
   Colosseum: "Colosseum",
   ColosseumDescV2: "Chariot Workshops are exempt from -1 happiness. Consumes 10 chariots to produce 10 happiness. Each unlocked age gives 2 extra happiness",
   ...
   GreatWallDesc: "All buildings within 1 tile range get +N Production, Worker Capacity and Storage Multiplier. N = the number of the different ages between the current age and the age where the building is first unlocked. When constructed next to Forbidden City, the range increases to 2 tiles",
   ...
   OpetV2: "Opet: Great Sphinx provides +N Building Level Boost to all Tier II or above buildings within 2 tiles of the Sphinx. N = Number of its adjacent buildings of the same type",
   ...
   PorcelainTowerDesc: "+5 Happiness. When constructed, all your currently earned extra great people at rebirth will become available for this run (they are rolled following the same rule as permanent great people)",
   ...
   StatueOfZeusDesc: "Spawn random deposits, from among those that have been unlocked, on adjacent empty tiles. All Tier I buildings adjacent to Statue of Zeus get +5 Production and Storage Multiplier",
   ...
   YellowCraneTowerDesc: "+1 choice when choosing great people. All buildings within 1 tile range of the Tower get +1 Production, Worker Capacity and Storage Multiplier. When constructed next to Yangtze River, the range increases to 2 tiles",
   ...
   HusainidDynasty: "Husainid Dynasty",
   ...
   EachPairOfAdjacentPaintingsByTheSamePainterGrants1ProductionMultiplier: "Each pair of adjacent paintings by the same painter grants +1 Production Multiplier",
   EachPairOfAdjacentPaintingsOfTheSameSizeGrants1BuildingLevelBoost: "Each pair of adjacent paintings of the same size grants +1 Building Level Boost",
   EachPairOfAdjacentPaintingsPaintedInTheSameCenturyGrants1StorageMultiplier: "Each pair of adjacent paintings painted in the same century (100 years) grants +1 Storage Multiplier",
   EachPairOfAdjacentPaintingsWithTheSameThemeGrants1WorkerCapacityMultiplier: "Each pair of adjacent paintings with the same theme grants +1 Worker Capacity Multiplier",
