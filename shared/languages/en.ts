export const EN = {
   ...
   PlayerTradePendingTrades: "Pending Trades",
   PlayerTradeClosePendingTrades: "Close",
   PlayerTradePlayerNameFilter: "Player Name",
   PlayerTradeMaxTradeAmountFilter: "Max Trade Amount",
   ...
   CultivationLevelX: "Cultivation Level %{level}",
   CommerceLevelX: "Commerce Level %{level}",
   HonorLevelX: "Honor Level %{level}",
   ExpansionLevelX: "Expansion Level %{level}",
};
