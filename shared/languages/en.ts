export const EN = {
   ...
   GreatBarrierReefDesc: "Each happiness provides +0.5*T Science Per Busy Worker and +0.25*T Science Per Idle Worker. T = Current Age (Stone Age = 1, Bronze Age = 2, Information Age = 10)",
   Uluru: "Uluru",
   UluruDesc: "All buildings within 3-tile range gets +X Production Multiplier. X = number of different great people from this run",
