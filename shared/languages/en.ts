export const EN = {
   ...
   AutopilotStoragePercentageDesc: "Autopilot Storage Percentage",
   AutopilotStoragePercentage: "%{percentage}%",
   AutopilotSettingWarning: "This setting applies to all Warehouses",
   RomeMapMenu: "Map",
   PlayerMapMenu: "Trade",
   Legion: "Legion",
   Milk: "Milk",
