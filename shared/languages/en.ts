export const EN = {
   ...
   Dutch: "Dutch",
   Binnenhof: "Binnenhof",
   KoningsdagV2: "Koningsdag: Keukenhof grants buildings within 3 tiles a Production Multiplier equal to 50% of Happiness it provides. Mauritshuis' Painter Collection Bonus and Diversification Bonus are doubled.",
