export const EN = {
   ...
   GreatBarrierReefDesc: "Each happiness provides +0.5*X Science Per Busy Worker and +0.25*X Science Per Idle Worker. X = Current Age (Stone Age = 1, Bronze Age = 2, Information Age = 10)",
   Uluru: "Uluru",
