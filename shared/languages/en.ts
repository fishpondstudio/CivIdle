export const EN = {
   ...
   LargeHadronColliderDescV3: "All Information Age great people get +2 level for this run. This wonder can be upgraded and each additional upgrade provides +1 level to all Information Age great people for this run (excl. Great People that provide extra level to Information Age wonders)",
   Law: "Law",
   Lens: "Lens",
   ...
   Diwali: "Diwali: Increase the range of Ganges River to 3-tile. Increase the range of Qutb Minar to 3-tile. Double the level boost from Red Fort",
   ...
   SundarbansDesc: "Double the effect of all Age Wisdoms (excl. Great People that provide extra level to Information Age wonders)",
};
