export const EN = {
   ...
   EachPairOfAdjacentPaintingsPaintedInTheSameCenturyV2: "Each pair of adjacent paintings painted in the same century (100 years) grants +5 Science Per Busy Worker",
