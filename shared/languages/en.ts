export const EN = {
   ...
   LargeHadronColliderDescV3: "All Information Age great people get +2 level for this run. This wonder can be upgraded and each additional upgrade provides +1 level to all Information Age great people for this run (excl. William Shepherd, Lee Kuan Yew, Emmanuelle Charpentier, Dan Alderson, Freeman Dyson, Vera Rubin)",
   Law: "Law",
   Lens: "Lens",
