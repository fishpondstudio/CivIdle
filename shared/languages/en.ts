export const EN = {
   ...
   ScheduleForDemolition: "Schedule for Demolition",
   ScheduleForDemolitionTooltip: "Stop production and empty inventory into nearby storage, then automatically demolish",
   CancelScheduledDemolition: "Cancel Demolition",
   ScheduledForDemolitionStatus: "Emptying inventory before demolishing...",
