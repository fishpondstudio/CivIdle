export const EN = {
   ...
   ResourceSortByName: "Sort by Name",
   ResourceSortByTier: "Sort by Tier",
   ResourceSortByValue: "Sort by Empire Value",
   ResourceSortMethod: "Resource Sort Method",
   ...
   GiantOtterDesc: "All buildings within 2 tile range get +X Production Multiplier. X = number of empty tiles within 2 tile range",
   Hoatzin: "Hoatzin",
   HoatzinDesc: "All buildings within 2 tile range get +X Building Level Boost. X = number of empty tiles within 2 tile range",
   RoyalFlycatcher: "Royal Flycatcher",
   RoyalFlycatcherDesc: "All buildings within 2 tile range get +X Building Level Boost. X = number of empty tiles within 2 tile range",
