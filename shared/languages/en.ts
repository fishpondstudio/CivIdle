export const EN = {
   ...
   ProductionPriorityDescV4:
      "Priority determins the order that buildings transport and produce - a bigger number means a building transports and produces before other buildings",
   ...
   ShortcutScopeGlobalCityPage: "City Page",
