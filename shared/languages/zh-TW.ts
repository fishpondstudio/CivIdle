export const ZH_TW = {
   ...
   SwissBank: "瑞士銀行",
   SwissBankDesc: "將選定資源從相鄰倉庫中轉換為💵瑞士貨幣——價值 10M 的可交易資源貨幣。每個週期基礎產出1個💵瑞士貨幣（可被生產乘數影響），該奇觀可被升級，並且每一次額外升級增加 1 基礎產出。瑞士銀行可以存儲無限量的💵瑞士貨幣",
   Sword: "劍",
   SwordForge: "鑄劍廠",
   ...
   TranslatorCredit: "HarchuN、JiaMuC(沐)、WangChenan、Neca、Captain<br>企鹅群<b>907371958</b>",
   Translators: "翻譯人員",
