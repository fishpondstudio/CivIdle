export const ZH_TW = {
   ...
   MatrioshkaBrainDesc: "計算帝國價值時允許計算科學（5 科學 = 1 帝國價值）。每個忙碌和空閒的工人 +5 科學。這個奇蹟可以升級，每次額外升級都會為每個忙碌和閒置工人提供 +1 科學",
   ...
   UpgradeWonderNotProducingDesc: "這個奇蹟正在升級 - <b>在升級完成之前，它的提升將不再起作用</b>",
   Uranium: "鈾",
   ...
   ZigguratOfUrDesc: "每 10 點幸福感（上限）為所有建築物提供 +1 生產乘數（最大值 = 解鎖時代數 / 2）。奇蹟（包括大自然）不再提供 +1 幸福值。效果可以關閉",
