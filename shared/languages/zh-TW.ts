export const ZH_TW = {
   ...
   Gameplay: "遊戲設定",
   GangesRiver: "恒河",
   GangesRiverDescV3: "周圍 1 地塊範圍內的每種建築（產出工人建築和克隆實驗室除外），每種建築所有同類型建築獲得 +N 生產乘數，N 為解鎖該建築時代的時代智慧等級",
   Garment: "服裝",
   GarmentWorkshop: "製衣廠",
   GasPipeline: "天然氣管道",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDescV2: "建造完成後，誕生一個除當前時代之外的偉人。該奇觀可被升級，並且每一次升級都會誕生一個除當前時代之外的偉人。（偉人隨機區間：青銅~資訊）當從這座奇觀進行偉人選擇時，每位偉人有 2 項可選。",
