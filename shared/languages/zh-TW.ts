export const ZH_TW = {
   ...
   BecomeAllyTooltip: "要成為相鄰玩家的同盟友，請選擇與他們相同的旗幟（地球旗幟除外）",
   BigBen: "大笨鐘",
   ...
   Neighbors: "相鄰玩家",
   NeighborsDescHTML:
      "對於每個相鄰玩家擁有的地塊，你得到<b> +%{neighbor} 生產乘數的貿易地塊加成</b>，對於每個同盟友擁有的地塊，你得到<b> +%{ally} 生產乘數的貿易地塊加成</b>。要成為相鄰玩家的盟友，請選擇與他們相同的旗幟（地球旗幟除外）",
   Neuschwanstein: "新天鵝堡",
   ...
   PlayerMapMapAllyTileBonus: "同盟友的貿易地塊加成",
