export const ZH_TW = {
   About: "關於放置文明",
   AbuSimbel: "阿布辛貝神殿",
   AbuSimbelDescV2: "每一級 +100% 拉美西斯二世（青銅時代，建造者能力）的效果（此生偉人與永恆偉人的效果。時代智慧除外）。為周圍 1 塊地範圍內的所有奇觀額外提供 +1 幸福感。該奇觀可被升級，並且每一次額外升級為奇觀周圍擴大 1 地塊範圍。",
   ...
   Alloy: "合金",
   AllTransportsWithDistance3TileAreImmediate: "所有運輸距離小於或等於 3 地塊範圍，運輸資源不需要工人且運輸是即時（無運輸單位運輸）",
   Ally: "盟友",
   ...
   AntonieVanLeeuwenhoek: "安東尼·凡·列文虎克",
   ...
   Archimedes: "阿基米德",
   Architecture: "建築學",
   AreYouSureYouWantToRebirthAsX: "你確定重生到 %{city} ？",
   Aristophanes: "阿里斯托芬",
   ...
   BirthdayOfXIsY: "%{date} 是 %{name} 的誕辰 ",
   Bitcoin: "比特幣",
   BitcoinMiner: "比特幣礦工",
   BlackForest: "黑森林",
   ...
   Blacksmith: "工匠鋪",
   Blockchain: "區塊鏈",
   BlockXCurrentGameSession: "封鎖 %{name} 的消息(重進遊戲後失效)",
   BlockXCurrentGameSessionDesc: "確定封鎖 <b>%{name}</b> 該玩家的消息？該封鎖重進遊戲後失效（自動重連除外）",
   BlueMosque: "藍色清真寺",
   ...
   BranCastle: "布郎城堡",
   BranCastleDescV2: "該奇觀產出的工人等同于周圍 3 地塊範圍內的工人總產出。如果有足夠的工人，還會將該奇觀產出的工人轉化為吸血鬼。吸血鬼不參與生產或運輸資源，但被視為忙碌的工人。布郎城堡的等級由工人總數決定，每一級獲得 +1 閒置工人科學產出和 +2 忙碌工人科學產出。該奇觀僅能在萬聖節（10月15日至11月15日）期間建造。",
   ...
   CarryOverWatchedResources: "繼承重視資源提示設置",
   CarryOverWatchedResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingStatisticsOffice: "重視資源提示設置將繼承到下次運行，該提示將在建造統計局後顯示",
   CarryOverWatchedTradeableResources: "繼承重視可交易資源提示設置",
   CarryOverWatchedTradeableResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingACaravansary: "重視可交易資源提示設置將繼承到下次運行，該提示將在建造商隊旅館後顯示",
   Carthage: "迦太基",
   Carthaginian: "迦太基",
   Cartographer: "製圖師",
   CathedralOfBrasilia: "巴西利亞大教堂",
   CathedralOfBrasiliaDesc:
      "如果周圍 2 地塊範圍的每個建築形成一個完整的生產鏈，即範圍內一個建築生產的資源被範圍內另一個建築消耗（範圍當中相同產出不同建築也會被歸入完整的生產鏈中），那麼參入該完整的生產鏈中的每種建築為其所有相同建築建築提供 +X 生產乘數。X 為生產鏈中不相同建築數量（最大值為18。奇觀、旅館、倉庫、市場、克隆工廠和克隆實驗室除外）",
   ...
   CentrePompidouDesc:
      "建造完成後，所有建築物將獲得 +1 的生產加成與 +2 的儲存加成乘數。若當前遊戲已進入資訊時代，且下次運行選擇不同文明，則此奇觀將會保留。每當以一個獨特文明達到資訊時代並重生時，該奇觀將在重生時提升 1 級，每個等級提供額外 +1 生產與 +2 儲存加成乘數。此奇觀的價值不會被計入帝國總價值中，且大英博物館無法轉換為此奇觀。",
   ...
   CircusMaximusDescV3: "每一級提供 +5 幸福感。每一級為所有音樂家協會、作家協會和畫家協會提供 +1 生產和存儲乘數",
   CityState: "城邦國家",
   CityViewMap: "城市",
   ...
   ColorTurquoise: "寶石綠",
   Colosseum: "羅馬競技場",
   ColosseumDescV3: "所有戰車工坊免去 -1 幸福感。每一級消耗 10 戰車並產出 5 幸福感。每個已解鎖的時代提供等同於奇觀等級的幸福感",
   ...
   CrossPlatformSaveDescHTML: "為了同步你的進度（包括帳號等級和支持者包）到移動設備，你需要在Steam上購買<b>跨平臺雲儲存</b>",
   ...
   DefaultStockpileMax: "預設最大儲存庫容量（建議初次新手最多設置為 50x ）",
   DefaultStockpileSettings: "預設儲存庫輸入容量（建議初次新手最多設置為 10x ）",
   ...
   Diplomacy: "外交",
   Display3PaintingsByJohannesVermeerToUnlock1ProductionMultiplier: "展覽 3 幅 約翰內斯·維米爾 的畫作獲得 +1 生產乘數",
   Display3PaintingsByRembrandtVanRijnToUnlock1ProductionMultiplier: "展覽 3 幅 倫勃朗·哈爾曼松·凡·萊因 的畫作獲得 +1 生產乘數",
   Display3PaintingsByVincentVanGoghToUnlock1ProductionMultiplier: "展覽 3 幅 文森特·威廉·梵高 的畫作獲得 +1 生產乘數",
   Display5MasterpiecesToUnlock1BuildingLevelBoost: "展覽 5 幅傑作獲得 +1 生產等級",
   DisplayPaintingsBy5DifferentPaintersToUnlock1BuildingLevelBoost: "展覽 5 位不同畫家的畫作獲得 +1 生產等級",
   DisplayPaintingsWith5DifferentThemesToUnlock1BuildingLevelBoost: "展覽 5 種不同主題的畫作獲得 +1 生產等級",
   DistanceInfinity: "無限制",
   DistanceInTiles: "距離格數",
   DiversificationBonus: "展覽多元化獎勵",
   DiwaliV3: "排燈節：恒河的範圍增加至周圍 2 地塊範圍。紅堡的範圍增加至周圍 5 地塊範圍。桑奇大塔周圍擴大 2 地塊範圍",
   ...
   EachPairOfAdjacentPaintingsByTheSamePainterV2: "每相鄰相同畫家的畫作獲得 +0.5 生產等級",
   EachPairOfAdjacentPaintingsOfTheSameSizeV2: "每相鄰相同尺寸的畫作獲得 +0.5 生產乘數",
   EachPairOfAdjacentPaintingsPaintedInTheSameCenturyV3: "每相鄰同一世紀（100 年）內畫作獲得 +2 閒置工人科學產出",
   EachPairOfAdjacentPaintingsWithTheSameTheme: "每相鄰相同主題的畫作獲得 +5 建造者能力乘數",
   EasterBunny: "復活節兔子",
   EasterBunnyConstructed: "已建造復活節兔子",
   EasterBunnyDesc: "建造完成後，重生時將複製 10％ 額外偉人將以此生偉人方式進入下次運行不再以永久碎片，並在下次運行中建造復活節兔子後根據已解鎖時代誕生這些偉人。此奇觀僅在 4 月可建造。",
   EastIndiaCompany: "東印度公司",
   EastIndiaCompanyDescV2: "當您通過與玩家貿易獲得的所有物品都會獲得相應貿易點數（包括稅收，物品的每 1 價值 = 1 貿易點數）。該奇觀累積您獲得的貿易點數。每週期自動消耗 2000 貿易點數，使所有建築每相鄰一個運轉的商隊旅館獲得 +0.5 生產乘數。該奇觀可消耗貿易點數進行升級，並且每一次額外升級獲得 +0.5 生產乘數",
   Education: "教育學",
   ...
   Every5WindMillsLevelGives1ProductionMultiplierToAdjacentPowerPlants: "每 5 級風力發電機為相鄰的發電廠提供 +1 生產乘數",
   ...
   FestivalTechTooltipV2: "正向幸福值（最多 50）轉換為節慶點數，1 幸福= 1 節日點數（開啟節日時不獲得節日點數）。每累積 %{point} 節慶點數，可以讓您的帝國進入節慶週期，獲得特定地圖的重大加成。此地圖的節慶加成為 %{desc}",
   FestivalTechV2: "解鎖節慶功能 - 正向幸福值（最多 50）轉換為節慶點數，1 幸福= 1 節日點數（開啟節日時不獲得節日點數）。每累積 %{point} 節慶點數，可以讓您的帝國進入節慶週期，獲得特定地圖的重大加成",
   Feudalism: "封建主義",
   Fibonacci: "費波拉契",
   ...
   Fire: "鑽木取火",
   Firearm: "火器",
   FirstTimeGuideIntroHTML: "《放置文明》是一款<b>增量式4X /帝國建設</b>遊戲——教程將幫助你完成第一次運行。但在開始之前，這裡有一些快速設置。你應該輸入你的<b>玩家昵稱</b>（請避免使用不友好昵稱），這樣其他玩家就能認出你<b>（玩家交流QQ群：907371958）</b>",
   ...
   Gallery: "美術館",
   GalleryPainterFransHals: "弗朗斯·哈爾斯",
   GalleryPainterGeorgeHendrikBreitner: "喬治·亨德裏克·布萊特納",
   GalleryPainterJacobVanRuisdael: "雅各布·凡·雷斯達爾",
   GalleryPainterJanSteen: "揚·斯丁",
   GalleryPainterJohannesVermeer: "約翰內斯·維米爾",
   GalleryPainterKarelAppel: "卡雷爾·阿佩爾",
   GalleryPainterPieterBruegelTheElder: "彼得·勃魯蓋爾",
   GalleryPainterPieterDeHooch: "彼得·德·霍赫",
   GalleryPainterPietMondrian: "皮特·蒙德裏安",
   GalleryPainterRachelRuysch: "雷切爾·勒伊斯",
   GalleryPainterRembrandtVanRijn: "倫勃朗·哈爾曼松·凡·萊因",
   GalleryPainterVincentVanGogh: "文森特·威廉·梵高",
   GalleryPaintingAMothersDuty: "《母親的職責》",
   GalleryPaintingBroadwayBoogieWoogie: "《百老匯的布吉·伍吉》",
   GalleryPaintingCafeTerraceAtNight: "《夜間的露天咖啡座》",
   GalleryPaintingCompositionWithRedBlueAndYellow: "《紅藍黃的構圖》",
   GalleryPaintingGirlInAWhiteKimono: "《穿白色和服的女孩》",
   GalleryPaintingGirlWithAPearlEarring: "《戴珍珠耳環的少女》",
   GalleryPaintingGrayTree: "《灰色的樹》",
   GalleryPaintingSelfPortrait1889: "《自畫像》",
   GalleryPaintingStillLifeWithFlowersOnAMarbleSlab: "《大理石板上的花卉靜物畫》",
   GalleryPaintingSunflowers: "《向日葵》",
   GalleryPaintingTheAnatomyLessonOfDrNicolaesTulp: "《尼古拉斯·杜爾博士的解剖學課》",
   GalleryPaintingTheArtOfPainting: "《繪畫的藝術》",
   GalleryPaintingTheBanquetOfTheOfficersOfTheStGeorgeMilitiaCompany: "《聖喬治市民警衛隊官員之宴》",
   GalleryPaintingTheCourtyardOfAHouseInDelft: "《代爾夫特一所房子的庭院》",
   GalleryPaintingTheCryingCrocodileTriesToCatchTheSun: "《哭泣的鱷魚試圖抓住太陽》",
   GalleryPaintingTheFeastOfSaintNicholas: "《聖尼古拉斯的盛宴》",
   GalleryPaintingTheHuntersInTheSnow: "《雪中獵人》",
   GalleryPaintingTheJewishBride: "《猶太新娘》",
   GalleryPaintingTheLaughingCavalier: "《微笑的騎士》",
   GalleryPaintingTheLittleStreet: "《小街》",
   GalleryPaintingTheMerryFamily: "《歡樂家庭》",
   GalleryPaintingTheMilkmaid: "《擠奶女工》",
   GalleryPaintingTheNightWatch: "《夜巡》",
   GalleryPaintingThePotatoEaters: "《吃馬鈴薯的人》",
   GalleryPaintingTheSingelBridgeAtThePaleisstraatInAmsterdam: "《阿姆斯特丹皇宮街的辛格爾橋》",
   GalleryPaintingTheStarryNight: "《星夜》",
   GalleryPaintingViewOfHaarlemWithBleachingFields: "《帶有漂白場的哈勒姆風景畫》",
   GalleryPaintingWheatFieldWithCrows: "《麥田上的鴉群》",
   GalleryPaintingWindmillAtWijkBijDuurstede: "《埃克河邊的磨坊》",
   GalleryPaintingWomanHoldingABalance: "《保持平衡的女人》",
   GalleryThemeAbstract: "抽象畫",
   GalleryThemeDomesticScene: "家庭情景畫",
   GalleryThemeLandscapeCityscape: "風景畫",
   GalleryThemePortrait: "肖像畫",
   GalleryThemeStillLife: "靜物畫",
   GameCalendar: "遊戲日曆",
   Gameplay: "遊戲設定",
   GangesRiver: "恒河",
   GangesRiverDescV3: "周圍 1 地塊範圍內的每種建築（產出工人建築除外），每種建築所有相同建築獲得 +N 生產乘數，N 為解鎖該建築時代的時代智慧等級",
   Garment: "服裝",
   GarmentWorkshop: "製衣廠",
   GasPipeline: "天然氣管道",
   ...
   Generate1hTimeWarpWhenEnteringANewAge: "每進入一個新時代時，獲得 1 小時扭曲時間（不會超出扭曲時間存儲上限）",
   ...
   GoldenPavilion: "金閣寺",
   GoldenPavilionDesc: "周圍 3 格地塊範圍內的建築，每個相鄰的建築物如果生產任何消耗資源，將獲得 +1 生產乘數（不包括克隆實驗室和克隆工廠，且該建築不可關閉）",
   GoldMiningCamp: "金礦",
   GordonMoore: "高登·摩爾(Gordon Moore)",
   GranaryAdministration: "糧倉管理",
   GrandBazaar: "大巴扎(伊斯坦堡大市集)",
   GrandBazaarDesc: "提供市場整合介面。相鄰奇觀運轉的商隊旅館 +5 生產、儲存乘數，相鄰的市場提供不同的交易內容。",
   ...
   GreatPeople: "偉人",
   GreatPeopleBirthday: "偉人的誕辰提示",
   GreatPeopleBirthdayDesc: "今天是以下偉人的誕辰: %{names} ——此生偉人與永久偉人的效果翻倍！",
   ...
   GreatPersonThisRunEffectiveLevel: "你目前在本次運行遊戲中有%{count}個%{person}，新獲得的%{person}將具有1/%{effect}的效果",
   GreatPersonWildCardBirth: "出生",
   GreatSphinx: "獅身人面像",
   GreatSphinxDescV3: "為周圍 1 塊地範圍內的所有建築提供 +N 生產乘數（ N 為其相鄰相同建築數量）。該奇觀可被升級，並且每一次額外升級為奇觀周圍擴大 1 地塊範圍。",
   GreatWall: "萬里長城",
   GreatWallDescV2: "周圍 1 地塊範圍內所有建築，獲得 +N 生產、工人能力以及存儲乘數。 N 為當前科技時代與建築所屬時代之間的差值。該奇觀可被升級，並且每一次額外升級為長城周圍擴大 1 地塊範圍。當與紫禁城相鄰時，則長城周圍擴大 1 地塊範圍",
   ...
   Habitat67: "棲息地67住宅區",
   Habitat67DescV2: "該奇觀可被升級，每一級為AI實驗室提供 +1 生產、工人能力以及存儲乘數。為AI實驗室提供 +N 生產和存儲乘數，N 為資訊時代智慧等級。每有正向 5 幸福感（最大值為 50 ）為AI實驗室提供 +1 生產等級",
   HafsidDynasty: "哈夫斯王朝",
   HagiaSophia: "聖索菲亞大教堂",
   ...
   Herding: "畜牧",
   Hermitage: "冬宮博物館",
   HermitageDesc: "該奇觀可被升級，每一級為周圍 2 地塊範圍內各種類型建築及其所有相同建築提供 +1 存儲乘數",
   Herodotus: "希羅多德",
   HideSpinner: "隱藏運轉動畫",
   ...
   IdeologyDescHTML: "<style>b { color: #0000ff; }</style>使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>自由主義、保守主義、社會主義或共產主義</b>中<font color= #ff0000>選擇一個</font>作為您的帝國政治意識形態。選擇後，您<b>無法切換意識形態</b>。您可以在每個政治意識形態中解鎖更多的增益。",
   IMPei: "貝聿銘",
   ...
   KeepersSpecialDay: "守護者的的特別日：%{names} (所有建築獲得 +1 生產乘數和 +1 生產等級)",
   KeepOurServerOnPackOptions: "守護者權益",
   KeepTheWindowOpenAfterPlacingTrade: "送出訂單後保留此窗口",
   Keukenhof: "庫肯霍夫公園",
   KeukenhofDescV2: "+N 幸福感。N 為周圍 3 地塊範圍內的所有建築生產或消耗的不相同資源種類",
   KingDavid: "大衛王",
   KizhiPogost: "基日鄉村教堂",
   KizhiPogostDescV2: "周圍 3 地塊範圍內的所有建築獲得 +N 生產乘數，N 為該奇觀獲得的生產乘數（生產乘數可來自：戴森球、蓬皮杜文藝中心、聖家族大教堂等通用加成奇觀）",
   Knight: "騎士",
   KnightCamp: "騎士營地",
   KoningsdagV3: "國王節：庫肯霍夫公園為範圍內的所有建築提供 +N 生產乘數，N 為庫肯霍夫公園提供幸福感的 25% 。莫瑞泰斯皇家美術館的展覽畫家作品獎勵和展覽多元化獎勵提供雙倍加成效果",
   Koti: "💵瑞士貨幣",
   KotiInStorage: "已存儲",
   KotiProduction: "💵瑞士貨幣",
   Kremlin: "克里姆林宮",
   ...
   Laozi: "老子",
   Lapland: "拉普蘭",
   LaplandDesc: "被發現時，顯示整張地圖。範圍內 2 格內的所有建築獲得 +N 的生產加成乘數，其中 N 為已解鎖的時代數。此自然奇觀僅能在 12 月被發現。",
   ...
   Lumber: "木材",
   LumberMill: "鋸木場",
   LunarNewYearV2: "農曆新年：長城和黃鶴樓為範圍內所有建築提供等同於奇觀提供生產乘數的生產等級。大報恩寺琉璃塔為所有此生偉人提供 +1 等級",
   LuxorTemple: "盧克索神殿",
   ...
   MiddleClickDescHTML: "選取你要<b>複製藍圖的建築</b>（包括建造中的）點擊，別點擊任何地塊！直接<b>按滑鼠中鍵</b>指著想要建設相同建築的地塊",
   Midsummer: "仲夏節",
   MidsummerDesc: "為周圍 1 塊地範圍內的所有建築提供 +N 生產等級，N 為該建築獲得時代智慧生產乘數的數值（奇觀提供時代智慧加成除外）。該奇觀可被升級，並且每一次額外升級為奇觀周圍擴大 1 地塊範圍。該奇觀僅能在仲夏期間（6月10日至6月30日）建造。",
   ...
   MoveTileConfirm: "你確定宣稱該地塊？ 你將失去所有貿易地塊並且 %{time} 小時內無法再次宣稱",
   Movie: "電影",
   MovieStudio: "電影製片廠",
   Museum: "博物館",
   Music: "音樂",
   MusiciansGuild: "音樂家公會",
   MuteWhenBackgrounded: "後臺靜音",
   ...
   OnlyYouCanSeeThis: "該消息僅您可見",
   OnYourSpecialDayDesc: "在您的特別日裏，所有玩家的所有建築獲得 +1 生產乘數和 +1 生產等級。你的特別日將會會顯示在遊戲日曆上。<b>此效果每 %{cooldown} 天只能更改一次。</b>",
   OpenGallery: "打開畫廊",
   ...
   OpetV3: "歐佩特：獅身人面像額外為範圍內所有建築，提供 +N 生產等級（ N 為其相鄰相同建築數量）",
   OpticalFiber: "光纖",
   ...
   Pagoda: "佛塔",
   Painter: "畫家",
   PainterAdjacency: "畫家相鄰",
   PaintersCollectionBonus: "展覽畫家作品獎勵",
   PaintersGuild: "畫家公會",
   Painting: "繪畫",
   ...
   ParliamentHill: "國會山",
   Parthenon: "帕德嫩神殿",
   ParthenonDescV3: "每一級誕生兩位古典時代偉人，每位偉人有 4 項可選。所有音樂家協會與畫家協會，獲得 +1 生產、工人能力以及存儲乘數，並免去 -1 幸福感",
   Passcode: "一次性密碼",
   ...
   Petra: "佩特拉古城",
   PetraDescV3: "解鎖更多扭曲倍速和扭曲時間繼承。該奇觀可以升級，每一級提供 1 小時的扭曲存儲。當你離線時生成扭曲時間，你可以用來加速你的帝國或攜帶最多 4 小時（14.4K）扭曲時間到重生後的文明（可在右上角的選項-遊戲設置-離線生產欄裏分配離線設置）",
   ...
   PlayerFlag: "玩家旗幟",
   PlayerHandle: "玩家資訊",
   PlayerHandleColor: "昵稱顏色",
   PlayerHandleFont: "昵稱字體",
   ...
   Plus2ActiveTradesForKeeperOfOurServer: "守護者 +2 活躍中的訂單上限",
   Plus2ActiveTradesForSupporter: "支持者 +2 活躍中的訂單上限",
   ...
   PlusXGreatPeopleFromTheCurrentAge: "獲得 %{count} 位當前時代偉人",
   ...
   PorcelainTowerDescV2:
      "+5 幸福感。該奇觀可被升級，並且每一次額外升級 +1 幸福感。建造完成時，你重生時可獲取的當前額外偉人，將可在本輪提前獲取（他們與永恆偉人遵循相同的獲取規則）並在獲取後提供相應此生偉人加成（之後新增的額外偉人不可再次本輪提前獲取。例：重生時 500 額外偉人因提前獲取 200 額外偉人，則重生後只能獲取 300 偉人）",
   ...
   QinShiHuang: "秦始皇",
   QuickUiMode: "自動分配模式",
   QuickUiModeTooltip: "當選擇或取消選擇資源，根據所選資源全自動平均分配運送速度和限額（包括升級後和發生乘數變化）",
   QutbMinar: "古特伯高塔",
   ...
   RebirthHistoryEmpireValuePerCycle: "每個周期的總帝國價值",
   RebirthHistoryEmpireValuePerWallSecond: "每秒實際時間的總帝國價值",
   RebirthHistoryEmpireValueV2: "帝國總價值",
   RebirthHistoryEmpty: "暫無重生記錄",
   RebirthHistoryExtraGreatPeopleAtRebirth: "重生時的額外偉人",
   RebirthTime: "重生時間",
   Reborn: "重生",
   ...
   ReligionDescHTML: "<style>b { color: #0000ff; }</style>使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>基督教、伊斯蘭教、佛教與多神教</b>中<font color= #ff0000>選擇一個</font>作為帝國宗教。你將<b>不能更換宗教</b>。不同宗教將能解鎖不同增益效果",
   ReligionIslam: "伊斯蘭教",
   ReligionPolytheism: "多神教",
   RemapMiddleClickToRightClickHTML: "複製藍圖從使用<b>滑鼠中鍵</b>更改為使用<b>滑鼠右鍵</b>",
   RembrandtVanRijn: "倫勃朗·哈爾曼松·凡·萊因",
   RememberLastBuildRange: "記住建造範圍",
   RememberTheLastSelectedBuildRangeAfterYouBuildInRangeTheValueIsRememberedDuringTheCurrentGameSession: "開啟後本次運行中將記住選擇的建造範圍",
   Renaissance: "文藝復興",
   ...
   ResearchLab: "研究實驗室",
   ResearchMenu: "研究",
   ResearchSuperintelligence: "研究技術奇點",
   ResetLayout: "重置佈局",
   Resource: "資源",
   ResourceAmount: "數量",
   ResourceBar: "資源欄",
   ...
   ResourceExportToSameTypeTooltip: "允許相同建築從該建築運輸資源",
   ...
   ResourceTransportPreference: "輸入偏好",
   ...
   RestitutorEmpireRestoredEarlyAccess: "《光復者：帝國重鑄》特別加成",
   ...
   Samsuiluna: "薩姆蘇·伊路那",
   SanchiStupa: "桑奇大塔",
   SanchiStupaDescV2: "周圍 2 地塊範圍內所有建築，對於範圍內建築 “輸出” 與 “輸入” 的資源調用，免費運輸且運輸是即時（無運輸單位運輸）。該奇觀可被升級，並且每一次額外升級為奇觀周圍擴大 1 地塊範圍。",
   Sand: "沙",
   Sandpit: "採沙坑",
   ...
   ShortcutUpgradePageCancelAllUpgrades: "取消所有相同建築升級",
   ...
   SourceGreatPersonBirthday: "🎂誕辰🎂（偉人）: %{person}",
   SourceGreatPersonPermanent: "永久偉人： %{person}",
   SourceGreatPersonPermanentBirthday: "🎂誕辰🎂（永久偉人）: %{person}",
   ...
   SpaceProgram: "太空計劃",
   SpecialDay: "特別日",
   SpecialDayEffectDesc: "所有建築獲得 +1 生產乘數和 +1 生產等級",
   Spinner: "運轉動畫",
   SpinnerSpeed: "運轉動畫速度",
   SpinnerSpeedDescHTML: "調整運轉動畫的速度，作為區分現代化改造的建築運轉動畫速度為兩倍。<b>調整值必須位於0.01到100之間。默認值為1</b>（調整運轉動畫的速度不會影響每週期生產）",
   Sports: "體育運動",
   Sputnik1: "伴侶號",
   Sputnik1DescV3: "該奇觀可被升級，每一級為所有冷戰時代的偉人（包括未擁有過的）提供 +1 等級的本次效果（不包括奇觀偉人）。每一級為航天器發射場提供 +1 生產和存儲乘數。為航天器發射場提供 +N 生產和存儲乘數，N 為冷戰時代智慧等級。",
   Stable: "馬廄",
   Stadium: "體育場",
   StartFestival: "節慶狂歡！",
   Stateship: "村鎮",
   ...
   StatueOfLibertyDesc: "所有相鄰建築，獲得 +N 生產、工人能力以及存儲乘數。 N = 相鄰相同建築數量",
   StatueOfZeus: "宙斯神像",
   StatueOfZeusDescV2: "與該奇觀相鄰無沉積的地塊，隨機生成並顯露沉積資源（根據已解鎖資源去隨機，每種各一個不重複）。為周圍 1 塊地範圍內的所有建築提供 +5 生產與存儲乘數。該奇觀可被升級，並且每一次額外升級為奇觀周圍擴大 1 地塊範圍。",
   ...
   TechResourceTransportPreference: "解鎖建築輸入偏好(允許設定建築如何運送所需資源)。",
   ...
   Today: "今日",
   TodayIsTheBirthdayOfX: "今天是 %{name} 的誕辰——此生偉人與永久偉人的效果翻倍！",
   TodoTabs: "待處理提示",
   ...
   TraditionDescHTML: "<style>b { color: #0000ff; }</style>使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>耕作、商業、擴張和榮譽</b>中<font color= #ff0000>選擇一個</font>作為您的帝國傳統。選擇傳統後，您<b>無法切換傳統</b>。您可以在每個傳統中解鎖更多提升",
   ...
   TutorialBuildWheatFarmHTML: "要快速建造大量的建築，你可以<b>選擇一個建築地塊</b>，別點擊任何地塊！直接<b>按滑鼠中鍵</b>指著想要建設相同建築的地塊——這將自動複製選定的建築到空白地塊上。",
   ...
   WatchedTradeableResources: "重視可交易資源提示",
   Water: "水",
   ...
   XDifferentMasterpieces: "%{count} 幅不同傑作",
   XDifferentPainters: "%{count} 位不同畫家",
   XDifferentThemes: "%{count} 種不同主題",
   XhWarpStorageThisRun: "本次增加 %{hour} 小時扭曲存儲",
   XPaintingsBy: "%{count} 幅 %{painter} 的畫作",
   XResourceHasBeenDestroyed: "已銷毀 <b>%{amount} %{resource}</b>",
   XRunsInTotal: "累計 %{count} 次重生",
   XSpecialDay: "%{name} 的特別日",
   Xuanzang: "玄奘",
   YangtzeRiver: "長江",
