export const ZH_TW = {
   ...
   BuildingsStorageFull: "建築存儲已滿",
   BuildingsStorageFullHTML: "%{count} 建築不生產，因為它們存儲已滿，點擊高亮它們",
   BuildingsTurnedOff: "建築關閉的",
   BuildingsTurnedOffHTML: "%{count} 建築不生產，因為它們是關閉的，點擊高亮它們",
   BuildingTier: "階",
   ...
   Diwali: "排燈節：恒河和桑奇大塔的範圍增加至周圍 3 地塊範圍。紅堡提供雙倍加成效果",
   ...
   Gameplay: "遊戲設定",
   GangesRiver: "恒河",
   GangesRiverDescV2: "周圍 2 地塊範圍內的每種建築（產出工人建築除外），每種建築所有同類型建築獲得 +N 生產乘數，N 為解鎖該建築時代的時代智慧等級",
   Garment: "服裝",
   GarmentWorkshop: "製衣廠",
   GasPipeline: "天然氣管道",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDesc: "建造完成後，誕生一個除當前時代之外的偉人。該奇觀可被升級，並且每一次升級都會誕生一個除當前時代之外的偉人。（偉人隨機區間：青銅~資訊）當從這座奇觀進行偉人選擇時，每位偉人有 4 項可選。",
   ...
   RedFort: "紅堡",
   RedFortDesc: "周圍 4 地塊範圍內的所有建築獲得 +5 額外建築等級。該奇觀可被升級，並且每一次額外升級為周圍 4 地塊範圍內的所有建築提供 +1 額外建築等級",
   ...
   TradeTileBonusWillRefresh: "貿易地塊加成和聯合國刷新時間",
   ...
   TutorialBuildHutsHTML: "要建造小屋，點擊<b>空白地塊</b>，然後點擊<b>小棚屋</b>旁邊的<b>建造</b>。建造完成後，會驅散周圍的迷霧。小棚屋提供工人，這需要保持建築的運轉，也產生相應科學。",
   TutorialBuildLoggingCampsHTML: "伐木場需要建在含有<b>原木</b>地塊上。選擇一個含有原木地塊，點擊<b>伐木場</b>旁邊的<b>建造</b>。",
   TutorialBuildLumberMillsHTML: "木材廠消耗原木來生產木材，這是一種重要的建築材料。確保你有足夠的伐木場來供應它們——您可以使用統計局來幫助平衡您的生產和消費。",
   ...
   TutorialBuildX: "建造 %{building}",
   TutorialBuildXBuildings: "建造 %{count} %{building}",
   ...
   TutorialResearchCountingHTML: "為了研究一項科技，點擊<b>研究</b>選項，選擇想要研究的科技，點擊右側面板的<b>解鎖</b>。如果你沒有足夠的科學，你可以繼續升級你的小棚屋，因為更多忙碌的工人將產生更多的科學。",
   TutorialResearchHousingHTML: "研究住宅科技解鎖<b>房屋</b>，比小棚屋能提供更多的工人。在研究住宅之後，你的帝國將進入<b>青銅時代</b>，一個青銅時代的偉人將誕生。你可以從三個選擇中選擇一個偉人，偉人會給你很大的幫助——明智地選擇。",
   ...
   TutorialUpgradeHutsHTML: "升級時選擇一個<b>小棚屋</b>，按一下<b>+1</b>。小棚屋在升級時將<b>不再提供工人</b>，所以避免一起升級。更高的級別需要更多的資源來升級。",
   TV: "電視",
   TVStation: "電視台",
   UnclaimedGreatPeopleThisRun: "未領取的此生偉人",
   ...
   UnclaimedPermanentGreatPeople: "未領取的永恆偉人",
