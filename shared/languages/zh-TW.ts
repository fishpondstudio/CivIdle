export const ZH_TW = {
   ...
   AdaLovelace: "愛達·勒芙蕾絲",
   AdamSmith: "亞當·史密斯",
   AdaptiveGreatPersonDesc: "選擇一個 %{age} 解鎖的建築（產出勞動者建築除外）+%{value} 生產倍數,存儲倍數（偉人管理中使用）",
   ...
   Ally: "盟友",
   Alps: "阿爾卑斯山",
   AlpsDesc: "建築每 10 級，獲得 +1 生產能力( +1 消費倍數， +1 生產倍數)",
   Aluminum: "鋁",
   AluminumSmelter: "鋁廠",
   ...
   AngkorWat: "吳哥窟",
   AngkorWatDesc: "所有相鄰建築，獲得 +1 工人能力倍數，並增加 1000 名工人",
   AntiCheatFailure: "您的帳戶等級由於<b>未能通過反作弊檢查</b>而受到限制，若想提出申訴，請聯絡開發商",
   AoiMatsuri: "葵祭: 富士山產生的時間扭曲效果加倍",
   Apartment: "公寓",
   Aphrodite: "阿芙蘿黛蒂女神",
   AphroditeDescV2: "建築物升級至 20 級以上時，每級獲得 +2 建築者能力倍數。所有已解鎖的古典時代永久偉人在本次運行中等級 +1",
   ApolloProgram: "阿波羅計劃",
   ApolloProgramDesc: "所有火箭工廠產量、工人能力和儲存倍數均 +2 。 每個相鄰火箭工廠的衛星工廠、太空船工廠和核子飛彈發射井獲得 +1 生產倍數",
   ApplyToAll: "套用到全部",
   ...
   Aqueduct: "水渠",
   ArcDeTriomphe: "凱旋門",
   ArcDeTriompheDescV2: "每 1 幸福（最多 50）為所有建築物提供 +1 建造者能力倍數。",
   Archimedes: "阿基米德",
   Architecture: "建築學",
   Aristophanes: "阿里斯托芬",
   ...
   AtomicTheory: "原子理論",
   Atomium: "原子球塔",
   AtomiumDescV2: "所有在 2 格範圍內產生科學的建築獲得 +5 生產倍數。產出與 2 格範圍內所有建築產出科學的加總。建築完工時獲得現已解鎖最昂貴所需科學之值",
   Autocracy: "制度",
   Aviation: "航空學",
   Babylonian: "巴比倫",
   BackToCity: "返回城市",
   ...
   Bank: "銀行",
   Banking: "銀行業",
   BankingAdditionalUpgrade: "所有 10 級以上建築，獲得 +1 儲存倍數",
   Banknote: "鈔票",
   BaseCapacity: "基礎運輸能力",
   ...
   Blockchain: "區塊鏈",
   BlueMosque: "藍色清真寺",
   BlueMosqueDesc: "該奇觀使所有奇觀（自然奇觀除外）為相鄰的所有建築提供 +1 生產、勞動者能力以及存儲倍數。當與聖索菲亞大教堂相鄰時該奇觀雙倍加成效果",
   BobHope: "鮑伯·霍伯",
   ...
   BrandenburgGateDesc: "所有煤礦與油井，獲得 +1 生產、儲存以及工人能力倍數。與煉油廠相鄰的每個含原油資源地塊，使煉油廠獲得 +1 生產、儲存以及工人能力倍數",
   Brasilia: "巴西利亞",
   Brazilian: "巴西",
   Bread: "麵包",
   Brewery: "釀酒廠",
   ...
   BuildingMultipliers: "倍數",
   BuildingName: "建築名稱",
   BuildingNoMultiplier: "%{building} <b>不受任何倍數影響</b>(生產、勞動能力、儲存等)",
   ...
   Capitalism: "資本主義",
   Cappadocia: "卡帕多西亞",
   CappadociaDesc: "周圍 3 地塊範圍內所有的建築，當建築等級超過 30 時，超過的每個等級獲得 +1 生產、勞動者能力以及存儲倍數",
   Capybara: "水豚自然保護區",
   CapybaraDesc: "周圍 2 地塊範圍內的所有建築獲得 +X 生產倍數。 X = 該奇觀範圍內空白地塊數量",
   Car: "汽車",
   Caravansary: "商隊旅館",
   ...
   CathedralOfBrasiliaDesc: "如果周圍 2 地塊範圍的每個建築形成一個完整的生產鏈（上游各分支也計入在內），即一個建築生產的資源被另一個建築消耗，那麼參入該完整生產鏈中的每種建築為所有同類型建築提供 +X 生產倍數。X = 生產鏈的總長度（建築種類數量，最大值為18）",
   ...
   ChichenItza: "奇琴伊察",
   ChichenItzaDesc: "相鄰的建築，獲得 +1 生產倍數、儲存以及工人能力倍數",
   Chinese: "中國",
   ChoghaZanbil: "恰高·占比爾",
   ...
   CloneLabScienceMultiplierHTML: "克隆實驗室僅適用於<b>生產倍數加成<b>不適用於</b>科學生產建築加成<b>（例如 原子球塔 的生產倍數）",
   Cloth: "織物",
   CloudComputing: "雲端運算",
   CloudSaveRefresh: "刷新",
   CloudSaveReturnToGame: "返回遊戲",
   CNTower: "加拿大國家電視塔",
   CNTowerDesc: "所有電影製片廠、廣播電台和電視台均不受-1 幸福度影響。 所有在世界大戰和冷戰中解鎖的​​建築都會獲得+N 生產、工人容量和儲存倍數。 N = 建築的層數和時代之間的差異",
   Coal: "煤",
   CoalMine: "煤礦",
   CoalPowerPlant: "燃煤電廠",
   Coin: "硬幣",
   ...
   ConstructionBuilderMultiplier: "能力倍數",
   ConstructionBuilderMultiplierFull: "建造者能力倍數",
   ...
   DynamicMultiplierTooltip: "這個倍數是動態的——它不會影響工人和存儲",
   Dynamite: "炸藥",
   DynamiteWorkshop: "炸藥工廠",
   DysonSphere: "戴森球(Dyson Sphere)",
   DysonSphereDesc: "所有建築物都獲得+5 生產倍數。這個奇蹟可以升級，每次額外升級都會為所有建築物提供 +1 生產倍數",
   EasterBunny: "復活節兔子",
   ...
   Egyptian: "埃及",
   EiffelTower: "巴黎鐵塔",
   EiffelTowerDesc: "所有相鄰煉鋼廠，獲得 +N 生產、儲存以及工人倍數。 N 取決於其相鄰煉鋼廠數量",
   ...
   EuphratesRiverDesc: "每 10% 從事生產（非運輸）的忙碌工人為所有不生產工人的建築物提供 +1 生產倍數（最大值 = 解鎖時代數 / 2）。當旁邊建造空中花園時，空中花園解鎖後每個時代 獲得+1效果。發現後，在所有相鄰的沒有沉積物的方塊上產生水",
   ...
   ForbiddenCity: "紫禁城",
   ForbiddenCityDesc: "所有造紙廠、作家公會以及印刷廠， 獲得 +1 生產倍數、工人能力倍數以及儲存倍數。與北京的奇觀萬里長城有搭配效果",
   Forex: "外匯",
   ForexMarket: "外匯市場",
   FrankLloydWright: "法蘭克·洛伊·萊特",
   FrankLloydWrightDesc: "+%{value}建造者能力倍數",
   ...
   German: "德國",
   GiantOtter: "水獺自然保護區",
   GiantOtterDesc: "周圍 2 地塊範圍內的所有建築獲得 +X 生產倍數。X = 該奇觀範圍內空白地塊數量",
   Glass: "玻璃",
   GlassFrog: "玻璃蛙自然保護區",
   GlassFrogDesc: "周圍 3 地塊範圍內的所有建築獲得 +X 存儲倍數。X = 該奇觀範圍內空白地塊數量",
   Glassworks: "玻璃工廠",
   ...
   GoldenGateBridgeDesc: "所有 發電廠 生產倍數+1。鄰近2格地塊供電(電力連接)",
   GoldenPavilion: "金閣寺",
   ...
   GreatSphinx: "獅身人面像",
   GreatSphinxDesc: "範圍 2 格內所有二階或以上建築 +N 消耗、生產能力倍數，N = 與受益建築相鄰的同類建築數量。",
   GreatWall: "萬里長城",
   GreatWallDesc: "範圍 1 格內所有建築 +N 生產、工人能力和儲存倍數，N = 當前科技時代 與 建築所屬時代 所相差的值，若與<b>紫禁城</b>相鄰，地塊範圍增加至 2 格",
   ...
   Hammurabi: "漢摩拉比",
   HangingGarden: "空中花園",
   HangingGardenDesc: "+1 建造者能力倍數。相鄰水渠獲得 +1 生產、儲存以及工人能力倍數",
   Happiness: "幸福感",
   ...
   HatshepsutTempleDesc: "完成建造時，地圖顯現所有水資源地塊。與小麥農場相鄰的每個含水資源地塊，使小麥農場獲得 +1 生產倍數",
   Headquarter: "總部",
   ...
   Herodotus: "希羅多德",
   HideSpinner: "顯示轉輪指示",
   HideSpinnerDescHTML: "關閉將隱藏建築運轉的轉輪指示。<b>這應該不會影響性能</b>>",
   HighlightBuilding: "高亮 %{building}",
   HighlightMoreBuildings: "高亮更多貿易地塊加成",
   HimejiCastle: "姬路城",
   HimejiCastleDesc: "所有輕快帆船船塢、大帆船船塢以及護衛艦船塢，獲得 +1 生產倍數、工人能力倍數以及儲存倍數",
   Hoatzin: "麝雉自然保護區",
   ...
   InternationalSpaceStationDesc: "所有建築物都獲得 +5 儲存倍數。這個奇蹟可以升級，每次額外升級都會為所有建築物提供 +1 儲存倍數",
   Internet: "網路",
   ...
   IsidoreOfMiletusDesc: "+%{value} 建造者能力倍數",
   Islam5UpgradeHTML: "解鎖時獲得科學，數量等同於解鎖<b>工業時代</b>最昂貴科技所需",
   IslamLevelX: "伊斯蘭教 %{level}",
   ItaipuDam: "伊泰普大壩",
   ItaipuDamDesc: "該奇觀可被升級，並且每一次額外升級，為周圍 2 地塊範圍的建築提供 +1 生產倍數或 +1 額外建築等級（可自由分配每+1加成）。為周圍 2 地塊範圍提供電力。",
   ...
   LighthouseOfAlexandriaDesc: "所有相鄰建築，獲得 +5 儲存倍數",
   LinusPauling: "萊納斯·鮑林",
   ...
   LouisSullivanDesc: "+%{value} 建造者能力倍數",
   Louvre: "盧浮宮",
   ...
   ManhattanProjectDesc: "所有鈾礦生產、工人和儲存能力倍數 +2 。與鈾礦相鄰的鈾濃縮場與原子能設施的生產倍數 +1 ",
   Marble: "石雕",
   Marbleworks: "石雕鋪",
   MarcoPolo: "馬可·波羅",
   MarieCurie: "瑪麗·居禮(居禮夫人)",
   MarinaBaySands: "濱海灣金沙酒店(Marina Bay Sands)",
   MarinaBaySandsDesc: "所有建築物均獲得 +5 工人能力倍數。這個奇蹟可以升級，每次額外升級都會為所有建築物提供 +1 工人能力倍數",
   Market: "市場",
   ...
   MotionPicture: "電影",
   MountArarat: "亞拉拉特山",
   MountAraratDesc: "周圍 2 地塊範圍內所有的建築，獲得 +X 生產、勞動者能力以及存儲倍數。X = 有效偉人等級的立方根",
   MountFuji: "富士山",
   MountFujiDescV2: "當佩特拉古城建造在旁邊時，佩特拉古城獲得 +8h 時間扭曲儲存。當遊戲運行時，每分鐘在佩特拉古城生成 20 時間扭曲（不受佩特拉古城本身加速影響，離線時不生效）",
   MountSinai: "西奈山",
   MountSinaiDesc: "當被發現時，根據帝國所處時代誕生一位偉人。所有產出信仰的建築獲得 +5 儲存倍數",
   MountTai: "泰山",
   MountTaiDesc: "所有產生科學的建築獲得 +1 生產倍數。 孔子(偉人)效果加倍。當被發現時，一次性獲得等同解鎖最昂貴科技所需的科學點數",
   MoveBuilding: "移動建築",
   ...
   Neighbor: "相鄰玩家",
   Neighbors: "相鄰玩家",
   NeighborsDescHTMLV2: "對於每個相鄰玩家擁有的地塊，你得到<b> +%{neighbor} 生產倍數的貿易地塊加成</b>，對於每個盟友擁有的地塊，你得到<b> +%{ally} 生產倍數的貿易地塊加成</b>。要成為相鄰玩家的盟友，請遊玩與他們相同的文明",
   NeilArmstrong: "尼爾·阿姆斯壯",
   Neuschwanstein: "新天鵝堡",
   NeuschwansteinDesc: "建造奇觀時 +10 建造者能力倍數",
   Newspaper: "報紙",
   NextExplorersIn: "探險家誕生剩餘時間",
   NextMarketUpdateIn: "市場刷新剩餘時間",
   NiagaraFalls: "尼加拉大瀑布",
   NiagaraFallsDescV2: "所有倉庫、市場和商隊都獲得 +N 儲存倍數。 N = 已解鎖時代數。愛因斯坦為研究基金提供 +1 生產倍數(不受百老匯等其他增益效果影響)",
   NielsBohr: "尼爾斯·波耳",
   NielsBohrDescV2: "+%{value} 來自所有工人的科學，如果超過 50% 的工人忙碌且少於 50% 的忙碌工人從事交通運輸工作",
   NileRiver: "尼羅河",
   NileRiverDesc: "哈特謝普蘇特(偉人)效果加倍。所有小麥農場獲得 +1 生產、儲存倍數。相鄰小麥農場獲得 +5 生產、儲存倍數",
   ...
   Pantheon: "萬神殿",
   PantheonDescV2: " 2 地塊範圍內的所有建築獲得 +1 工人能力與儲存倍數。產生的科學基於所有神社的信仰總產出",
   Paper: "紙張",
   PaperMaker: "造紙廠",
   Parliament: "議會",
   Parthenon: "帕德嫩神殿",
   ...
   Persepolis: "波斯波利斯",
   PersepolisDesc: "所有銅礦、伐木場以及採石場 +1 生產倍數、工人能力倍數、儲存倍數",
   PeterHiggs: "彼得·希格斯",
   ...
   PygmyMarmosetDesc: "周圍 3 地塊範圍內的所有建築獲得 +X 存儲倍數。X = 該奇觀範圍內空白地塊數量",
   PyramidOfGiza: "吉薩金字塔",
   PyramidOfGizaDesc: "所有產出工人的建築，獲得 +1 生產倍數",
   QinShiHuang: "秦始皇",
   Radio: "收音機",
   RadioStation: "廣播電台",
   Railway: "鐵路",
   RamessesII: "拉美西斯二世",
   RamessesIIDesc: "建造者能力倍數 +%{value}",
   RandomColorScheme: "隨機配色方案",
   RapidFire: "速射",
   ReadFullPatchNotes: "開啟網頁，閱讀更新說明",
   ReadPatchNotesHTML: "您已經更新到 <b>%{version}</b> (<b>%{build}</b>)，請閱讀<b>Steam</b>的補丁說明",
   Rebar: "鋼筋",
   RebarPlant: "鋼筋工廠",
   ...
   RequiredWorkersTooltipV2: "生產所需的工人數量等於倍數後消耗和生產的所有資源的總和（不包括動態倍數）",
   RequirePower: "需要供電",
   ...
   ResourceCloneTooltip: "生產倍數僅適用於克隆資源（即額外副本）",
   ResourceColor: "資源色彩",
   ...
   Rifling: "膛線",
   Rijksmuseum: "國家博物館",
   RijksmuseumDesc: "+5 幸福感。所有消耗或產出文化的建築，獲得 +1 生產、儲存以及工人能力倍數",
   RoadAndWheel: "土木工程學",
   RobertNoyce: "勞勃·諾伊斯",
   Robocar: "無人車(Robocar)",
   ...
   RurikDesc: "幸福感 +%{value}",
   SagradaFamilia: "聖家堂",
   SagradaFamiliaDesc: "鄰近 2 格建築 +N 生產、工人和儲存倍數。 N = 相鄰建築的最大階級差",
   SaintBasilsCathedral: "瓦西里升天教堂",
   SaintBasilsCathedralDescV2: "與資源地塊相鄰的採集建築可進行生產。相鄰的 I 階建築生產、儲存、工人能力倍數增加 +1",
   Saladin: "薩拉丁",
   Samsuiluna: "薩姆蘇·伊路那",
   Sand: "沙",
   Sandpit: "採沙坑",
   ...
   ShowFloaterText: "顯示地塊產量指示",
   ShowFloaterTextDescHTML: "關閉將隱藏地塊產量指示。將其關閉可能會略微提高性能。",
   ...
   Spinner: "轉輪",
   SpinnerSpeed: "轉輪速度",
   SpinnerSpeedDescHTML: "調整轉輪指示的速度，作為區分電氣化的建築轉輪指示速度為兩倍。<b>調整值必須位於0.01到100之間。默認值為1</b>（調整轉輪指示的速度不會影響每週期生產）",
   Sports: "體育運動",
   Stable: "馬廄",
   Stadium: "體育場",
   StartFestival: "節慶狂歡！",
   ...
   StatueOfLibertyDesc: "所有相鄰建築，獲得 +N 生產、儲存以及工人能力倍數。 N = 相鄰同類型建築數量",
   StatueOfZeus: "宙斯神像",
   StatueOfZeusDesc: "在相鄰的空地塊隨機產生並顯現沉積資源。所有相鄰 I 階建築 +5 生產以及儲存倍數",
   ...
   StoneAge: "石器時代",
   Stonehenge: "巨石陣",
   StonehengeDesc: "所有消耗或產出石頭的建築，獲得 +1 生產倍數",
   StoneQuarry: "採石場",
   StoneTool: "石器",
   StoneTools: "岩石",
   Storage: "儲存空間",
   StorageBaseCapacity: "基礎儲存能力",
   StorageMultiplier: "儲存倍數",
   StorageUsed: "已用儲存空間",
   StPetersBasilica: "聖彼得大教堂",
   StPetersBasilicaDescV2: "所有教堂獲得 +5 儲存倍數。其產生的科學，基於所有教堂的信仰總產出",
   Submarine: "潛水艇",
   SubmarineYard: "潛水艇工廠",
   SuleimanI: "蘇萊曼一世",
   SummerPalace: "頤和園",
   SummerPalaceDesc: "所有消耗或產出火藥的相鄰建築，免除 -1 幸福感。所有消耗或產出火藥的建築，獲得 +1 生產、儲存以及工人能力倍數",
   ...
   SwissBank: "瑞士銀行",
   SwissBankDescV3: "從所有可與玩家交易的資源（旅館存儲和聯動的倉庫存儲）中選擇一種資源轉換為💵瑞士貨幣。每個週期基礎產出1個💵瑞士貨幣（可被生產倍數影響），該奇觀可被升級，並且每一次額外升級增加 1 基礎產出（無論基礎產出提升還是生產倍數提升都只是提升每週期等價兌換最大總數量）。瑞士銀行可以存儲無限量的💵瑞士貨幣",
   Sword: "劍",
   SwordForge: "鑄劍廠",
   ...
   Synthetics: "合成材料",
   TajMahal: "泰姬瑪哈陵",
   TajMahalDescV2: "建造完成時，誕生古典和中世紀各一位偉人。 升級 20 級以上的建築時 +5 建造者能力倍數",
   TangOfShang: "商湯",
   TangOfShangDesc: "閒置工人產出科學 +%{value}",
   Tank: "坦克",
   TankFactory: "坦克工廠",
   TechAge: "時代",
   TechGlobalMultiplier: "倍數",
   ...
   TempleOfArtemisDesc: "當完成建造時，所有鑄劍廠與軍火庫，獲得 +5 等級。所有鑄劍廠與軍火庫，獲得 +1 生產倍數、工人能力倍數以及儲存倍數",
   TempleOfHeaven: "天壇",
   TempleOfHeavenDesc: "所有等級 10 或更高的建築 +1 工人能力倍數",
   TempleOfPtah: "卜塔神殿",
   TerracottaArmy: "兵馬俑",
   TerracottaArmyDesc: "所有鐵礦 +1 生產倍數、工人能力倍數以及儲存倍數。與鐵鍛鋪相鄰的每個含鐵資源地塊的鐵礦，使鐵鍛鋪獲得 +1 生產倍數",
   Thanksgiving: "感恩節：華爾街對建築物的提升效果加倍，並適用於共同基金、對沖基金和比特幣礦工，華爾街為所有研究基金會提供 +5 生產倍數",
   Theater: "劇院",
   Theme: "主題",
   ...
   ThePentagon: "五角大廈",
   ThePentagonDesc: "建造完成後，產生可用於移動建築的傳送者。 2 格範圍內的所有建築 +1 生產、工人容量和儲存倍數",
   TheWhiteHouse: "白宮",
   ...
   Tool: "工具",
   TopkapiPalace: "托普卡帕宮",
   TopkapiPalaceDesc: "周圍 2 地塊範圍內的所有建築，獲得 +X 存儲倍數。X = 被加成建築的 50% 生產倍數（不包括動態倍數）",
   ...
   TowerOfBabelDesc: "為所有至少有一座工作建築毗鄰奇蹟的建築提供 +2 生產倍數",
   ...
   TransportCapacityMultiplier: "運送能力倍數",
   ...
   UNGeneralAssemblyMultipliers: "<b>+%{count}</b> 生產、工人和儲存能力倍數對於 <b>%{buildings}</b>",
   UNGeneralAssemblyNext: "即將召開的聯合國大會 #%{id}",
   UNGeneralAssemblyVoteEndIn: "您可以在<b>%{time}</b>投票結束之前隨時更改投票",
   UniqueBuildings: "獨特建築",
   UniqueTechMultipliers: "獨特技術倍數",
   UnitedNations: "聯合國",
   UnitedNationsDesc: "所有 IV、V 和 VI 階級建築，生產、工人和儲存能力倍數 +1。 參加聯合國大會並每週投票支持額外獎勵",
   University: "大學",
   ...
   WallStreet: "華爾街",
   WallStreetDesc: "所有在 2 格範圍內生產硬幣、紙幣、債券、股票和外匯的建築都獲得 +N 生產倍數。 N = 1 到 5 之間的隨機值，每個建築都不同，並且隨著每次市場刷新而變化。約翰·D·洛克菲勒的影響加倍",
   WaltDisney: "華特·迪士尼",
   Warehouse: "倉庫",
   ...
   Wood: "原木",
   Worker: "工人",
   WorkerCapacityMultiplier: "工人能力倍數",
   WorkerHappinessPercentage: "幸福倍數",
   WorkerMultiplier: "工人能力",
   WorkerPercentagePerHappiness: "每點幸福感提供 %{value}% 倍數",
   Workers: "工人",
   WorkersAvailableAfterHappinessMultiplier: "可獲工人(幸福倍數後)",
   WorkersAvailableBeforeHappinessMultiplier: "可獲工人(幸福倍數前)",
   WorkersBusy: "忙碌工人",
   ...
   Writing: "文字",
   WuZetian: "武則天",
   WuZetianDesc: "運送能力倍數 +%{value}",
   Xuanzang: "玄奘",
   YangtzeRiver: "長江",
   YangtzeRiverDesc: "所有消耗水的建築獲得 +1 生產、工人能力和儲存倍數。鄭和(偉人)效果加倍。武則天(偉人)每升一級為所有建築提供+1儲存倍數。與黃鶴樓(奇觀)具搭配效果",
   YearOfTheSnake: "巳蛇",
   ...
   YellowCraneTowerDesc: "選擇偉人時 +1 選擇。 1 格範圍內的所有建築能獲得 +1 生產倍數、工人容量和儲存倍數。若建造在長江旁，範圍增加到 2 格",
   YuriGagarin: "尤里·加加林",
   ZagrosMountains: "札格羅斯山脈(Zagros Mountains)",
   ZagrosMountainsDesc: "所有生產倍數低於 5 的鄰近建築物都獲得 +2 生產倍數。尼布甲尼撒二世（偉人）效果加倍",
   ZahaHadid: "札哈·哈蒂",
   ZahaHadidDesc: "+%{value} 建造者能力倍數",
   Zenobia: "澤諾比亞",
   ZenobiaDesc: "+%{value}小時佩特拉古城扭曲時間儲存上限",
   ZhengHe: "鄭和",
   ZigguratOfUr: "烏爾金字形神塔(Ziggurat of Ur)",
   ZigguratOfUrDescV2: "每 10 點幸福感（上限）為所有不生產工人的建築提供 +1 生產倍數，前提是該建築在以前的時代已解鎖（最大值 = 解鎖的時代數 / 2）。奇觀（包括自然奇觀）不再提供 +1 快樂度。該效果可被關閉",
