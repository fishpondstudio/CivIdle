export const ZH_TW = {
   ...
   GreatBarrierReefDesc: "每正向幸福感（最大值為 50 ）獲得 +0.2*N 忙碌勞動者科學產出和 +0.1*N 閒置勞動者科學產出。 N 為已解鎖時代數量",
   ...
   UndoAll: "撤銷所有",
   UndoUpgradesForAllPermanentGreatPeopleThatAreEligibleForAgeWisdom: "撤銷所有具備資質的永恆偉人升級",
   ...
   UpgradeAllPermanentGreatPeopleThatAreUpgradeable: "升級所有可升永恆偉人",
   UpgradeBuilding: "升級",
