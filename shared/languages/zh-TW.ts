export const ZH_TW = {
   ...
   EuphratesRiverDesc:
      "每 10% 從事生產（非運輸）的忙碌工人為所有不生產工人的建築物提供 +1 生產乘數（最大值 = 解鎖年齡數 / 2）。當旁邊建造空中花園時，空中花園解鎖後每個年齡層獲得+1效果。發現後，在所有相鄰的沒有沉積物的方塊上產生水",
   ...
   WallOfBabylonDesc: "所有建築物都獲得+N儲存倍增。 N = 解鎖年齡數/2",
   WallStreet: "華爾街",
   ...
   ZigguratOfUrDesc: "每 10 點幸福感（上限）為所有建築物提供 +1 生產乘數（最大值 = 解鎖年齡數 / 2）。奇蹟（包括大自然）不再提供 +1 幸福值。效果可以關閉",
