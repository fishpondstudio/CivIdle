export const ZH_TW = {
   ...
   EachPairOfAdjacentPaintingsByTheSamePainter: "每相鄰相同畫家的畫作獲得 +1 生產乘數",
   EachPairOfAdjacentPaintingsOfTheSameSize: "每相鄰相同尺寸的畫作獲得+1 生產等級",
   EachPairOfAdjacentPaintingsPaintedInTheSameCentury: "每相鄰同一世紀（100 年）內畫作獲得 +5 幸福感",
   EachPairOfAdjacentPaintingsWithTheSameTheme: "每相鄰相同主題的畫作獲得 +5 建造者乘數",
   EasterBunny: "復活節兔子",
   ...
   Knight: "騎士",
   KnightCamp: "騎士營地",
   KoningsdagV2: "國王節：庫肯霍夫公園為範圍內的所有建築提供 +N 生產乘數，N 為庫肯霍夫公園提供幸福感的一半。莫瑞泰斯皇家美術館的展覽畫家作品獎勵和展覽多元化獎勵提供雙倍加成",
   Koti: "💵瑞士貨幣",
   KotiInStorage: "已存儲",
   KotiProduction: "💵瑞士貨幣",
   Kremlin: "克里姆林宮",
