export const ZH_TW = {
   ...
   BecomeAllyTooltip: "要成為相鄰玩家的盟友，請選擇與他們相同的旗幟（地球旗幟除外）",
   BigBen: "大笨鐘",
   ...
   CathedralOfBrasiliaDesc: "如果周圍 2 地塊範圍的每個建築形成一個完整的生產鏈（下游各分支也計入在內），即一個建築生產的資源被另一個建築消耗，那麼該完整生產鏈中的參入每種建築同類型都獲得 +X 生產乘數。X = 生產鏈的總長度",
   ...
   Carnival: "嘉年華：水豚，巨水獺，麝雉和皇冠鹟的範圍增加至周圍 3 地塊範圍。巴西利亞大教堂雙倍加成效果",
   Census: "人口普查",
   ...
   Hoatzin: "麝雉",
   HoatzinDesc: "周圍 2 地塊範圍內的所有建築獲得 +X 建築等級。 X = 該奇觀範圍內空白地塊數量",
   Hollywood: "好萊塢",
   ...
   Neighbors: "相鄰玩家",
   NeighborsDescHTML:
      "對於每個相鄰玩家擁有的地塊，你得到<b> +%{neighbor} 生產乘數的貿易地塊加成</b>，對於每個盟友擁有的地塊，你得到<b> +%{ally} 生產乘數的貿易地塊加成</b>。要成為相鄰玩家的盟友，請選擇與他們相同的旗幟（地球旗幟除外）",
   Neuschwanstein: "新天鵝堡",
   ...
   RomanForum: "古羅馬議院廣場",
   RoyalFlycatcher: "皇冠鹟",
   RoyalFlycatcherDesc: "周圍 2 地塊範圍內的所有建築獲得 +X 建築等級。 X = 該奇觀範圍內空白地塊數量",
