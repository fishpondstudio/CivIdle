export const ZH_TW = {
   ...
   AdvisorElectricityContentV2:
      "發電廠建築為你提供了兩種新系統。第一種是「電力」，與電廠相鄰地塊以閃電圖示顯示。一些建築物（如世界大戰時期的建築廣播電台）在其輸入列表中會顯示「需要電力」的指示。<b>這意味著它們必須建在具有閃電圖示的地塊上才能運作</b>。需要電力的建築物如果有電力支持，也會將電力傳輸到該建築物相鄰的地塊，因此只要有一個建築物接觸到電廠，其它建築物就可以彼此供電。<br><br>另一個系統是「電氣化」，只要不是生產科學或工人的建築物，就可以將其應用到<b>地圖上的任何建築物</b>。這會消耗電廠產生的電力，以增加建築物的消耗和生產。更高的電氣化等級需要消耗越來越多的電力。對「需要電力」的建築物可以從電氣化中獲得額外的 +5 建築等級。",
   ...
   ElectrificationStatusDesc: "需要與不需要電力的建築都可以電氣化。然而，需要電力的建築可以從電氣化中獲得額外的 +5 建築等級。",
   ...
   LiberalismLevel5DescHTMLV2: "所有可電氣化的建築獲得額外<b> +5 建築等級</b>",
