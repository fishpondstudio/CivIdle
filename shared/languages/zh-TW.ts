export const ZH_TW = {
   ...
   GreatWall: "萬里長城",
   GreatWallDescV2: "周圍 1 地塊範圍內所有建築，獲得 +N 生產、勞動者能力以及存儲乘數。 N 為當前科技時代與建築所屬時代之間的差值。該奇觀可被升級，並且每一次額外升級為長城周圍擴大 1 地塊範圍。當與紫禁城相鄰時，則長城周圍擴大 1 地塊範圍",
   ...
   ParliamentHill: "國會山",
   Parthenon: "帕德嫩神殿",
   ParthenonDescV3: "每一級誕生兩位古典時代偉人，每位偉人有 4 項可選。所有音樂家協會與畫家協會，獲得 +1 生產、勞動者能力以及存儲乘數，並免去 -1 幸福感",
   Passcode: "一次性密碼",
   ...
   YellowCraneTowerDescV2: "選擇偉人時 +1 可選項。每一級為周圍 2 地塊範圍內的所有建築提供 +1 生產、勞動者能力以及存儲乘數。當與長江相鄰時，則黃鶴樓周圍擴大 2 地塊範圍",
   YouAreOffline: "您已離線",
