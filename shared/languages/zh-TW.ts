export const ZH_TW = {
   ...
   SwissBank: "瑞士銀行",
   SwissBankDescV3: "從所有可與玩家交易的資源（旅館和聯動的倉庫）中選擇一種資源轉換為💵瑞士貨幣。每個週期基礎產出1個💵瑞士貨幣（可被生產乘數影響），該奇觀可被升級，並且每一次額外升級增加 1 基礎產出（無論基礎產出提升還是生產乘數提升都只是提升每週期等價兌換最大總數量）。瑞士銀行可以存儲無限量的💵瑞士貨幣",
   Sword: "劍",
   SwordForge: "鑄劍廠",
