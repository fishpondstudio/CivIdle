export const ZH_TW = {
   ...
   GreatPeopleBirthdayDesc: "今天是以下偉人的誕辰: %{names} ——此生偉人與永恆偉人的效果翻倍！",
   ...
   GreatSphinx: "獅身人面像",
   GreatSphinxDescV2: "範圍 2 格內所有二階或以上建築 +N 生產乘數，N = 與受益建築相鄰的相同建築數量。",
   GreatWall: "萬里長城",
   ...
   Literature: "文學",
   LiveData: "實時數據",
   LockTradeProfit: "鎖定貿易利潤率（送出訂單者的收益）",
   ...
   OpetV2: "歐佩特：獅身人面像額外为範圍 2 格內所有二階或以上建築 +N 生產等級，N = 與受益建築相鄰的相同建築數量。",
   OpticalFiber: "光纖",
...
   RebirthHistoryExtraGreatPeopleAtRebirth: "重生時的額外偉人",
   ...
   TodayIsTheBirthdayOfX: "今天是 %{name} 的誕辰——此生偉人與永恆偉人的效果翻倍！",
   TodoTabs: "待處理提示",
