export const ZH_TW = {
   ...
   LumberMill: "鋸木場",
   LuxorTemple: "盧克索神殿",
   LuxorTempleDescV2: "+1 忙碌工人科學產出。選擇帝國宗教來解鎖更多增益效果",
   Machinery: "機械",
   Magazine: "雜誌",
   ...
   ScrollSensitivityDescHTML: "滾動滑鼠滾輪時調整靈敏度。<b>必須在0.01到100之間。預設爲1</b>",
   ...
   TribuneUpgradeDescV3:
      "若不打算使用線上功能，您可以以<b>軍官</b>身分獲得完整離線遊戲體驗，需要升級到<b>財務官</b>以使用線上功能，。 <b>這是一種反機器人措施，旨在讓每個人都可以免費玩遊戲。</b>但是，<b>升級到財務官</b> 後，您可以繼承偉人：<ul><li>青銅、鐵器和古典時代<b>3</b> 最高等級</li><li>中世紀、文藝復興和工業時代 <b>2</b> 最高等級</li><li>世界大戰、冷戰和資訊時代 <b>1</b> 最高等級</li></ul>超過該級別的部分無法結轉。",
   TurnOnTimeWarpDesc: "每秒消耗 %{speed} 扭曲時間，同時加速你的帝國，使其以 %{speed} 倍速度運行。",
   Tutorial: "新手教學",
   Tutorial1:
      "歡迎使用 CivIdle 安裝設定。(譯者：若翻譯存疑，請參考英文版。若欲修改、更新翻譯，可在Discord上反饋問題並提出意願，歡迎更多人加入翻譯！)<br><br>    在遊戲中，你將經營你自己的帝國城市：管理生產、解鎖科技、與其他玩家開展資源貿易、獲得偉人相助以及修建世界奇觀。<br><br>    使用滑鼠進行移動，使用滾輪放大或縮小，單擊空地塊建造新建築，單擊建築來查看詳細資訊。<br><br>",
   Tutorial2: "我沒有玩過類似遊戲，我願意通讀一篇簡短新手教學。(譯者：前作玩家初次接觸此遊戲，可速讀了解基礎框架。)",
   Tutorial3: "我玩過 Industry Idle ，跳過基礎新手教學。",
   Tutorial4:
   ...
   Tutorial5:
      "    <b>科學</b>被用來在科技樹中解鎖科技。科技研究可能解鎖新的建築、奇觀以及提供增益。<br><br>    <b>忙碌工人</b>可產出少量科學，隨著發展，你將解鎖一些能產出科學的建築(比如圖書館與學校)。<br><br>    可獲工人數量受到<b>幸福感</b>的影響。每座建築將會消耗 1 幸福感。你也可以從科技、奇觀以及偉人獲得幸福感。確保你麾下工人們的幸福，否則你帝國的生產將陷入停止。<br><br>    <b>奇觀</b>是獨一無二的建築，你只能建造一座，並且它們一旦建成將不能被移除。奇觀可以提供顯著增益或者解鎖新的機制。",
   Tutorial6:
   ...
   TutorialAdvices:
      "我們向經驗豐富的玩家徵求他們對新手玩家的建議。在深入遊戲前，這裏有一些有用的內容。<ol><li><b>不要同時升級你的所有建築</b>: 建築在升級過程中會停止生產</li><li><b>注意幸福感</b>: 幸福感將影響工人數量，若幸福感達到 -50, 所有生產將會停止</li><li><b>不要過度擴張</b>: 建築運行會使用幸福感，在擴張之前確保擁有足夠的幸福感</li><li><b>提高生產工人建築的優先等級</b>: 將這些建築設定為高優先級以確保工人充足</li><li><b>隨時隨地都可以重生</b>: 如果把把當前這一輪搞砸了，可以隨時重生，重新開始新一輪遊戲就好。</li></ol>",
