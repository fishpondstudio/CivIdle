export const ZH_TW = {
   ...
   Blockchain: "區塊鏈",
   BlueMosque: "藍色清真寺",
   BlueMosqueDesc: "該奇觀使所有奇觀（自然奇觀除外）為相鄰的所有建築提供 +1 生產、勞動者能力以及存儲乘數。當與聖索菲亞大教堂相鄰時該奇觀雙倍加成效果",
   BobHope: "鮑伯·霍伯",
   ...
   Capitalism: "資本主義",
   Cappadocia: "卡帕多西亞",
   CappadociaDesc: "周圍 3 地塊範圍內所有的建築，當建築等級超過 30 時，超過的每個等級獲得 +1 生產、勞動者能力以及存儲乘數",
   Capybara: "水豚自然保護區",
   ...
   GrottaAzzurraDescV2: "被發現時，所有您的 I 級建築物獲得 +5 等級以及 +1 生產、工人容量和儲存乘數",
   Gunpowder: "火藥",
   GunpowderMill: "火藥廠",
   ...
   LargeHadronColliderDescV3: "所有資訊時代的偉人（包括未擁有過的）額外獲得 +2 等級。該奇觀可被升級，並且每一次額外升級，為所有資訊時代的偉人（包括未擁有過的）提供 +1 等級（不包括給與奇觀額外等級的資訊時代偉人）",
   Law: "法律",
   LeeKuanYew: "李光耀",
   Lens: "鏡頭",
   LensWorkshop: "鏡頭工廠",
   ...
   MontSaintMichelDesc: "從閒置勞動者處產生額外的文化值。為 2 格範圍內的所有建築物提供 +1 的儲存加成乘數。此奇觀可使用所產生的文化進行升級，每次額外升級都會為 2 格範圍內的所有建築物額外提供 +1 的儲存加成乘數。",
   ...
   Parliament: "議會",
   Parthenon: "帕德嫩神殿",
   ParthenonDescV2: "兩位古典時代偉人誕生，每位將有 4 個選項提供選擇。所有音樂家、畫家公會的生產、儲存乘數 +1，並免除 -1 幸福感",
   Passcode: "一次性密碼",
   ...
   Petra: "佩特拉古城",
   PetraDescV2: "解鎖更高扭曲倍速，該奇觀可以升級，每一級提供1小時的扭曲存儲。當你離線時生成扭曲時間，你可以用來加速你的帝國",
   ...
   Poseidon: "海神波塞頓",
   PoseidonDescV2: "所有相鄰建築獲得等級 25 的免費升級和 +N 生產、工人容量與儲存乘數（N = 建築等級）",
   PoultryFarm: "家禽農場",
   Power: "電力",
   PowerAvailable: "可用電力",
   PoweredBuilding: "電力",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDesc: "建造完成後，誕生一個之前時代的偉人。該奇觀可被升級，並且每一次升級都會誕生一個之前時代的偉人。當從這座奇觀進行偉人選擇時，每位偉人有 4 項可選。",
   ...
   RedFort: "紅堡",
   RedFortDesc: "周圍 4 地塊範圍內的所有建築獲得 +5 額外建築等級。該奇觀可被升級，並且每一次額外升級為周圍 4 地塊範圍內的所有建築額外提供 +1 額外建築等級",
   ...
   UnitedNations: "聯合國",
   UnitedNationsDescV2: "所有 IV、V 和 VI 階級建築，生產、工人和儲存能力乘數 +1。 參加聯合國大會並每週投票支持額外獎勵。該奇觀可被升級，並且每一次額外升級為額外的獎勵 +1 生產乘數",
   University: "大學",
   ...
   Xuanzang: "玄奘",
   YangtzeRiver: "長江",
   YangtzeRiverDesc: "所有消耗水的建築獲得 +1 生產、工人能力和儲存乘數。鄭和(偉人)效果加倍。武則天(偉人)每升一級為所有建築提供+1儲存乘數。與黃鶴樓(奇觀)具搭配效果",
   YearOfTheSnake: "巳蛇",
