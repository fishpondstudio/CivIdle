export const ZH_CN = {
   ...
   EachPairOfAdjacentPaintingsByTheSamePainter: "每相邻相同画家的画作获得 +1 生产乘数",
   EachPairOfAdjacentPaintingsOfTheSameSize: "每相邻相同尺寸的画作获得+1 生产等级",
   EachPairOfAdjacentPaintingsPaintedInTheSameCentury: "每相邻同一世纪（100 年）内画作获得 +5 幸福感",
   EachPairOfAdjacentPaintingsWithTheSameTheme: "每相邻相同主题的画作获得 +5 建造者乘数",
   EasterBunny: "复活节兔子",
   ...
   GreatSphinx: "狮身人面像",
   GreatSphinxDescV2: "周围 2 地块范围，所有 II 阶及以上建筑，获得 +N 生产乘数（ N 为其相邻相同建筑数量）",
   GreatWall: "长城",
   ...
   Keukenhof: "库肯霍夫公园",
   KeukenhofDesc: "+N 幸福感。N 为周围 2 地块范围内的所有建筑生产或消耗的不相同资源种类",
   KingDavid: "大卫王",
   KizhiPogost: "基日乡村教堂",
   KizhiPogostDescV2: "周围 3 地块范围内的所有建筑获得 +N 生产乘数，N 为该奇观获得的生产乘数（生产乘数可来自：戴森球、蓬皮杜文艺中心、圣家族大教堂等通用加成奇观）",
   Knight: "骑士",
   KnightCamp: "骑士营地",
   Koningsdag: "国王节：库肯霍夫公园周围扩大 2 地块范围。莫瑞泰斯皇家美术馆的展览画家作品奖励和展览多元化奖励提供双倍加成",
   Koti: "💵瑞士货币",
   KotiInStorage: "已存储",
   KotiProduction: "💵瑞士货币",
   Kremlin: "克里姆林宫",
   ...
   Midsummer: "仲夏节",
   MidsummerDesc: "为周围 Y 块地范围内的所有建筑提供 +N 生产等级。N 为该建筑获得时代智慧的生产乘数数值，Y 为仲夏节等级。该奇观仅可仲夏期间（6 月 10 日至 6 月 30 日）建造。",
   ...
   OpetV2: "欧佩特：狮身人面像额外为周围 2 地块范围，所有 II 阶及以上建筑，提供 +N 生产等级（ N 为其相邻相同建筑数量）",
   OpticalFiber: "光纤",
