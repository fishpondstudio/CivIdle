export const ZH_TW = {
   ...
   CathedralOfBrasiliaDesc:
      "如果周圍 2 地塊範圍的每個建築形成一個完整的生產鏈，即範圍內一個建築生產的資源被範圍內另一個建築消耗（範圍當中相同產出不同建築也會被歸入完整的生產鏈中），那麼參入該完整的生產鏈中的每種建築為其所有同類型建築提供 +X 生產乘數。X = 生產鏈的總長度（建築種類數量，最大值為18。奇觀、旅館、倉庫、市場、克隆工廠和克隆實驗室除外）",
   ...
   Sports: "體育運動",
   Sputnik1: "伴侶號",
   Sputnik1Desc: "該奇觀可被升級，每一級為所有冷戰時代的偉人（包括未擁有過的）提供 +1 等級的本次運行效果（不包括奇觀偉人）。",
   Stable: "馬廄",
   Stadium: "體育場",
   StartFestival: "節慶狂歡！",
   Stateship: "村鎮",
