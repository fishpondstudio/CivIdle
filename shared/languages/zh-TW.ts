export const ZH_TW = {
   ...
   EastIndiaCompanyDescV2: "當您通過貿易獲得的所有物品都會獲得相應貿易點數（包括稅收，物品的每 1 價值 = 1 貿易點數）。該奇觀累積您獲得的貿易點數。每週期自動消耗 2000 貿易點數，使所有建築每相鄰一個運轉的商隊旅館獲得 +0.5 生產乘數。該奇觀可消耗貿易點數進行升級，並且每一次額外升級獲得 +0.5 生產乘數",
   Education: "教育學",
