export const ZH_TW = {
   ...
   Petra: "佩特拉古城",
   PetraDescV3: "解鎖更多扭曲倍速和扭曲時間繼承。該奇觀可以升級，每一級提供 1 小時的扭曲存儲。當你離線時生成扭曲時間，你可以用來加速你的帝國或攜帶最多 4 小時（14.4K）扭曲時間到重生後的地圖（可在右上角的選項-遊戲設置-離線生產欄裏分配離線設置）",
   ...
   SuperintelligenceDescV3: "建造該奇觀後，可花費 38.75 Qa 科學研究技術奇點使下輪遊玩獲得 3.875 Qa 科學（足以解鎖所有科技）",
