export const ZH_TW = {
   ...
   IdeologyDescHTML: "<style>b { color: #000ff; }</style>使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>自由主義、保守主義、社會主義或共產主義</b>中<font color= #ff0000>選擇一個</font>作為您的帝國政治意識形態。選擇後，您<b>無法切換意識形態</b>。您可以在每個政治意識形態中解鎖更多的增益。",
   IMPei: "貝聿銘",
   ...
   ReligionDescHTML: "<style>b { color: #000ff; }</style>使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>基督教、伊斯蘭教、佛教與多神教</b>中<font color= #ff0000>選擇一個</font>作為帝國宗教。你將<b>不能更換宗教</b>。不同宗教將能解鎖不同增益效果",
   ReligionIslam: "伊斯蘭教",
   ...
   TraditionDescHTML: "<style>b { color: #000ff; }</style>使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>耕作、商業、擴張和榮譽</b>中<font color= #ff0000>選擇一個</font>作為您的帝國傳統。選擇傳統後，您<b>無法切換傳統</b>。您可以在每個傳統中解鎖更多提升",
