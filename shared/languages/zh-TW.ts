export const ZH_TW = {
   ...
   Diwali: "排燈節：恒河和桑奇大塔的範圍增加至周圍 3 地塊範圍。紅堡的建築等級提升一倍（包括偉人提供建築等級）",
   ...
   Gameplay: "遊戲設定",
   GangesRiver: "恒河",
   GangesRiverDesc: "周圍 2 地塊範圍內的所有建築，提供 +N 額外建築等級，N 為解鎖該建築時代的時代智慧等級",
   Garment: "服裝",
   GarmentWorkshop: "製衣廠",
   GasPipeline: "天然氣管道",
   ...
   NotEnoughPowerHTML: "%{count} 建築沒有電氣化，因為它們的沒有足夠電力，點擊高亮他們",
   NothingHere: "此處沒有東西",
