export const ZH_TW = {
   ...
   AuroraBorealis: "北極光",
   AuroraBorealisDesc: "周圍 2 地塊範圍內的所有建築（產出工人建築除外）獲得 +N 生產乘數，N 是基於奇觀持續時間",
   Australian: "澳大利亞",
   ...
   ChateauFrontenacDesc: "該奇觀可被升級，每次升級時，將隨機抽取當前時代的三種建築。選擇其中一個來獲得 +1 額外建築等級",
   ...
   DinosaurProvincialParkDesc: "該奇觀可以在選定的時間啟動，一次性獲得相當於當前帝國總價值 25% 的瑞士貨幣",
   Diplomacy: "外交",
   ...
   GreatOceanRoad: "大洋路",
   GreatOceanRoadDesc: "該奇觀可被升級，每一級為貿易地塊加成相應建築提供 +1 額外建築等級（不包括相鄰玩家加成，相同地塊僅生效一次）",
   GreatPeople: "偉人",
   ...
   LakeLouise: "路易斯湖",
   LakeLouiseDesc: "所有貿易地圖上的相鄰玩家都會成為盟友（不管文明如何）。每個盟友擁有地塊相應建築提供 +2 額外建築等級",
   LandTrade: "商學",
   Language: "語言",
   Laozi: "老子",
   Lapland: "拉普蘭",
   ...
   Moomba: "蒙巴節：大洋路每一級額外為貿易地塊加成相應建築提供 +1 生產乘數（不包括相鄰玩家加成，相同地塊僅生效一次）。烏魯魯的範圍增加至周圍 3 地塊範圍",
   ...
   Wine: "葡萄酒",
   Winery: "葡萄酒廠",
   WinterCarnival: "冬季嘉年華：北極光的範圍增加至周圍 4 地塊範圍。弗朗特納克城堡和棲息地67提供額外建築等級翻倍",
   ...
   WorldTradeOrganizationDesc: "該奇觀可被升級，每一級為貿易地塊加成額外提供 +1 生產乘數。每週參加世界貿易組織投票，在世界貿易組織大會上獲選的建築將增加貿易地塊加成數量",
   WorldWarAge: "世界大戰",
   WorldWideWeb: "全球資訊網",
   WritersGuild: "作家公會",
   Writing: "文字",
