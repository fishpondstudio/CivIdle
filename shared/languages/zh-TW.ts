export const ZH_TW = {
   ...
   Aqueduct: "水渠",
   ArcDeTriomphe: "凱旋門",
   ArcDeTriompheDescV2: "每 1 幸福（最多 50）為所有建築物提供 +1 建造者能力指數。",
   Archimedes: "阿基米德",
   Architecture: "建築學",
   Aristophanes: "阿里斯托芬",
   ...
   CentrePompidouDesc: "建造完成後，所有建築物將獲得 +1 的生產加成與 +2 的儲存加成倍數。若當前遊戲已進入資訊時代，且下一輪遊戲選擇不同文明，則此奇觀將會保留。每當以一個獨特文明達到資訊時代並重生時，該奇觀將在重生時提升 1 級，每個等級提供額外 +1 生產與 +2 儲存加成倍數。此奇觀的價值不會被計入帝國總價值中，且大英博物館無法轉換為此奇觀。",
   ...
   DukeOfZhou: "周公旦",
   DuneOfPilat: "比拉沙丘",
   DuneOfPilatDesc: "在每個時代中，上個時代的智慧時代等級加成將提高一倍。",
   ...
   EastIndiaCompanyDescV2: "這座世界奇觀會累積您與其他玩家完成交易的總貿易價值。每累積 2000 點貿易價值可獲得一個周期，使所有建築每與一座運作中的商隊旅館相鄰，獲得 +0.5 的生產加成倍數。此奇觀可升級，每升級一次，額外獲得 +0.5 的生產加成倍數。當您完成其他玩家提出的交易請求，或您的交易請求被其他玩家完成時，透過交易所獲得的物品價值才會被計入（包含稅收部分）。多次交易可延長加成效果的持續時間，且加成效果可疊加。",
   Education: "教育學",
   ...
   PlayerMapOccupyTileCondition2: "你還沒有達到你等級的最大佔領地塊",
   ...
   TranslatorCredit: "HarchuN、JiaMuC(沐)、WangChenan、Neca、Captain",
   Translators: "翻譯人員",
