export const ZH_TW = {
   ...
   BorobudurDesc: "婆羅浮屠",
   BranCastle: "布郎城堡",
   BranCastleDescV2: "該奇觀產出的工人等同于周圍 2 地塊範圍內的工人總產出。如果有足夠的工人，還會將該奇觀產出的工人轉化為吸血鬼。吸血鬼不參與生產或運輸資源，但被視為忙碌的工人。布郎城堡的等級由工人總數決定，每一級獲得 +1 閒置工人科學產出和 +2 忙碌工人科學產出。該奇觀只能在萬聖節（10.15 ~ 11.15）期間建造。",
