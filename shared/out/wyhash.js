...
exports.wyhash_str = exports.wyhash = void 0;
function _mul64(x, y) {
    ...
    const hi = BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, x1 * y1) + w2) + BigInt.asUintN(64, w1 >> BigInt(32)));
...
function _wyr8(p, offset) {
    return BigInt.asUintN(64, BigInt(p[offset + 0]) |
