export const EN = {
   ...
   LighthouseOfAlexandriaDesc: "Provide +5 Storage Multiplier for all adjacent buildings",
   ...
   ColossusOfRhodesDesc: "+1 Happiness for each adjacent building that does not produce workers",
   ...
   Colosseum: "Colosseum",
   ColosseumDesc: "Provide +1 Production, Storage and Worker Capacity multiplier for all adjacent buildings",
